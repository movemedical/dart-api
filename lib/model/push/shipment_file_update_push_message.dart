...
abstract class ShipmentFileUpdatePushMessage
    implements
        Built<ShipmentFileUpdatePushMessage,
  ...
  factory ShipmentFileUpdatePushMessage(
          [updates(ShipmentFileUpdatePushMessageBuilder b)]) =
  ...
  static Serializer<ShipmentFileUpdatePushMessage> get serializer =>
      _$shipmentFileUpdatePushMessageSerializer;
}

abstract class ShipmentFileUpdatePushMessageActions extends ModelActions<
    ShipmentFileUpdatePushMessage,
    ShipmentFileUpdatePushMessageBuilder,
    ShipmentFileUpdatePushMessageActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ShipmentFileUpdatePushMessageActions(
          ShipmentFileUpdatePushMessageActionsOptions options) =>
      _$ShipmentFileUpdatePushMessageActions(options);
}
