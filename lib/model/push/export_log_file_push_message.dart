...
abstract class ExportLogFilePushMessage
    implements
        Built<ExportLogFilePushMessage, ExportLogFilePushMessageBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ExportLogFilePushMessage(
          [updates(ExportLogFilePushMessageBuilder b)]) =
  ...
  static Serializer<ExportLogFilePushMessage> get serializer =>
      _$exportLogFilePushMessageSerializer;
}

abstract class ExportLogFilePushMessageActions extends ModelActions<
    ExportLogFilePushMessage,
    ExportLogFilePushMessageBuilder,
    ExportLogFilePushMessageActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ExportLogFilePushMessageActions(
          ExportLogFilePushMessageActionsOptions options) =>
      _$ExportLogFilePushMessageActions(options);
}
