...
abstract class ImportLogFilePushMessage
    implements
        Built<ImportLogFilePushMessage, ImportLogFilePushMessageBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ImportLogFilePushMessage(
          [updates(ImportLogFilePushMessageBuilder b)]) =
  ...
  static Serializer<ImportLogFilePushMessage> get serializer =>
      _$importLogFilePushMessageSerializer;
}

abstract class ImportLogFilePushMessageActions extends ModelActions<
    ImportLogFilePushMessage,
    ImportLogFilePushMessageBuilder,
    ImportLogFilePushMessageActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ImportLogFilePushMessageActions(
          ImportLogFilePushMessageActionsOptions options) =>
      _$ImportLogFilePushMessageActions(options);
}
