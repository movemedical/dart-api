...
abstract class AuditFilePushMessage
    implements Built<AuditFilePushMessage, AuditFilePushMessageBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory AuditFilePushMessage([updates(AuditFilePushMessageBuilder b)]) =
  ...
  static Serializer<AuditFilePushMessage> get serializer =>
      _$auditFilePushMessageSerializer;
}

abstract class AuditFilePushMessageActions extends ModelActions<
    AuditFilePushMessage,
    AuditFilePushMessageBuilder,
    AuditFilePushMessageActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory AuditFilePushMessageActions(
          AuditFilePushMessageActionsOptions options) =>
      _$AuditFilePushMessageActions(options);
}
