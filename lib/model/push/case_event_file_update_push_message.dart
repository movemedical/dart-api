...
abstract class CaseEventFileUpdatePushMessage
    implements
        Built<CaseEventFileUpdatePushMessage,
  ...
  factory CaseEventFileUpdatePushMessage(
          [updates(CaseEventFileUpdatePushMessageBuilder b)]) =
  ...
  static Serializer<CaseEventFileUpdatePushMessage> get serializer =>
      _$caseEventFileUpdatePushMessageSerializer;
}

abstract class CaseEventFileUpdatePushMessageActions extends ModelActions<
    CaseEventFileUpdatePushMessage,
    CaseEventFileUpdatePushMessageBuilder,
    CaseEventFileUpdatePushMessageActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  FieldDispatcher<CaseEventFileUpdatePushMessageCaseEventFileUpdateType>
      get updateType;
  ...
  factory CaseEventFileUpdatePushMessageActions(
          CaseEventFileUpdatePushMessageActionsOptions options) =>
      _$CaseEventFileUpdatePushMessageActions(options);
}
