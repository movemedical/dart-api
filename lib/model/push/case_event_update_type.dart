...
class CaseEventUpdateType extends EnumClass {
  ...
  static const CaseEventUpdateType REQUIREMENTS_UPDATED = _$wireREQUIREMENTS_UPDATED;
  ...
  static const CaseEventUpdateType SCHEDULING_UPDATED = _$wireSCHEDULING_UPDATED;
  ...
  static const CaseEventUpdateType OPERATIONS_UPDATED = _$wireOPERATIONS_UPDATED;
  ...
  static BuiltSet<CaseEventUpdateType> get values => _$caseEventUpdateTypeValues;
  
  static CaseEventUpdateType valueOf(String name) => _$caseEventUpdateTypeValueOf(name);
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<CaseEventUpdateType> get serializer => _$caseEventUpdateTypeSerializer;
}
