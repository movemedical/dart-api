...
class ExpirationLevelColor extends EnumClass {
  ...
  static BuiltSet<ExpirationLevelColor> get values => _$expirationLevelColorValues;
  
  static ExpirationLevelColor valueOf(String name) => _$expirationLevelColorValueOf(name);
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<ExpirationLevelColor> get serializer => _$expirationLevelColorSerializer;
}
