...
abstract class ProcedureActions
    extends ModelActions<Procedure, ProcedureBuilder, ProcedureActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ProcedureActions(ProcedureActionsOptions options) =>
      _$ProcedureActions(options);
}
