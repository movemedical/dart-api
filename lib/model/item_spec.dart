...
abstract class ItemSpecActions extends ModelActions<ItemSpec, ItemSpecBuilder, ItemSpecActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ItemSpecActions(ItemSpecActionsOptions options) => _$ItemSpecActions(options);
}
