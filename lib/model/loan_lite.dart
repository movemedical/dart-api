...
abstract class LoanLiteActions
    extends ModelActions<LoanLite, LoanLiteBuilder, LoanLiteActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory LoanLiteActions(LoanLiteActionsOptions options) =>
      _$LoanLiteActions(options);
}
