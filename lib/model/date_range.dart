...
abstract class DateRangeActions extends ModelActions<DateRange, DateRangeBuilder, DateRangeActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory DateRangeActions(DateRangeActionsOptions options) => _$DateRangeActions(options);
}
