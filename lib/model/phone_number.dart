...
abstract class PhoneNumberActions extends ModelActions<PhoneNumber, PhoneNumberBuilder, PhoneNumberActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory PhoneNumberActions(PhoneNumberActionsOptions options) => _$PhoneNumberActions(options);
}
