...
abstract class TeamLinkActions
    extends ModelActions<TeamLink, TeamLinkBuilder, TeamLinkActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory TeamLinkActions(TeamLinkActionsOptions options) =>
      _$TeamLinkActions(options);
}
