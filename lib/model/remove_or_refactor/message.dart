...
abstract class MessageActions
    extends ModelActions<Message, MessageBuilder, MessageActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory MessageActions(MessageActionsOptions options) =>
      _$MessageActions(options);
}
