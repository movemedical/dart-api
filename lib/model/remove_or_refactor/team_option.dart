...
abstract class TeamOptionActions
    extends ModelActions<TeamOption, TeamOptionBuilder, TeamOptionActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory TeamOptionActions(TeamOptionActionsOptions options) =>
      _$TeamOptionActions(options);
}
