...
abstract class ConsumerActions
    extends ModelActions<Consumer, ConsumerBuilder, ConsumerActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ConsumerActions(ConsumerActionsOptions options) =>
      _$ConsumerActions(options);
}
