...
abstract class InsuranceActions extends ModelActions<Insurance, InsuranceBuilder, InsuranceActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory InsuranceActions(InsuranceActionsOptions options) => _$InsuranceActions(options);
}
