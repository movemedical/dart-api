...
abstract class StockContainer implements Built<StockContainer, StockContainerBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  static Serializer<StockContainer> get serializer => _$stockContainerSerializer;
}

abstract class StockContainerActions extends ModelActions<StockContainer, StockContainerBuilder, StockContainerActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory StockContainerActions(StockContainerActionsOptions options) => _$StockContainerActions(options);
}
