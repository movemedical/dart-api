...
abstract class SerialActions extends ModelActions<Serial, SerialBuilder, SerialActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory SerialActions(SerialActionsOptions options) => _$SerialActions(options);
}
