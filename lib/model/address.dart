...
abstract class AddressActions
    extends ModelActions<Address, AddressBuilder, AddressActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory AddressActions(AddressActionsOptions options) =>
      _$AddressActions(options);
}
