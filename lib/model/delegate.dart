...
abstract class DelegateActions extends ModelActions<Delegate, DelegateBuilder, DelegateActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory DelegateActions(DelegateActionsOptions options) => _$DelegateActions(options);
}
