...
abstract class StockItemActions
    extends ModelActions<StockItem, StockItemBuilder, StockItemActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory StockItemActions(StockItemActionsOptions options) =>
      _$StockItemActions(options);
}
