...
abstract class OrderHeaderLite
    implements Built<OrderHeaderLite, OrderHeaderLiteBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory OrderHeaderLite([updates(OrderHeaderLiteBuilder b)]) =
      _$OrderHeaderLite;
  ...
  static Serializer<OrderHeaderLite> get serializer =>
      _$orderHeaderLiteSerializer;
}

abstract class OrderHeaderLiteActions extends ModelActions<OrderHeaderLite,
  ...
  factory OrderHeaderLiteActions(OrderHeaderLiteActionsOptions options) =>
      _$OrderHeaderLiteActions(options);
}
