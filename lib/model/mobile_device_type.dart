...
class MobileDeviceType extends EnumClass {
  ...
  static MobileDeviceType valueOf(String name) => _$mobileDeviceTypeValueOf(name);
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<MobileDeviceType> get serializer => _$mobileDeviceTypeSerializer;
}
