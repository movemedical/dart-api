...
abstract class PatientActions extends ModelActions<Patient, PatientBuilder, PatientActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory PatientActions(PatientActionsOptions options) => _$PatientActions(options);
}
