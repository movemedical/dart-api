...
abstract class SystemAdminActions
    extends ModelActions<SystemAdmin, SystemAdminBuilder, SystemAdminActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory SystemAdminActions(SystemAdminActionsOptions options) =>
      _$SystemAdminActions(options);
}
