...
abstract class StockDataActions
    extends ModelActions<StockData, StockDataBuilder, StockDataActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory StockDataActions(StockDataActionsOptions options) =>
      _$StockDataActions(options);
}
