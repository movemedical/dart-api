...
abstract class ItemVersionActions extends ModelActions<ItemVersion, ItemVersionBuilder, ItemVersionActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ItemVersionActions(ItemVersionActionsOptions options) => _$ItemVersionActions(options);
}
