...
abstract class UnitOfMeasureActions extends ModelActions<UnitOfMeasure, UnitOfMeasureBuilder, UnitOfMeasureActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory UnitOfMeasureActions(UnitOfMeasureActionsOptions options) => _$UnitOfMeasureActions(options);
}
