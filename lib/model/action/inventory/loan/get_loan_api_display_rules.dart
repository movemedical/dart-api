...
abstract class GetLoanApiDisplayRules
    implements Built<GetLoanApiDisplayRules, GetLoanApiDisplayRulesBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetLoanApiDisplayRules([updates(GetLoanApiDisplayRulesBuilder b)]) =
  ...
  static Serializer<GetLoanApiDisplayRules> get serializer =>
      _$getLoanApiDisplayRulesSerializer;
}

abstract class GetLoanApiDisplayRulesActions extends ModelActions<
  ...
  factory GetLoanApiDisplayRulesActions(
          GetLoanApiDisplayRulesActionsOptions options) =>
      _$GetLoanApiDisplayRulesActions(options);
}
