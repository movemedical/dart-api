...
class ListLoansApiOrderBy extends EnumClass {
  ...
  static BuiltSet<ListLoansApiOrderBy> get values => _$listLoansApiOrderByValues;
  
  static ListLoansApiOrderBy valueOf(String name) => _$listLoansApiOrderByValueOf(name);
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<ListLoansApiOrderBy> get serializer => _$listLoansApiOrderBySerializer;
}
