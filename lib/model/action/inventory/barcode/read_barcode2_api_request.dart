...
abstract class ReadBarcode2ApiRequest
    implements Built<ReadBarcode2ApiRequest, ReadBarcode2ApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ReadBarcode2ApiRequest([updates(ReadBarcode2ApiRequestBuilder b)]) =
  ...
  static Serializer<ReadBarcode2ApiRequest> get serializer =>
      _$readBarcode2ApiRequestSerializer;
}

abstract class ReadBarcode2ApiRequestActions extends ModelActions<
    ReadBarcode2ApiRequest,
    ReadBarcode2ApiRequestBuilder,
    ReadBarcode2ApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ReadBarcode2ApiRequestActions(
          ReadBarcode2ApiRequestActionsOptions options) =>
      _$ReadBarcode2ApiRequestActions(options);
}
