...
class ReadBarcode2ApiReadType extends EnumClass {
  ...
  static BuiltSet<ReadBarcode2ApiReadType> get values => _$readBarcode2ApiReadTypeValues;
  
  static ReadBarcode2ApiReadType valueOf(String name) => _$readBarcode2ApiReadTypeValueOf(name);
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<ReadBarcode2ApiReadType> get serializer => _$readBarcode2ApiReadTypeSerializer;
}
