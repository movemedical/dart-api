...
abstract class ListTrayContentsApiResponse
    implements
        Built<ListTrayContentsApiResponse, ListTrayContentsApiResponseBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListTrayContentsApiResponse(
          [updates(ListTrayContentsApiResponseBuilder b)]) =
  ...
  static Serializer<ListTrayContentsApiResponse> get serializer =>
      _$listTrayContentsApiResponseSerializer;
}

abstract class ListTrayContentsApiResponseActions extends ModelActions<
    ListTrayContentsApiResponse,
    ListTrayContentsApiResponseBuilder,
    ListTrayContentsApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListTrayContentsApiResponseActions(
          ListTrayContentsApiResponseActionsOptions options) =>
      _$ListTrayContentsApiResponseActions(options);
}
