...
abstract class ListQuestionableTraySummaryApiQuestionableSummary
    implements
        Built<ListQuestionableTraySummaryApiQuestionableSummary,
  ...
  factory ListQuestionableTraySummaryApiQuestionableSummary(
          [updates(
  ...
  static Serializer<ListQuestionableTraySummaryApiQuestionableSummary>
      get serializer =>
          _$listQuestionableTraySummaryApiQuestionableSummarySerializer;
}

abstract class ListQuestionableTraySummaryApiQuestionableSummaryActions
    extends ModelActions<
        ListQuestionableTraySummaryApiQuestionableSummary,
        ListQuestionableTraySummaryApiQuestionableSummaryBuilder,
        ListQuestionableTraySummaryApiQuestionableSummaryActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListQuestionableTraySummaryApiQuestionableSummaryActions(
          ListQuestionableTraySummaryApiQuestionableSummaryActionsOptions
              options) =>
      _$ListQuestionableTraySummaryApiQuestionableSummaryActions(options);
}
