...
abstract class ListQuestionableTraySummaryApiResponse
    implements
        Built<ListQuestionableTraySummaryApiResponse,
  ...
  factory ListQuestionableTraySummaryApiResponse(
          [updates(ListQuestionableTraySummaryApiResponseBuilder b)]) =
  ...
  static Serializer<ListQuestionableTraySummaryApiResponse> get serializer =>
      _$listQuestionableTraySummaryApiResponseSerializer;
}

abstract class ListQuestionableTraySummaryApiResponseActions
    extends ModelActions<
        ListQuestionableTraySummaryApiResponse,
        ListQuestionableTraySummaryApiResponseBuilder,
        ListQuestionableTraySummaryApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////

  FieldDispatcher<BuiltList<ListQuestionableTraySummaryApiQuestionableSummary>>
      get questionableSummaryList;
  ...
  factory ListQuestionableTraySummaryApiResponseActions(
          ListQuestionableTraySummaryApiResponseActionsOptions options) =>
      _$ListQuestionableTraySummaryApiResponseActions(options);
}
