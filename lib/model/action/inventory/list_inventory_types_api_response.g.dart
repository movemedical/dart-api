...
class _$ListInventoryTypesApiResponseActions
  ...
  _$ListInventoryTypesApiResponseActions._(this.$options)
      : $replace = $options.action<ListInventoryTypesApiResponse>(
            '\$replace', (a) => a?.$replace),
        data = $options.actionField<BuiltList<InventoryType>>(
  ...
  @override
  ListInventoryTypesApiResponse get $initial => ListInventoryTypesApiResponse();
...
// @override
// Serializer<ListInventoryTypesApiResponseListInventoryTypesApiResponseActions> get $serializer => ListInventoryTypesApiResponseListInventoryTypesApiResponseActions.serializer;

  FullType _$fullType;
  @override
  FullType get $fullType =>
      _$fullType ??= FullType(ListInventoryTypesApiResponse);
}
