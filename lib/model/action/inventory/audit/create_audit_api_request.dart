...
abstract class CreateAuditApiRequest implements Built<CreateAuditApiRequest, CreateAuditApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreateAuditApiRequest([updates(CreateAuditApiRequestBuilder b)]) = _$CreateAuditApiRequest;
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<CreateAuditApiRequest> get serializer => _$createAuditApiRequestSerializer;
}

abstract class CreateAuditApiRequestActions extends ModelActions<CreateAuditApiRequest, CreateAuditApiRequestBuilder, CreateAuditApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreateAuditApiRequestActions(CreateAuditApiRequestActionsOptions options) => _$CreateAuditApiRequestActions(options);
}
