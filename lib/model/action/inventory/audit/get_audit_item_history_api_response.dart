...
abstract class GetAuditItemHistoryApiResponse
    implements
        Built<GetAuditItemHistoryApiResponse,
  ...
  factory GetAuditItemHistoryApiResponse(
          [updates(GetAuditItemHistoryApiResponseBuilder b)]) =
  ...
  static Serializer<GetAuditItemHistoryApiResponse> get serializer =>
      _$getAuditItemHistoryApiResponseSerializer;
}

abstract class GetAuditItemHistoryApiResponseActions extends ModelActions<
    GetAuditItemHistoryApiResponse,
    GetAuditItemHistoryApiResponseBuilder,
    GetAuditItemHistoryApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetAuditItemHistoryApiResponseActions(
          GetAuditItemHistoryApiResponseActionsOptions options) =>
      _$GetAuditItemHistoryApiResponseActions(options);
}
