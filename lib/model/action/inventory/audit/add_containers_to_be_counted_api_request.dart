...
abstract class AddContainersToBeCountedApiRequest
    implements
        Built<AddContainersToBeCountedApiRequest,
  ...
  factory AddContainersToBeCountedApiRequest(
          [updates(AddContainersToBeCountedApiRequestBuilder b)]) =
  ...
  static Serializer<AddContainersToBeCountedApiRequest> get serializer =>
      _$addContainersToBeCountedApiRequestSerializer;
}

abstract class AddContainersToBeCountedApiRequestActions extends ModelActions<
    AddContainersToBeCountedApiRequest,
    AddContainersToBeCountedApiRequestBuilder,
    AddContainersToBeCountedApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory AddContainersToBeCountedApiRequestActions(
          AddContainersToBeCountedApiRequestActionsOptions options) =>
      _$AddContainersToBeCountedApiRequestActions(options);
}
