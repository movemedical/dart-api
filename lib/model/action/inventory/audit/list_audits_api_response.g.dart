...
class _$ListAuditsApiResponseActions extends ListAuditsApiResponseActions {
  ...
  _$ListAuditsApiResponseActions._(this.$options)
      : $replace = $options.action<ListAuditsApiResponse>(
            '\$replace', (a) => a?.$replace),
        data = $options.actionField<BuiltList<ListAuditsApiAuditLite>>(
...
// @override
// Serializer<ListAuditsApiResponseListAuditsApiResponseActions> get $serializer => ListAuditsApiResponseListAuditsApiResponseActions.serializer;
