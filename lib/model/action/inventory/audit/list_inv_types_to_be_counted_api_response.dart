...
abstract class ListInvTypesToBeCountedApiResponse
    implements
        Built<ListInvTypesToBeCountedApiResponse,
            ListInvTypesToBeCountedApiResponseBuilder>,
        PaginatedListResponse<ListInvTypesToBeCountedApiInvTypeToCount> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListInvTypesToBeCountedApiResponse(
          [updates(ListInvTypesToBeCountedApiResponseBuilder b)]) =
  ...
  static Serializer<ListInvTypesToBeCountedApiResponse> get serializer =>
      _$listInvTypesToBeCountedApiResponseSerializer;
}

abstract class ListInvTypesToBeCountedApiResponseActions extends ModelActions<
    ListInvTypesToBeCountedApiResponse,
    ListInvTypesToBeCountedApiResponseBuilder,
    ListInvTypesToBeCountedApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListInvTypesToBeCountedApiResponseActions(
          ListInvTypesToBeCountedApiResponseActionsOptions options) =>
      _$ListInvTypesToBeCountedApiResponseActions(options);
}
