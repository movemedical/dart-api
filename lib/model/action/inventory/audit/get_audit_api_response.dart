...
abstract class GetAuditApiResponse
    implements Built<GetAuditApiResponse, GetAuditApiResponseBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetAuditApiResponse([updates(GetAuditApiResponseBuilder b)]) =
  ...
  static Serializer<GetAuditApiResponse> get serializer =>
      _$getAuditApiResponseSerializer;
}

abstract class GetAuditApiResponseActions extends ModelActions<
    GetAuditApiResponse,
    GetAuditApiResponseBuilder,
    GetAuditApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetAuditApiResponseActions(
          GetAuditApiResponseActionsOptions options) =>
      _$GetAuditApiResponseActions(options);
}
