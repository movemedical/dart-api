...
abstract class ListAuditItemStockApiAuditStock
    implements
        Built<ListAuditItemStockApiAuditStock,
  ...
  factory ListAuditItemStockApiAuditStock(
          [updates(ListAuditItemStockApiAuditStockBuilder b)]) =
  ...
  static Serializer<ListAuditItemStockApiAuditStock> get serializer =>
      _$listAuditItemStockApiAuditStockSerializer;
}

abstract class ListAuditItemStockApiAuditStockActions extends ModelActions<
    ListAuditItemStockApiAuditStock,
    ListAuditItemStockApiAuditStockBuilder,
    ListAuditItemStockApiAuditStockActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListAuditItemStockApiAuditStockActions(
          ListAuditItemStockApiAuditStockActionsOptions options) =>
      _$ListAuditItemStockApiAuditStockActions(options);
}
