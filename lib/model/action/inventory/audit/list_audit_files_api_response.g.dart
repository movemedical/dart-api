...
class _$ListAuditFilesApiResponseActions
  ...
  _$ListAuditFilesApiResponseActions._(this.$options)
      : $replace = $options.action<ListAuditFilesApiResponse>(
            '\$replace', (a) => a?.$replace),
        data = $options.actionField<BuiltList<ListAuditFilesApiAuditFile>>(
...
// @override
// Serializer<ListAuditFilesApiResponseListAuditFilesApiResponseActions> get $serializer => ListAuditFilesApiResponseListAuditFilesApiResponseActions.serializer;
