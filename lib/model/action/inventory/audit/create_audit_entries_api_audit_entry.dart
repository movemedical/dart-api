...
abstract class CreateAuditEntriesApiAuditEntry
    implements
        Built<CreateAuditEntriesApiAuditEntry,
  ...
  factory CreateAuditEntriesApiAuditEntry(
          [updates(CreateAuditEntriesApiAuditEntryBuilder b)]) =
  ...
  static Serializer<CreateAuditEntriesApiAuditEntry> get serializer =>
      _$createAuditEntriesApiAuditEntrySerializer;
}

abstract class CreateAuditEntriesApiAuditEntryActions extends ModelActions<
    CreateAuditEntriesApiAuditEntry,
    CreateAuditEntriesApiAuditEntryBuilder,
    CreateAuditEntriesApiAuditEntryActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreateAuditEntriesApiAuditEntryActions(
          CreateAuditEntriesApiAuditEntryActionsOptions options) =>
      _$CreateAuditEntriesApiAuditEntryActions(options);
}
