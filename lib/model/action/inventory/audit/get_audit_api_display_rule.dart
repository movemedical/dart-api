...
abstract class GetAuditApiDisplayRule
    implements Built<GetAuditApiDisplayRule, GetAuditApiDisplayRuleBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetAuditApiDisplayRule([updates(GetAuditApiDisplayRuleBuilder b)]) =
  ...
  static Serializer<GetAuditApiDisplayRule> get serializer =>
      _$getAuditApiDisplayRuleSerializer;
}

abstract class GetAuditApiDisplayRuleActions extends ModelActions<
  ...
  factory GetAuditApiDisplayRuleActions(
          GetAuditApiDisplayRuleActionsOptions options) =>
      _$GetAuditApiDisplayRuleActions(options);
}
