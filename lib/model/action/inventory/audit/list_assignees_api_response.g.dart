...
class _$ListAssigneesApiResponseActions
  ...
  _$ListAssigneesApiResponseActions._(this.$options)
      : $replace = $options.action<ListAssigneesApiResponse>(
            '\$replace', (a) => a?.$replace),
        data = $options.actionField<BuiltList<ListAssigneesApiAssignee>>(
...
// @override
// Serializer<ListAssigneesApiResponseListAssigneesApiResponseActions> get $serializer => ListAssigneesApiResponseListAssigneesApiResponseActions.serializer;
