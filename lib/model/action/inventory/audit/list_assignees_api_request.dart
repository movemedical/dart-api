...
abstract class ListAssigneesApiRequest
    implements Built<ListAssigneesApiRequest, ListAssigneesApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListAssigneesApiRequest([updates(ListAssigneesApiRequestBuilder b)]) =
  ...
  static Serializer<ListAssigneesApiRequest> get serializer =>
      _$listAssigneesApiRequestSerializer;
}

abstract class ListAssigneesApiRequestActions extends ModelActions<
    ListAssigneesApiRequest,
    ListAssigneesApiRequestBuilder,
    ListAssigneesApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListAssigneesApiRequestActions(
          ListAssigneesApiRequestActionsOptions options) =>
      _$ListAssigneesApiRequestActions(options);
}
