...
abstract class GetAuditApiAuditCountedSummary
    implements
        Built<GetAuditApiAuditCountedSummary,
  ...
  factory GetAuditApiAuditCountedSummary(
          [updates(GetAuditApiAuditCountedSummaryBuilder b)]) =
  ...
  static Serializer<GetAuditApiAuditCountedSummary> get serializer =>
      _$getAuditApiAuditCountedSummarySerializer;
}

abstract class GetAuditApiAuditCountedSummaryActions extends ModelActions<
  ...
  factory GetAuditApiAuditCountedSummaryActions(
          GetAuditApiAuditCountedSummaryActionsOptions options) =>
      _$GetAuditApiAuditCountedSummaryActions(options);
}
