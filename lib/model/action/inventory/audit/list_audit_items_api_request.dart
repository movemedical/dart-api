...
abstract class ListAuditItemsApiRequest
    implements
        Built<ListAuditItemsApiRequest, ListAuditItemsApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListAuditItemsApiRequest(
          [updates(ListAuditItemsApiRequestBuilder b)]) =
  ...
  static Serializer<ListAuditItemsApiRequest> get serializer =>
      _$listAuditItemsApiRequestSerializer;
}

abstract class ListAuditItemsApiRequestActions extends ModelActions<
    ListAuditItemsApiRequest,
    ListAuditItemsApiRequestBuilder,
    ListAuditItemsApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListAuditItemsApiRequestActions(
          ListAuditItemsApiRequestActionsOptions options) =>
      _$ListAuditItemsApiRequestActions(options);
}
