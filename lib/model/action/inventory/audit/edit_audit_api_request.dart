...
abstract class EditAuditApiRequest implements Built<EditAuditApiRequest, EditAuditApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory EditAuditApiRequest([updates(EditAuditApiRequestBuilder b)]) = _$EditAuditApiRequest;
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<EditAuditApiRequest> get serializer => _$editAuditApiRequestSerializer;
}

abstract class EditAuditApiRequestActions extends ModelActions<EditAuditApiRequest, EditAuditApiRequestBuilder, EditAuditApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory EditAuditApiRequestActions(EditAuditApiRequestActionsOptions options) => _$EditAuditApiRequestActions(options);
}
