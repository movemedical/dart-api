...
abstract class ListContainersToBeCountedApiContainerToBeCounted
    implements
        Built<ListContainersToBeCountedApiContainerToBeCounted,
  ...
  factory ListContainersToBeCountedApiContainerToBeCounted(
          [updates(
  ...
  static Serializer<ListContainersToBeCountedApiContainerToBeCounted>
      get serializer =>
          _$listContainersToBeCountedApiContainerToBeCountedSerializer;
}

abstract class ListContainersToBeCountedApiContainerToBeCountedActions
    extends ModelActions<
        ListContainersToBeCountedApiContainerToBeCounted,
        ListContainersToBeCountedApiContainerToBeCountedBuilder,
        ListContainersToBeCountedApiContainerToBeCountedActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListContainersToBeCountedApiContainerToBeCountedActions(
          ListContainersToBeCountedApiContainerToBeCountedActionsOptions
              options) =>
      _$ListContainersToBeCountedApiContainerToBeCountedActions(options);
}
