...
abstract class GetAuditApiBillingInfo
    implements Built<GetAuditApiBillingInfo, GetAuditApiBillingInfoBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetAuditApiBillingInfo([updates(GetAuditApiBillingInfoBuilder b)]) =
  ...
  static Serializer<GetAuditApiBillingInfo> get serializer =>
      _$getAuditApiBillingInfoSerializer;
}

abstract class GetAuditApiBillingInfoActions extends ModelActions<
  ...
  factory GetAuditApiBillingInfoActions(
          GetAuditApiBillingInfoActionsOptions options) =>
      _$GetAuditApiBillingInfoActions(options);
}
