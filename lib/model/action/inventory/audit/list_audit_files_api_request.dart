...
abstract class ListAuditFilesApiRequest
    implements
        Built<ListAuditFilesApiRequest, ListAuditFilesApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListAuditFilesApiRequest(
          [updates(ListAuditFilesApiRequestBuilder b)]) =
  ...
  static Serializer<ListAuditFilesApiRequest> get serializer =>
      _$listAuditFilesApiRequestSerializer;
}

abstract class ListAuditFilesApiRequestActions extends ModelActions<
    ListAuditFilesApiRequest,
    ListAuditFilesApiRequestBuilder,
    ListAuditFilesApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListAuditFilesApiRequestActions(
          ListAuditFilesApiRequestActionsOptions options) =>
      _$ListAuditFilesApiRequestActions(options);
}
