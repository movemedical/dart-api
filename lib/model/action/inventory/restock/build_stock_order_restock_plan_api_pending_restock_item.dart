...
abstract class BuildStockOrderRestockPlanApiPendingRestockItem
    implements
        Built<BuildStockOrderRestockPlanApiPendingRestockItem,
  ...
  factory BuildStockOrderRestockPlanApiPendingRestockItem(
          [updates(BuildStockOrderRestockPlanApiPendingRestockItemBuilder b)]) =
  ...
  static Serializer<BuildStockOrderRestockPlanApiPendingRestockItem>
      get serializer =>
          _$buildStockOrderRestockPlanApiPendingRestockItemSerializer;
}

abstract class BuildStockOrderRestockPlanApiPendingRestockItemActions
    extends ModelActions<
        BuildStockOrderRestockPlanApiPendingRestockItem,
        BuildStockOrderRestockPlanApiPendingRestockItemBuilder,
        BuildStockOrderRestockPlanApiPendingRestockItemActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory BuildStockOrderRestockPlanApiPendingRestockItemActions(
          BuildStockOrderRestockPlanApiPendingRestockItemActionsOptions
              options) =>
      _$BuildStockOrderRestockPlanApiPendingRestockItemActions(options);
}
