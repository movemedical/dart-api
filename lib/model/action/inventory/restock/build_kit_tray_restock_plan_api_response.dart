...
abstract class BuildKitTrayRestockPlanApiResponse
    implements
        Built<BuildKitTrayRestockPlanApiResponse,
  ...
  factory BuildKitTrayRestockPlanApiResponse(
          [updates(BuildKitTrayRestockPlanApiResponseBuilder b)]) =
  ...
  static Serializer<BuildKitTrayRestockPlanApiResponse> get serializer =>
      _$buildKitTrayRestockPlanApiResponseSerializer;
}

abstract class BuildKitTrayRestockPlanApiResponseActions extends ModelActions<
    BuildKitTrayRestockPlanApiResponse,
    BuildKitTrayRestockPlanApiResponseBuilder,
    BuildKitTrayRestockPlanApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  FieldDispatcher<BuildKitTrayRestockPlanApiRestockByDateType>
      get restockByDateType;
  ...
  FieldDispatcher<BuiltList<BuildKitTrayRestockPlanApiRestockItem>>
      get restockItems;

  FieldDispatcher<BuiltList<BuildKitTrayRestockPlanApiPendingRestockItem>>
      get pendingRestockItems;
  ...
  factory BuildKitTrayRestockPlanApiResponseActions(
          BuildKitTrayRestockPlanApiResponseActionsOptions options) =>
      _$BuildKitTrayRestockPlanApiResponseActions(options);
}
