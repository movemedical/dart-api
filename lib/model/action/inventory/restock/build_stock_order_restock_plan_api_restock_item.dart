...
abstract class BuildStockOrderRestockPlanApiRestockItem
    implements
        Built<BuildStockOrderRestockPlanApiRestockItem,
  ...
  factory BuildStockOrderRestockPlanApiRestockItem(
          [updates(BuildStockOrderRestockPlanApiRestockItemBuilder b)]) =
  ...
  static Serializer<BuildStockOrderRestockPlanApiRestockItem> get serializer =>
      _$buildStockOrderRestockPlanApiRestockItemSerializer;
}

abstract class BuildStockOrderRestockPlanApiRestockItemActions
    extends ModelActions<
        BuildStockOrderRestockPlanApiRestockItem,
        BuildStockOrderRestockPlanApiRestockItemBuilder,
        BuildStockOrderRestockPlanApiRestockItemActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  FieldDispatcher<BuildStockOrderRestockPlanApiRestockByDateType>
  ...
  factory BuildStockOrderRestockPlanApiRestockItemActions(
          BuildStockOrderRestockPlanApiRestockItemActionsOptions options) =>
      _$BuildStockOrderRestockPlanApiRestockItemActions(options);
}
