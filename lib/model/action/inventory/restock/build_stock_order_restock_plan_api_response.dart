...
abstract class BuildStockOrderRestockPlanApiResponse
    implements
        Built<BuildStockOrderRestockPlanApiResponse,
  ...
  factory BuildStockOrderRestockPlanApiResponse(
          [updates(BuildStockOrderRestockPlanApiResponseBuilder b)]) =
  ...
  static Serializer<BuildStockOrderRestockPlanApiResponse> get serializer =>
      _$buildStockOrderRestockPlanApiResponseSerializer;
}

abstract class BuildStockOrderRestockPlanApiResponseActions
    extends ModelActions<
        BuildStockOrderRestockPlanApiResponse,
        BuildStockOrderRestockPlanApiResponseBuilder,
        BuildStockOrderRestockPlanApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  FieldDispatcher<BuiltList<BuildStockOrderRestockPlanApiRestockItem>>
      get restockItems;

  FieldDispatcher<BuiltList<BuildStockOrderRestockPlanApiPendingRestockItem>>
      get pendingRestockItems;
  ...
  factory BuildStockOrderRestockPlanApiResponseActions(
          BuildStockOrderRestockPlanApiResponseActionsOptions options) =>
      _$BuildStockOrderRestockPlanApiResponseActions(options);
}
