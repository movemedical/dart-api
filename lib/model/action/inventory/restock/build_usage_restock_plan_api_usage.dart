...
abstract class BuildUsageRestockPlanApiUsage implements Built<BuildUsageRestockPlanApiUsage, BuildUsageRestockPlanApiUsageBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory BuildUsageRestockPlanApiUsage([updates(BuildUsageRestockPlanApiUsageBuilder b)]) = _$BuildUsageRestockPlanApiUsage;
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<BuildUsageRestockPlanApiUsage> get serializer => _$buildUsageRestockPlanApiUsageSerializer;
}

abstract class BuildUsageRestockPlanApiUsageActions extends ModelActions<BuildUsageRestockPlanApiUsage, BuildUsageRestockPlanApiUsageBuilder, BuildUsageRestockPlanApiUsageActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory BuildUsageRestockPlanApiUsageActions(BuildUsageRestockPlanApiUsageActionsOptions options) => _$BuildUsageRestockPlanApiUsageActions(options);
}
