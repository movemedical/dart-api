...
abstract class ProcessKitTrayRestockPlanApiResponse
    implements
        Built<ProcessKitTrayRestockPlanApiResponse,
  ...
  factory ProcessKitTrayRestockPlanApiResponse(
          [updates(ProcessKitTrayRestockPlanApiResponseBuilder b)]) =
  ...
  static Serializer<ProcessKitTrayRestockPlanApiResponse> get serializer =>
      _$processKitTrayRestockPlanApiResponseSerializer;
}

abstract class ProcessKitTrayRestockPlanApiResponseActions extends ModelActions<
    ProcessKitTrayRestockPlanApiResponse,
    ProcessKitTrayRestockPlanApiResponseBuilder,
    ProcessKitTrayRestockPlanApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ProcessKitTrayRestockPlanApiResponseActions(
          ProcessKitTrayRestockPlanApiResponseActionsOptions options) =>
      _$ProcessKitTrayRestockPlanApiResponseActions(options);
}
