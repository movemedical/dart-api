...
abstract class ProcessKitTrayRestockPlanApiRequest implements Built<ProcessKitTrayRestockPlanApiRequest, ProcessKitTrayRestockPlanApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ProcessKitTrayRestockPlanApiRequest([updates(ProcessKitTrayRestockPlanApiRequestBuilder b)]) = _$ProcessKitTrayRestockPlanApiRequest;
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<ProcessKitTrayRestockPlanApiRequest> get serializer => _$processKitTrayRestockPlanApiRequestSerializer;
}

abstract class ProcessKitTrayRestockPlanApiRequestActions extends ModelActions<ProcessKitTrayRestockPlanApiRequest, ProcessKitTrayRestockPlanApiRequestBuilder, ProcessKitTrayRestockPlanApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  FieldDispatcher<BuiltList<ProcessKitTrayRestockPlanApiRestockItem>> get restockItems;
  ...
  factory ProcessKitTrayRestockPlanApiRequestActions(ProcessKitTrayRestockPlanApiRequestActionsOptions options) => _$ProcessKitTrayRestockPlanApiRequestActions(options);
}
