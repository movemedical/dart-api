...
abstract class ProcessStockOrderRestockPlanApiRequest
    implements
        Built<ProcessStockOrderRestockPlanApiRequest,
  ...
  factory ProcessStockOrderRestockPlanApiRequest(
          [updates(ProcessStockOrderRestockPlanApiRequestBuilder b)]) =
  ...
  static Serializer<ProcessStockOrderRestockPlanApiRequest> get serializer =>
      _$processStockOrderRestockPlanApiRequestSerializer;
}

abstract class ProcessStockOrderRestockPlanApiRequestActions
    extends ModelActions<
        ProcessStockOrderRestockPlanApiRequest,
        ProcessStockOrderRestockPlanApiRequestBuilder,
        ProcessStockOrderRestockPlanApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  FieldDispatcher<BuiltList<ProcessStockOrderRestockPlanApiRestockItem>>
      get restockItems;
  ...
  factory ProcessStockOrderRestockPlanApiRequestActions(
          ProcessStockOrderRestockPlanApiRequestActionsOptions options) =>
      _$ProcessStockOrderRestockPlanApiRequestActions(options);
}
