...
abstract class ListAssociationJournalsApiAssociationJournal implements Built<ListAssociationJournalsApiAssociationJournal, ListAssociationJournalsApiAssociationJournalBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListAssociationJournalsApiAssociationJournal([updates(ListAssociationJournalsApiAssociationJournalBuilder b)]) = _$ListAssociationJournalsApiAssociationJournal;
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<ListAssociationJournalsApiAssociationJournal> get serializer => _$listAssociationJournalsApiAssociationJournalSerializer;
}

abstract class ListAssociationJournalsApiAssociationJournalActions extends ModelActions<ListAssociationJournalsApiAssociationJournal, ListAssociationJournalsApiAssociationJournalBuilder, ListAssociationJournalsApiAssociationJournalActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListAssociationJournalsApiAssociationJournalActions(ListAssociationJournalsApiAssociationJournalActionsOptions options) => _$ListAssociationJournalsApiAssociationJournalActions(options);
}
