...
class _$ListStockSummaryApiStockSummarySerializer
  ...
  final String wireName =
      'movemedical_api/model/action/inventory/stock_summary/ListStockSummaryApiStockSummary';
  ...
  Iterable serialize(
    ...
    if (object.kitHasUnverified != null) {
      result
        ..add('kitHasUnverified')
        ..add(serializers.serialize(object.kitHasUnverified,
            specifiedType: const FullType(bool)));
    }
      ...
      switch (key) {
        ...
        case 'kitHasMissing':
          result.kitHasMissing = serializers.deserialize(value,
              specifiedType: const FullType(bool)) as bool;
          break;
        case 'kitHasUnverified':
          result.kitHasUnverified = serializers.deserialize(value,
              specifiedType: const FullType(bool)) as bool;
          break;
        case 'attributeLabel':
...
class _$ListStockSummaryApiStockSummary
  ...
  bool operator ==(Object other) {
    ...
    return other is ListStockSummaryApiStockSummary &&
        ...
        kitHasUnverified == other.kitHasUnverified &&
                                                        ...
                                                        $jc(
                                                            $jc(
                                                                $jc(
                                                                    $jc(
                                                                        $jc(
                                                                            $jc($jc($jc($jc($jc($jc(0, id.hashCode), key.hashCode), qty.hashCode), holdQty.hashCode), lostQty.hashCode),
                                                                                foundQty.hashCode),
                                                                            place.hashCode),
                                                                        stockItem.hashCode),
  ...
  String toString() {
    return (newBuiltValueToStringHelper('ListStockSummaryApiStockSummary')
          ...
          ..add('kitHasUnverified', kitHasUnverified)
...
class ListStockSummaryApiStockSummaryBuilder
  ...
  ListStockSummaryApiStockSummaryBuilder get _$this {
    if (_$v != null) {
      ...
      _kitHasUnverified = _$v.kitHasUnverified;
    ...
    try {
      _$result = _$v ??
          new _$ListStockSummaryApiStockSummary._(
              ...
              kitHasUnverified: kitHasUnverified,
...
class _$ListStockSummaryApiStockSummaryActions
  ...
  final FieldDispatcher<bool> kitHasUnverified;
