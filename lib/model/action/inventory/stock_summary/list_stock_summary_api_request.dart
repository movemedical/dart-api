...
import 'package:movemedical_api/model/action/inventory/stock_summary/list_stock_summary_api_order_by.dart';
...
abstract class ListStockSummaryApiRequest
    implements
        Built<ListStockSummaryApiRequest, ListStockSummaryApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  @nullable
  BuiltList<String> get zoneIds;

  @nullable
  BuiltList<String> get binIds;
  ...
  factory ListStockSummaryApiRequest(
          [updates(ListStockSummaryApiRequestBuilder b)]) =
  ...
  static Serializer<ListStockSummaryApiRequest> get serializer =>
      _$listStockSummaryApiRequestSerializer;
}

abstract class ListStockSummaryApiRequestActions extends ModelActions<
  ...
  FieldDispatcher<BuiltList<String>> get zoneIds;

  FieldDispatcher<BuiltList<String>> get binIds;
  ...
  factory ListStockSummaryApiRequestActions(
          ListStockSummaryApiRequestActionsOptions options) =>
      _$ListStockSummaryApiRequestActions(options);
}
