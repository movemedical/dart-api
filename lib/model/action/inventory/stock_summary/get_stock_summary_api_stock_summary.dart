...
import 'package:movemedical_api/model/action/inventory/stock_summary/get_stock_summary_api_stock_attribute.dart';
...
abstract class GetStockSummaryApiStockSummary
    implements
        Built<GetStockSummaryApiStockSummary,
  ...
  factory GetStockSummaryApiStockSummary(
          [updates(GetStockSummaryApiStockSummaryBuilder b)]) =
  ...
  static Serializer<GetStockSummaryApiStockSummary> get serializer =>
      _$getStockSummaryApiStockSummarySerializer;
}

abstract class GetStockSummaryApiStockSummaryActions extends ModelActions<
  ...
  factory GetStockSummaryApiStockSummaryActions(
          GetStockSummaryApiStockSummaryActionsOptions options) =>
      _$GetStockSummaryApiStockSummaryActions(options);
}
