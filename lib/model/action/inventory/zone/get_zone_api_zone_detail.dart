...
abstract class GetZoneApiZoneDetail
    implements Built<GetZoneApiZoneDetail, GetZoneApiZoneDetailBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetZoneApiZoneDetail([updates(GetZoneApiZoneDetailBuilder b)]) =
  ...
  static Serializer<GetZoneApiZoneDetail> get serializer =>
      _$getZoneApiZoneDetailSerializer;
}

abstract class GetZoneApiZoneDetailActions extends ModelActions<
  ...
  factory GetZoneApiZoneDetailActions(
          GetZoneApiZoneDetailActionsOptions options) =>
      _$GetZoneApiZoneDetailActions(options);
}
