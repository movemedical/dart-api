...
class _$ListStockSummaryApiResponseSerializer
  ...
  final String wireName =
      'movemedical_api/model/action/inventory/stockSummary/ListStockSummaryApiResponse';
...
class _$ListStockSummaryApiResponseActions
  ...
  _$ListStockSummaryApiResponseActions._(this.$options)
      : $replace = $options.action<ListStockSummaryApiResponse>(
            '\$replace', (a) => a?.$replace),
        data = $options.actionField<BuiltList<ListStockSummaryApiStockSummary>>(
  ...
  @override
  ListStockSummaryApiResponse get $initial => ListStockSummaryApiResponse();
...
// @override
// Serializer<ListStockSummaryApiResponseListStockSummaryApiResponseActions> get $serializer => ListStockSummaryApiResponseListStockSummaryApiResponseActions.serializer;

  FullType _$fullType;
  @override
  FullType get $fullType =>
      _$fullType ??= FullType(ListStockSummaryApiResponse);
}
