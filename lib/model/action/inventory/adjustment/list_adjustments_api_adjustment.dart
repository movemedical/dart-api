...
abstract class ListAdjustmentsApiAdjustment
    implements
        Built<ListAdjustmentsApiAdjustment,
  ...
  factory ListAdjustmentsApiAdjustment(
          [updates(ListAdjustmentsApiAdjustmentBuilder b)]) =
  ...
  static Serializer<ListAdjustmentsApiAdjustment> get serializer =>
      _$listAdjustmentsApiAdjustmentSerializer;
}

abstract class ListAdjustmentsApiAdjustmentActions extends ModelActions<
    ListAdjustmentsApiAdjustment,
    ListAdjustmentsApiAdjustmentBuilder,
    ListAdjustmentsApiAdjustmentActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListAdjustmentsApiAdjustmentActions(
          ListAdjustmentsApiAdjustmentActionsOptions options) =>
      _$ListAdjustmentsApiAdjustmentActions(options);
}
