...
abstract class GetAdjustmentApiResponse
    implements
        Built<GetAdjustmentApiResponse, GetAdjustmentApiResponseBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetAdjustmentApiResponse(
          [updates(GetAdjustmentApiResponseBuilder b)]) =
  ...
  static Serializer<GetAdjustmentApiResponse> get serializer =>
      _$getAdjustmentApiResponseSerializer;
}

abstract class GetAdjustmentApiResponseActions extends ModelActions<
    GetAdjustmentApiResponse,
    GetAdjustmentApiResponseBuilder,
    GetAdjustmentApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetAdjustmentApiResponseActions(
          GetAdjustmentApiResponseActionsOptions options) =>
      _$GetAdjustmentApiResponseActions(options);
}
