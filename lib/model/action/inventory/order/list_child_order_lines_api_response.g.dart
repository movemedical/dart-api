...
class _$ListChildOrderLinesApiResponseActions
  ...
  _$ListChildOrderLinesApiResponseActions._(this.$options)
      : $replace = $options.action<ListChildOrderLinesApiResponse>(
            '\$replace', (a) => a?.$replace),
        data = $options.actionField<BuiltList<ListChildOrderLinesApiOrderLine>>(
  ...
  @override
  ListChildOrderLinesApiResponse get $initial =>
      ListChildOrderLinesApiResponse();
...
// @override
// Serializer<ListChildOrderLinesApiResponseListChildOrderLinesApiResponseActions> get $serializer => ListChildOrderLinesApiResponseListChildOrderLinesApiResponseActions.serializer;

  FullType _$fullType;
  @override
  FullType get $fullType =>
      _$fullType ??= FullType(ListChildOrderLinesApiResponse);
}
