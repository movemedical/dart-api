...
abstract class EditOrderDetailsApiRequest
    implements
        Built<EditOrderDetailsApiRequest, EditOrderDetailsApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory EditOrderDetailsApiRequest(
          [updates(EditOrderDetailsApiRequestBuilder b)]) =
  ...
  static Serializer<EditOrderDetailsApiRequest> get serializer =>
      _$editOrderDetailsApiRequestSerializer;
}

abstract class EditOrderDetailsApiRequestActions extends ModelActions<
    EditOrderDetailsApiRequest,
    EditOrderDetailsApiRequestBuilder,
    EditOrderDetailsApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory EditOrderDetailsApiRequestActions(
          EditOrderDetailsApiRequestActionsOptions options) =>
      _$EditOrderDetailsApiRequestActions(options);
}
