...
abstract class CreateStockOrderApiRequest
    implements
        Built<CreateStockOrderApiRequest, CreateStockOrderApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreateStockOrderApiRequest(
          [updates(CreateStockOrderApiRequestBuilder b)]) =
  ...
  static Serializer<CreateStockOrderApiRequest> get serializer =>
      _$createStockOrderApiRequestSerializer;
}

abstract class CreateStockOrderApiRequestActions extends ModelActions<
    CreateStockOrderApiRequest,
    CreateStockOrderApiRequestBuilder,
    CreateStockOrderApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreateStockOrderApiRequestActions(
          CreateStockOrderApiRequestActionsOptions options) =>
      _$CreateStockOrderApiRequestActions(options);
}
