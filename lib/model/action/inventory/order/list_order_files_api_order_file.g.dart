...
class _$ListOrderFilesApiOrderFileActions
  ...
  _$ListOrderFilesApiOrderFileActions._(this.$options)
      : $replace = $options.action<ListOrderFilesApiOrderFile>(
        ...
        orderFileType = $options.actionField<FileType>(
            'orderFileType',
            (a) => a?.orderFileType,
            (s) => s?.orderFileType,
...
// @override
// Serializer<ListOrderFilesApiOrderFileListOrderFilesApiOrderFileActions> get $serializer => ListOrderFilesApiOrderFileListOrderFilesApiOrderFileActions.serializer;
