...
abstract class ListOrderFilesApiRequest
    implements
        Built<ListOrderFilesApiRequest, ListOrderFilesApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListOrderFilesApiRequest(
          [updates(ListOrderFilesApiRequestBuilder b)]) =
  ...
  static Serializer<ListOrderFilesApiRequest> get serializer =>
      _$listOrderFilesApiRequestSerializer;
}

abstract class ListOrderFilesApiRequestActions extends ModelActions<
    ListOrderFilesApiRequest,
    ListOrderFilesApiRequestBuilder,
    ListOrderFilesApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListOrderFilesApiRequestActions(
          ListOrderFilesApiRequestActionsOptions options) =>
      _$ListOrderFilesApiRequestActions(options);
}
