...
abstract class ListOrderLinesApiOrderLine implements Built<ListOrderLinesApiOrderLine, ListOrderLinesApiOrderLineBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListOrderLinesApiOrderLine([updates(ListOrderLinesApiOrderLineBuilder b)]) = _$ListOrderLinesApiOrderLine;
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<ListOrderLinesApiOrderLine> get serializer => _$listOrderLinesApiOrderLineSerializer;
}

abstract class ListOrderLinesApiOrderLineActions extends ModelActions<ListOrderLinesApiOrderLine, ListOrderLinesApiOrderLineBuilder, ListOrderLinesApiOrderLineActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  FieldDispatcher<BuiltList<ListOrderLinesApiBackOrderDetail>> get backOrderDetails;
  ...
  factory ListOrderLinesApiOrderLineActions(ListOrderLinesApiOrderLineActionsOptions options) => _$ListOrderLinesApiOrderLineActions(options);
}
