...
abstract class CreateOrderReasonApiRequest
    implements
        Built<CreateOrderReasonApiRequest, CreateOrderReasonApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreateOrderReasonApiRequest(
          [updates(CreateOrderReasonApiRequestBuilder b)]) =
  ...
  static Serializer<CreateOrderReasonApiRequest> get serializer =>
      _$createOrderReasonApiRequestSerializer;
}

abstract class CreateOrderReasonApiRequestActions extends ModelActions<
    CreateOrderReasonApiRequest,
    CreateOrderReasonApiRequestBuilder,
    CreateOrderReasonApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreateOrderReasonApiRequestActions(
          CreateOrderReasonApiRequestActionsOptions options) =>
      _$CreateOrderReasonApiRequestActions(options);
}
