...
abstract class UpdateOrderReasonApiRequest
    implements
        Built<UpdateOrderReasonApiRequest, UpdateOrderReasonApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory UpdateOrderReasonApiRequest(
          [updates(UpdateOrderReasonApiRequestBuilder b)]) =
  ...
  static Serializer<UpdateOrderReasonApiRequest> get serializer =>
      _$updateOrderReasonApiRequestSerializer;
}

abstract class UpdateOrderReasonApiRequestActions extends ModelActions<
    UpdateOrderReasonApiRequest,
    UpdateOrderReasonApiRequestBuilder,
    UpdateOrderReasonApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory UpdateOrderReasonApiRequestActions(
          UpdateOrderReasonApiRequestActionsOptions options) =>
      _$UpdateOrderReasonApiRequestActions(options);
}
