...
abstract class GetStockOrderApiOrder
    implements Built<GetStockOrderApiOrder, GetStockOrderApiOrderBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetStockOrderApiOrder([updates(GetStockOrderApiOrderBuilder b)]) =
  ...
  static Serializer<GetStockOrderApiOrder> get serializer =>
      _$getStockOrderApiOrderSerializer;
}

abstract class GetStockOrderApiOrderActions extends ModelActions<
  ...
  factory GetStockOrderApiOrderActions(
          GetStockOrderApiOrderActionsOptions options) =>
      _$GetStockOrderApiOrderActions(options);
}
