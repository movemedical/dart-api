...
abstract class ListOrderFilesApiOrderFile implements Built<ListOrderFilesApiOrderFile, ListOrderFilesApiOrderFileBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListOrderFilesApiOrderFile([updates(ListOrderFilesApiOrderFileBuilder b)]) = _$ListOrderFilesApiOrderFile;
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<ListOrderFilesApiOrderFile> get serializer => _$listOrderFilesApiOrderFileSerializer;
}

abstract class ListOrderFilesApiOrderFileActions extends ModelActions<ListOrderFilesApiOrderFile, ListOrderFilesApiOrderFileBuilder, ListOrderFilesApiOrderFileActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListOrderFilesApiOrderFileActions(ListOrderFilesApiOrderFileActionsOptions options) => _$ListOrderFilesApiOrderFileActions(options);
}
