...
abstract class GetStockOrderApiDisplayRules
    implements
        Built<GetStockOrderApiDisplayRules,
  ...
  factory GetStockOrderApiDisplayRules(
          [updates(GetStockOrderApiDisplayRulesBuilder b)]) =
  ...
  static Serializer<GetStockOrderApiDisplayRules> get serializer =>
      _$getStockOrderApiDisplayRulesSerializer;
}

abstract class GetStockOrderApiDisplayRulesActions extends ModelActions<
  ...
  factory GetStockOrderApiDisplayRulesActions(
          GetStockOrderApiDisplayRulesActionsOptions options) =>
      _$GetStockOrderApiDisplayRulesActions(options);
}
