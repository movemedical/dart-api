...
abstract class SaveOrderLinesApiRequest
    implements
        Built<SaveOrderLinesApiRequest, SaveOrderLinesApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory SaveOrderLinesApiRequest(
          [updates(SaveOrderLinesApiRequestBuilder b)]) =
  ...
  static Serializer<SaveOrderLinesApiRequest> get serializer =>
      _$saveOrderLinesApiRequestSerializer;
}

abstract class SaveOrderLinesApiRequestActions extends ModelActions<
  ...
  factory SaveOrderLinesApiRequestActions(
          SaveOrderLinesApiRequestActionsOptions options) =>
      _$SaveOrderLinesApiRequestActions(options);
}
