...
abstract class ListOrdersApiOrder implements Built<ListOrdersApiOrder, ListOrdersApiOrderBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListOrdersApiOrder([updates(ListOrdersApiOrderBuilder b)]) = _$ListOrdersApiOrder;
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<ListOrdersApiOrder> get serializer => _$listOrdersApiOrderSerializer;
}

abstract class ListOrdersApiOrderActions extends ModelActions<ListOrdersApiOrder, ListOrdersApiOrderBuilder, ListOrdersApiOrderActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListOrdersApiOrderActions(ListOrdersApiOrderActionsOptions options) => _$ListOrdersApiOrderActions(options);
}
