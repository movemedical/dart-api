...
class _$ListOrderReasonsApiRequestSerializer
  ...
  Iterable serialize(Serializers serializers, ListOrderReasonsApiRequest object,
    ...
    if (object.inventoryOrder != null) {
      result
        ..add('inventoryOrder')
        ..add(serializers.serialize(object.inventoryOrder,
            specifiedType: const FullType(bool)));
    }
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'forCreate':
          ...
          break;
        case 'inventoryOrder':
          result.inventoryOrder = serializers.deserialize(value,
              specifiedType: const FullType(bool)) as bool;
          break;
        case 'paging':
...
class _$ListOrderReasonsApiRequest extends ListOrderReasonsApiRequest {
  ...
  bool operator ==(Object other) {
    ...
    return other is ListOrderReasonsApiRequest &&
        ...
        inventoryOrder == other.inventoryOrder &&
        paging == other.paging;
  }
  ...
  String toString() {
    return (newBuiltValueToStringHelper('ListOrderReasonsApiRequest')
          ...
          ..add('inventoryOrder', inventoryOrder)
          ..add('paging', paging))
        .toString();
  }
}
...
class ListOrderReasonsApiRequestBuilder
  ...
  bool _inventoryOrder;

  bool get inventoryOrder => _$this._inventoryOrder;

  set inventoryOrder(bool inventoryOrder) =>
      _$this._inventoryOrder = inventoryOrder;
  ...
  ListOrderReasonsApiRequestBuilder get _$this {
    if (_$v != null) {
      ...
      _inventoryOrder = _$v.inventoryOrder;
...
class _$ListOrderReasonsApiRequestActions
  ...
  final FieldDispatcher<bool> inventoryOrder;
  ...
  _$ListOrderReasonsApiRequestActions._(this.options$)
      : replace$ = options$.action<ListOrderReasonsApiRequest>(
        ...
        inventoryOrder = options$.field<bool>(
            'inventoryOrder',
            (a) => a?.inventoryOrder,
            (s) => s?.inventoryOrder,
            (p, b) => p?.inventoryOrder = b),
  ...
  void reducer$(ReducerBuilder reducer) {
    ...
    inventoryOrder.reducer$(reducer);
