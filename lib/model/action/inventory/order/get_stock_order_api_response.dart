...
abstract class GetStockOrderApiResponse
    implements
        Built<GetStockOrderApiResponse, GetStockOrderApiResponseBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetStockOrderApiResponse(
          [updates(GetStockOrderApiResponseBuilder b)]) =
  ...
  static Serializer<GetStockOrderApiResponse> get serializer =>
      _$getStockOrderApiResponseSerializer;
}

abstract class GetStockOrderApiResponseActions extends ModelActions<
    GetStockOrderApiResponse,
    GetStockOrderApiResponseBuilder,
    GetStockOrderApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetStockOrderApiResponseActions(
          GetStockOrderApiResponseActionsOptions options) =>
      _$GetStockOrderApiResponseActions(options);
}
