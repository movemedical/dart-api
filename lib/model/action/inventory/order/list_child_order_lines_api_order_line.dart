...
abstract class ListChildOrderLinesApiOrderLine
    implements
        Built<ListChildOrderLinesApiOrderLine,
  ...
  factory ListChildOrderLinesApiOrderLine(
          [updates(ListChildOrderLinesApiOrderLineBuilder b)]) =
  ...
  static Serializer<ListChildOrderLinesApiOrderLine> get serializer =>
      _$listChildOrderLinesApiOrderLineSerializer;
}

abstract class ListChildOrderLinesApiOrderLineActions extends ModelActions<
    ListChildOrderLinesApiOrderLine,
    ListChildOrderLinesApiOrderLineBuilder,
    ListChildOrderLinesApiOrderLineActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListChildOrderLinesApiOrderLineActions(
          ListChildOrderLinesApiOrderLineActionsOptions options) =>
      _$ListChildOrderLinesApiOrderLineActions(options);
}
