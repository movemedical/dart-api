...
abstract class ShipDeliverConfirmPackagesApiRequest
    implements
        Built<ShipDeliverConfirmPackagesApiRequest,
  ...
  factory ShipDeliverConfirmPackagesApiRequest(
          [updates(ShipDeliverConfirmPackagesApiRequestBuilder b)]) =
  ...
  static Serializer<ShipDeliverConfirmPackagesApiRequest> get serializer =>
      _$shipDeliverConfirmPackagesApiRequestSerializer;
}

abstract class ShipDeliverConfirmPackagesApiRequestActions extends ModelActions<
    ShipDeliverConfirmPackagesApiRequest,
    ShipDeliverConfirmPackagesApiRequestBuilder,
    ShipDeliverConfirmPackagesApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////

  FieldDispatcher<BuiltList<ShipDeliverConfirmPackagesApiProcessingSteps>>
      get processingSteps;
  ...
  factory ShipDeliverConfirmPackagesApiRequestActions(
          ShipDeliverConfirmPackagesApiRequestActionsOptions options) =>
      _$ShipDeliverConfirmPackagesApiRequestActions(options);
}
