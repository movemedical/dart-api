...
abstract class ListPackageContentsApiContentItem
    implements
        Built<ListPackageContentsApiContentItem,
  ...
  factory ListPackageContentsApiContentItem(
          [updates(ListPackageContentsApiContentItemBuilder b)]) =
  ...
  static Serializer<ListPackageContentsApiContentItem> get serializer =>
      _$listPackageContentsApiContentItemSerializer;
}

abstract class ListPackageContentsApiContentItemActions extends ModelActions<
    ListPackageContentsApiContentItem,
    ListPackageContentsApiContentItemBuilder,
    ListPackageContentsApiContentItemActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListPackageContentsApiContentItemActions(
          ListPackageContentsApiContentItemActionsOptions options) =>
      _$ListPackageContentsApiContentItemActions(options);
}
