...
abstract class ListPackageContentsApiResponse
    implements
        Built<ListPackageContentsApiResponse,
  ...
  factory ListPackageContentsApiResponse(
          [updates(ListPackageContentsApiResponseBuilder b)]) =
  ...
  static Serializer<ListPackageContentsApiResponse> get serializer =>
      _$listPackageContentsApiResponseSerializer;
}

abstract class ListPackageContentsApiResponseActions extends ModelActions<
    ListPackageContentsApiResponse,
    ListPackageContentsApiResponseBuilder,
    ListPackageContentsApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListPackageContentsApiResponseActions(
          ListPackageContentsApiResponseActionsOptions options) =>
      _$ListPackageContentsApiResponseActions(options);
}
