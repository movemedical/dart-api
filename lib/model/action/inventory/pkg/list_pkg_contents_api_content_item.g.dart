...
part of 'list_pkg_contents_api_content_item.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<ListPkgContentsApiContentItem>
    _$listPkgContentsApiContentItemSerializer =
    new _$ListPkgContentsApiContentItemSerializer();

class _$ListPkgContentsApiContentItemSerializer
    implements StructuredSerializer<ListPkgContentsApiContentItem> {
  @override
  final Iterable<Type> types = const [
    ListPkgContentsApiContentItem,
    _$ListPkgContentsApiContentItem
  ];
  @override
  final String wireName =
      'movemedical_api/model/action/inventory/pkg/ListPkgContentsApiContentItem';

  @override
  Iterable serialize(
      Serializers serializers, ListPkgContentsApiContentItem object,
  ...
  @override
  ListPkgContentsApiContentItem deserialize(
      Serializers serializers, Iterable serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new ListPkgContentsApiContentItemBuilder();
...
class _$ListPkgContentsApiContentItem extends ListPkgContentsApiContentItem {
  @override
  ...
  factory _$ListPkgContentsApiContentItem(
          [void updates(ListPkgContentsApiContentItemBuilder b)]) =>
      (new ListPkgContentsApiContentItemBuilder()..update(updates)).build();

  _$ListPkgContentsApiContentItem._(
  ...
  @override
  ListPkgContentsApiContentItem rebuild(
          void updates(ListPkgContentsApiContentItemBuilder b)) =>
      (toBuilder()..update(updates)).build();

  @override
  ListPkgContentsApiContentItemBuilder toBuilder() =>
      new ListPkgContentsApiContentItemBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ListPkgContentsApiContentItem &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('ListPkgContentsApiContentItem')
...
class ListPkgContentsApiContentItemBuilder
    implements
        Builder<ListPkgContentsApiContentItem,
            ListPkgContentsApiContentItemBuilder> {
  _$ListPkgContentsApiContentItem _$v;
  ...
  ListPkgContentsApiContentItemBuilder get _$this {
    if (_$v != null) {
  ...
  @override
  void replace(ListPkgContentsApiContentItem other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$ListPkgContentsApiContentItem;
  }

  @override
  void update(void updates(ListPkgContentsApiContentItemBuilder b)) {
    if (updates != null) updates(this);
  }

  @override
  _$ListPkgContentsApiContentItem build() {
    _$ListPkgContentsApiContentItem _$result;
    try {
      _$result = _$v ??
          new _$ListPkgContentsApiContentItem._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'ListPkgContentsApiContentItem', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
typedef StatefulActionsOptions<
    ListPkgContentsApiContentItem,
    ListPkgContentsApiContentItemBuilder,
    ListPkgContentsApiContentItemActions> ListPkgContentsApiContentItemActionsOptions();

class _$ListPkgContentsApiContentItemActions
    extends ListPkgContentsApiContentItemActions {
  final StatefulActionsOptions<
      ListPkgContentsApiContentItem,
      ListPkgContentsApiContentItemBuilder,
      ListPkgContentsApiContentItemActions> $options;

  final ActionDispatcher<ListPkgContentsApiContentItem> $replace;
  ...
  factory _$ListPkgContentsApiContentItemActions(
          ListPkgContentsApiContentItemActionsOptions options) =>
      _$ListPkgContentsApiContentItemActions._(options());

  @override
  ListPkgContentsApiContentItem get $initial => ListPkgContentsApiContentItem();

  @override
  ListPkgContentsApiContentItemBuilder $newBuilder() =>
      ListPkgContentsApiContentItemBuilder();
  ...
  FullType get $fullType =>
      _$fullType ??= FullType(ListPkgContentsApiContentItem);
}
