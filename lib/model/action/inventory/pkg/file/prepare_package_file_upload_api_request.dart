...
abstract class PreparePackageFileUploadApiRequest
    implements
        Built<PreparePackageFileUploadApiRequest,
  ...
  factory PreparePackageFileUploadApiRequest(
          [updates(PreparePackageFileUploadApiRequestBuilder b)]) =
  ...
  static Serializer<PreparePackageFileUploadApiRequest> get serializer =>
      _$preparePackageFileUploadApiRequestSerializer;
}

abstract class PreparePackageFileUploadApiRequestActions extends ModelActions<
    PreparePackageFileUploadApiRequest,
    PreparePackageFileUploadApiRequestBuilder,
    PreparePackageFileUploadApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory PreparePackageFileUploadApiRequestActions(
          PreparePackageFileUploadApiRequestActionsOptions options) =>
      _$PreparePackageFileUploadApiRequestActions(options);
}
