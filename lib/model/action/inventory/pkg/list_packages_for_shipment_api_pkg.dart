...
abstract class ListPackagesForShipmentApiPkg
    implements
        Built<ListPackagesForShipmentApiPkg,
  ...
  factory ListPackagesForShipmentApiPkg(
          [updates(ListPackagesForShipmentApiPkgBuilder b)]) =
  ...
  static Serializer<ListPackagesForShipmentApiPkg> get serializer =>
      _$listPackagesForShipmentApiPkgSerializer;
}

abstract class ListPackagesForShipmentApiPkgActions extends ModelActions<
    ListPackagesForShipmentApiPkg,
    ListPackagesForShipmentApiPkgBuilder,
    ListPackagesForShipmentApiPkgActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListPackagesForShipmentApiPkgActions(
          ListPackagesForShipmentApiPkgActionsOptions options) =>
      _$ListPackagesForShipmentApiPkgActions(options);
}
