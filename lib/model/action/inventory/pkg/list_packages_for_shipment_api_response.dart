...
abstract class ListPackagesForShipmentApiResponse
    implements
        Built<ListPackagesForShipmentApiResponse,
            ListPackagesForShipmentApiResponseBuilder>,
        PaginatedListResponse<ListPackagesForShipmentApiPkg> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListPackagesForShipmentApiResponse(
          [updates(ListPackagesForShipmentApiResponseBuilder b)]) =
  ...
  static Serializer<ListPackagesForShipmentApiResponse> get serializer =>
      _$listPackagesForShipmentApiResponseSerializer;
}

abstract class ListPackagesForShipmentApiResponseActions extends ModelActions<
  ...
  factory ListPackagesForShipmentApiResponseActions(
          ListPackagesForShipmentApiResponseActionsOptions options) =>
      _$ListPackagesForShipmentApiResponseActions(options);
}
