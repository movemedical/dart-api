...
abstract class ListBackToBackPicksApiPick
    implements
        Built<ListBackToBackPicksApiPick, ListBackToBackPicksApiPickBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListBackToBackPicksApiPick(
          [updates(ListBackToBackPicksApiPickBuilder b)]) =
  ...
  static Serializer<ListBackToBackPicksApiPick> get serializer =>
      _$listBackToBackPicksApiPickSerializer;
}

abstract class ListBackToBackPicksApiPickActions extends ModelActions<
    ListBackToBackPicksApiPick,
    ListBackToBackPicksApiPickBuilder,
    ListBackToBackPicksApiPickActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListBackToBackPicksApiPickActions(
          ListBackToBackPicksApiPickActionsOptions options) =>
      _$ListBackToBackPicksApiPickActions(options);
}
