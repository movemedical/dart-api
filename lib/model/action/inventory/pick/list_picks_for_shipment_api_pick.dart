...
abstract class ListPicksForShipmentApiPick
    implements
        Built<ListPicksForShipmentApiPick, ListPicksForShipmentApiPickBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListPicksForShipmentApiPick(
          [updates(ListPicksForShipmentApiPickBuilder b)]) =
  ...
  static Serializer<ListPicksForShipmentApiPick> get serializer =>
      _$listPicksForShipmentApiPickSerializer;
}

abstract class ListPicksForShipmentApiPickActions extends ModelActions<
    ListPicksForShipmentApiPick,
    ListPicksForShipmentApiPickBuilder,
    ListPicksForShipmentApiPickActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListPicksForShipmentApiPickActions(
          ListPicksForShipmentApiPickActionsOptions options) =>
      _$ListPicksForShipmentApiPickActions(options);
}
