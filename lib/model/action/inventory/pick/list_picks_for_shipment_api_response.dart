...
abstract class ListPicksForShipmentApiResponse
    implements
        Built<ListPicksForShipmentApiResponse,
            ListPicksForShipmentApiResponseBuilder>,
        PaginatedListResponse<ListPicksForShipmentApiPick> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListPicksForShipmentApiResponse(
          [updates(ListPicksForShipmentApiResponseBuilder b)]) =
  ...
  static Serializer<ListPicksForShipmentApiResponse> get serializer =>
      _$listPicksForShipmentApiResponseSerializer;
}

abstract class ListPicksForShipmentApiResponseActions extends ModelActions<
    ListPicksForShipmentApiResponse,
    ListPicksForShipmentApiResponseBuilder,
    ListPicksForShipmentApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListPicksForShipmentApiResponseActions(
          ListPicksForShipmentApiResponseActionsOptions options) =>
      _$ListPicksForShipmentApiResponseActions(options);
}
