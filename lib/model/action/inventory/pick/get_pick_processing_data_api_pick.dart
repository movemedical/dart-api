...
abstract class GetPickProcessingDataApiPick
    implements
        Built<GetPickProcessingDataApiPick,
  ...
  factory GetPickProcessingDataApiPick(
          [updates(GetPickProcessingDataApiPickBuilder b)]) =
  ...
  static Serializer<GetPickProcessingDataApiPick> get serializer =>
      _$getPickProcessingDataApiPickSerializer;
}

abstract class GetPickProcessingDataApiPickActions extends ModelActions<
    GetPickProcessingDataApiPick,
    GetPickProcessingDataApiPickBuilder,
    GetPickProcessingDataApiPickActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetPickProcessingDataApiPickActions(
          GetPickProcessingDataApiPickActionsOptions options) =>
      _$GetPickProcessingDataApiPickActions(options);
}
