...
abstract class CreatePicks2ApiVirtualStockData
    implements
        Built<CreatePicks2ApiVirtualStockData,
  ...
  factory CreatePicks2ApiVirtualStockData(
          [updates(CreatePicks2ApiVirtualStockDataBuilder b)]) =
  ...
  static Serializer<CreatePicks2ApiVirtualStockData> get serializer =>
      _$createPicks2ApiVirtualStockDataSerializer;
}

abstract class CreatePicks2ApiVirtualStockDataActions extends ModelActions<
  ...
  factory CreatePicks2ApiVirtualStockDataActions(
          CreatePicks2ApiVirtualStockDataActionsOptions options) =>
      _$CreatePicks2ApiVirtualStockDataActions(options);
}
