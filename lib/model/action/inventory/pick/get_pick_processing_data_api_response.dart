...
abstract class GetPickProcessingDataApiResponse implements Built<GetPickProcessingDataApiResponse, GetPickProcessingDataApiResponseBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetPickProcessingDataApiResponse([updates(GetPickProcessingDataApiResponseBuilder b)]) = _$GetPickProcessingDataApiResponse;
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<GetPickProcessingDataApiResponse> get serializer => _$getPickProcessingDataApiResponseSerializer;
}

abstract class GetPickProcessingDataApiResponseActions extends ModelActions<GetPickProcessingDataApiResponse, GetPickProcessingDataApiResponseBuilder, GetPickProcessingDataApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetPickProcessingDataApiResponseActions(GetPickProcessingDataApiResponseActionsOptions options) => _$GetPickProcessingDataApiResponseActions(options);
}
