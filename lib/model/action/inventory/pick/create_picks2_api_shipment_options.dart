...
abstract class CreatePicks2ApiShipmentOptions
    implements
        Built<CreatePicks2ApiShipmentOptions,
  ...
  factory CreatePicks2ApiShipmentOptions(
          [updates(CreatePicks2ApiShipmentOptionsBuilder b)]) =
  ...
  static Serializer<CreatePicks2ApiShipmentOptions> get serializer =>
      _$createPicks2ApiShipmentOptionsSerializer;
}

abstract class CreatePicks2ApiShipmentOptionsActions extends ModelActions<
  ...
  factory CreatePicks2ApiShipmentOptionsActions(
          CreatePicks2ApiShipmentOptionsActionsOptions options) =>
      _$CreatePicks2ApiShipmentOptionsActions(options);
}
