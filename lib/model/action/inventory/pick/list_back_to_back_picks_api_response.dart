...
abstract class ListBackToBackPicksApiResponse
    implements
        Built<ListBackToBackPicksApiResponse,
            ListBackToBackPicksApiResponseBuilder>,
        PaginatedListResponse<ListBackToBackPicksApiPick> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListBackToBackPicksApiResponse(
          [updates(ListBackToBackPicksApiResponseBuilder b)]) =
  ...
  static Serializer<ListBackToBackPicksApiResponse> get serializer =>
      _$listBackToBackPicksApiResponseSerializer;
}

abstract class ListBackToBackPicksApiResponseActions extends ModelActions<
    ListBackToBackPicksApiResponse,
    ListBackToBackPicksApiResponseBuilder,
    ListBackToBackPicksApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListBackToBackPicksApiResponseActions(
          ListBackToBackPicksApiResponseActionsOptions options) =>
      _$ListBackToBackPicksApiResponseActions(options);
}
