...
class ListTagsApiOrderBy extends EnumClass {
  ...
  static ListTagsApiOrderBy valueOf(String name) => _$listTagsApiOrderByValueOf(name);
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<ListTagsApiOrderBy> get serializer => _$listTagsApiOrderBySerializer;
}
