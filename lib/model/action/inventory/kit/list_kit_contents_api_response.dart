...
abstract class ListKitContentsApiResponse
    implements
        Built<ListKitContentsApiResponse, ListKitContentsApiResponseBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListKitContentsApiResponse(
          [updates(ListKitContentsApiResponseBuilder b)]) =
  ...
  static Serializer<ListKitContentsApiResponse> get serializer =>
      _$listKitContentsApiResponseSerializer;
}

abstract class ListKitContentsApiResponseActions extends ModelActions<
    ListKitContentsApiResponse,
    ListKitContentsApiResponseBuilder,
    ListKitContentsApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListKitContentsApiResponseActions(
          ListKitContentsApiResponseActionsOptions options) =>
      _$ListKitContentsApiResponseActions(options);
}
