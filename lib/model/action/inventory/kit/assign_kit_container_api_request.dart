...
abstract class AssignKitContainerApiRequest
    implements
        Built<AssignKitContainerApiRequest,
  ...
  factory AssignKitContainerApiRequest(
          [updates(AssignKitContainerApiRequestBuilder b)]) =
  ...
  static Serializer<AssignKitContainerApiRequest> get serializer =>
      _$assignKitContainerApiRequestSerializer;
}

abstract class AssignKitContainerApiRequestActions extends ModelActions<
    AssignKitContainerApiRequest,
    AssignKitContainerApiRequestBuilder,
    AssignKitContainerApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory AssignKitContainerApiRequestActions(
          AssignKitContainerApiRequestActionsOptions options) =>
      _$AssignKitContainerApiRequestActions(options);
}
