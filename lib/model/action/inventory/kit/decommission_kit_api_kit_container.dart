...
abstract class DecommissionKitApiKitContainer
    implements
        Built<DecommissionKitApiKitContainer,
  ...
  factory DecommissionKitApiKitContainer(
          [updates(DecommissionKitApiKitContainerBuilder b)]) =
  ...
  static Serializer<DecommissionKitApiKitContainer> get serializer =>
      _$decommissionKitApiKitContainerSerializer;
}

abstract class DecommissionKitApiKitContainerActions extends ModelActions<
    DecommissionKitApiKitContainer,
    DecommissionKitApiKitContainerBuilder,
    DecommissionKitApiKitContainerActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory DecommissionKitApiKitContainerActions(
          DecommissionKitApiKitContainerActionsOptions options) =>
      _$DecommissionKitApiKitContainerActions(options);
}
