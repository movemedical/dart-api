...
abstract class BuildInspectionApiUpdateExpectedStock
    implements
        Built<BuildInspectionApiUpdateExpectedStock,
  ...
  factory BuildInspectionApiUpdateExpectedStock(
          [updates(BuildInspectionApiUpdateExpectedStockBuilder b)]) =
  ...
  static Serializer<BuildInspectionApiUpdateExpectedStock> get serializer =>
      _$buildInspectionApiUpdateExpectedStockSerializer;
}

abstract class BuildInspectionApiUpdateExpectedStockActions
    extends ModelActions<
        BuildInspectionApiUpdateExpectedStock,
        BuildInspectionApiUpdateExpectedStockBuilder,
        BuildInspectionApiUpdateExpectedStockActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory BuildInspectionApiUpdateExpectedStockActions(
          BuildInspectionApiUpdateExpectedStockActionsOptions options) =>
      _$BuildInspectionApiUpdateExpectedStockActions(options);
}
