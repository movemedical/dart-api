...
abstract class BuildInspectionApiResponse implements Built<BuildInspectionApiResponse, BuildInspectionApiResponseBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory BuildInspectionApiResponse([updates(BuildInspectionApiResponseBuilder b)]) = _$BuildInspectionApiResponse;
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<BuildInspectionApiResponse> get serializer => _$buildInspectionApiResponseSerializer;
}

abstract class BuildInspectionApiResponseActions extends ModelActions<BuildInspectionApiResponse, BuildInspectionApiResponseBuilder, BuildInspectionApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  FieldDispatcher<BuiltList<BuildInspectionApiExpectedStock>> get expectedStocks;
  
  FieldDispatcher<BuiltList<BuildInspectionApiEntryReceiptOverride>> get receiptOverrides;
  ...
  factory BuildInspectionApiResponseActions(BuildInspectionApiResponseActionsOptions options) => _$BuildInspectionApiResponseActions(options);
}
