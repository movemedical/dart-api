...
abstract class BuildInspectionApiExpectedStock
    implements
        Built<BuildInspectionApiExpectedStock,
  ...
  factory BuildInspectionApiExpectedStock(
          [updates(BuildInspectionApiExpectedStockBuilder b)]) =
  ...
  static Serializer<BuildInspectionApiExpectedStock> get serializer =>
      _$buildInspectionApiExpectedStockSerializer;
}

abstract class BuildInspectionApiExpectedStockActions extends ModelActions<
    BuildInspectionApiExpectedStock,
    BuildInspectionApiExpectedStockBuilder,
    BuildInspectionApiExpectedStockActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  FieldDispatcher<BuiltList<BuildInspectionApiMissingExpectedStockOption>>
      get options;
  ...
  factory BuildInspectionApiExpectedStockActions(
          BuildInspectionApiExpectedStockActionsOptions options) =>
      _$BuildInspectionApiExpectedStockActions(options);
}
