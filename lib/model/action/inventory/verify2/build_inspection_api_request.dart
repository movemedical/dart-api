...
abstract class BuildInspectionApiRequest
    implements
        Built<BuildInspectionApiRequest, BuildInspectionApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory BuildInspectionApiRequest(
          [updates(BuildInspectionApiRequestBuilder b)]) =
  ...
  static Serializer<BuildInspectionApiRequest> get serializer =>
      _$buildInspectionApiRequestSerializer;
}

abstract class BuildInspectionApiRequestActions extends ModelActions<
    BuildInspectionApiRequest,
    BuildInspectionApiRequestBuilder,
    BuildInspectionApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  FieldDispatcher<BuiltList<BuildInspectionApiUpdateExpectedStock>>
      get expectedStockUpdates;
  ...
  factory BuildInspectionApiRequestActions(
          BuildInspectionApiRequestActionsOptions options) =>
      _$BuildInspectionApiRequestActions(options);
}
