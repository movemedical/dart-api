...
abstract class BuildInspectionApiSupportingInfo implements Built<BuildInspectionApiSupportingInfo, BuildInspectionApiSupportingInfoBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory BuildInspectionApiSupportingInfo([updates(BuildInspectionApiSupportingInfoBuilder b)]) = _$BuildInspectionApiSupportingInfo;
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<BuildInspectionApiSupportingInfo> get serializer => _$buildInspectionApiSupportingInfoSerializer;
}

abstract class BuildInspectionApiSupportingInfoActions extends ModelActions<BuildInspectionApiSupportingInfo, BuildInspectionApiSupportingInfoBuilder, BuildInspectionApiSupportingInfoActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  FieldDispatcher<BuiltList<BuildInspectionApiTrayStandardImageFile>> get trayStandardImageFiles;
  ...
  factory BuildInspectionApiSupportingInfoActions(BuildInspectionApiSupportingInfoActionsOptions options) => _$BuildInspectionApiSupportingInfoActions(options);
}
