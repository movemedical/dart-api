...
abstract class ListShipmentsApiShipment
    implements
        Built<ListShipmentsApiShipment, ListShipmentsApiShipmentBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListShipmentsApiShipment(
          [updates(ListShipmentsApiShipmentBuilder b)]) =
  ...
  static Serializer<ListShipmentsApiShipment> get serializer =>
      _$listShipmentsApiShipmentSerializer;
}

abstract class ListShipmentsApiShipmentActions extends ModelActions<
    ListShipmentsApiShipment,
    ListShipmentsApiShipmentBuilder,
    ListShipmentsApiShipmentActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListShipmentsApiShipmentActions(
          ListShipmentsApiShipmentActionsOptions options) =>
      _$ListShipmentsApiShipmentActions(options);
}
