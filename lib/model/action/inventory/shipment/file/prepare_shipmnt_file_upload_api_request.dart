...
abstract class PrepareShipmntFileUploadApiRequest
    implements
        Built<PrepareShipmntFileUploadApiRequest,
  ...
  factory PrepareShipmntFileUploadApiRequest(
          [updates(PrepareShipmntFileUploadApiRequestBuilder b)]) =
  ...
  static Serializer<PrepareShipmntFileUploadApiRequest> get serializer =>
      _$prepareShipmntFileUploadApiRequestSerializer;
}

abstract class PrepareShipmntFileUploadApiRequestActions extends ModelActions<
    PrepareShipmntFileUploadApiRequest,
    PrepareShipmntFileUploadApiRequestBuilder,
    PrepareShipmntFileUploadApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory PrepareShipmntFileUploadApiRequestActions(
          PrepareShipmntFileUploadApiRequestActionsOptions options) =>
      _$PrepareShipmntFileUploadApiRequestActions(options);
}
