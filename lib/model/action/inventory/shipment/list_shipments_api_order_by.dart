...
class ListShipmentsApiOrderBy extends EnumClass {
  ...
  static const ListShipmentsApiOrderBy SHIPPING_SERVICE =
      _$wireSHIPPING_SERVICE;
  static const ListShipmentsApiOrderBy FULFILLMENT_CUTOFF =
  ...
  static BuiltSet<ListShipmentsApiOrderBy> get values =>
      _$listShipmentsApiOrderByValues;

  static ListShipmentsApiOrderBy valueOf(String name) =>
      _$listShipmentsApiOrderByValueOf(name);

  ////////////////////////////////
  /// Serializer
  ////////////////////////////////

  static Serializer<ListShipmentsApiOrderBy> get serializer =>
      _$listShipmentsApiOrderBySerializer;
}
