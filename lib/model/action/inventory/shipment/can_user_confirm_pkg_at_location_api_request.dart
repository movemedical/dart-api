...
abstract class CanUserConfirmPkgAtLocationApiRequest
    implements
        Built<CanUserConfirmPkgAtLocationApiRequest,
  ...
  factory CanUserConfirmPkgAtLocationApiRequest(
          [updates(CanUserConfirmPkgAtLocationApiRequestBuilder b)]) =
  ...
  static Serializer<CanUserConfirmPkgAtLocationApiRequest> get serializer =>
      _$canUserConfirmPkgAtLocationApiRequestSerializer;
}

abstract class CanUserConfirmPkgAtLocationApiRequestActions
    extends ModelActions<
        CanUserConfirmPkgAtLocationApiRequest,
        CanUserConfirmPkgAtLocationApiRequestBuilder,
        CanUserConfirmPkgAtLocationApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CanUserConfirmPkgAtLocationApiRequestActions(
          CanUserConfirmPkgAtLocationApiRequestActionsOptions options) =>
      _$CanUserConfirmPkgAtLocationApiRequestActions(options);
}
