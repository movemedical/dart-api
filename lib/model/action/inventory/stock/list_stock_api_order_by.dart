...
class ListStockApiOrderBy extends EnumClass {
  ...
  static BuiltSet<ListStockApiOrderBy> get values => _$listStockApiOrderByValues;
  
  static ListStockApiOrderBy valueOf(String name) => _$listStockApiOrderByValueOf(name);
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<ListStockApiOrderBy> get serializer => _$listStockApiOrderBySerializer;
}
