...
abstract class BarcodeScansToStockApiResponse
    implements
        Built<BarcodeScansToStockApiResponse,
  ...
  factory BarcodeScansToStockApiResponse(
          [updates(BarcodeScansToStockApiResponseBuilder b)]) =
  ...
  static Serializer<BarcodeScansToStockApiResponse> get serializer =>
      _$barcodeScansToStockApiResponseSerializer;
}

abstract class BarcodeScansToStockApiResponseActions extends ModelActions<
    BarcodeScansToStockApiResponse,
    BarcodeScansToStockApiResponseBuilder,
    BarcodeScansToStockApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory BarcodeScansToStockApiResponseActions(
          BarcodeScansToStockApiResponseActionsOptions options) =>
      _$BarcodeScansToStockApiResponseActions(options);
}
