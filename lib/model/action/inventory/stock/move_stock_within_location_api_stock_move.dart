...
abstract class MoveStockWithinLocationApiStockMove
    implements
        Built<MoveStockWithinLocationApiStockMove,
  ...
  factory MoveStockWithinLocationApiStockMove(
          [updates(MoveStockWithinLocationApiStockMoveBuilder b)]) =
  ...
  static Serializer<MoveStockWithinLocationApiStockMove> get serializer =>
      _$moveStockWithinLocationApiStockMoveSerializer;
}

abstract class MoveStockWithinLocationApiStockMoveActions extends ModelActions<
    MoveStockWithinLocationApiStockMove,
    MoveStockWithinLocationApiStockMoveBuilder,
    MoveStockWithinLocationApiStockMoveActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory MoveStockWithinLocationApiStockMoveActions(
          MoveStockWithinLocationApiStockMoveActionsOptions options) =>
      _$MoveStockWithinLocationApiStockMoveActions(options);
}
