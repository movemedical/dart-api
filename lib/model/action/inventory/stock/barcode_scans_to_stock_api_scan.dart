...
abstract class BarcodeScansToStockApiScan
    implements
        Built<BarcodeScansToStockApiScan, BarcodeScansToStockApiScanBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory BarcodeScansToStockApiScan(
          [updates(BarcodeScansToStockApiScanBuilder b)]) =
  ...
  static Serializer<BarcodeScansToStockApiScan> get serializer =>
      _$barcodeScansToStockApiScanSerializer;
}

abstract class BarcodeScansToStockApiScanActions extends ModelActions<
  ...
  factory BarcodeScansToStockApiScanActions(
          BarcodeScansToStockApiScanActionsOptions options) =>
      _$BarcodeScansToStockApiScanActions(options);
}
