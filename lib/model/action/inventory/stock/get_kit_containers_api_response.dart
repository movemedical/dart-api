...
abstract class GetKitContainersApiResponse
    implements
        Built<GetKitContainersApiResponse, GetKitContainersApiResponseBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetKitContainersApiResponse(
          [updates(GetKitContainersApiResponseBuilder b)]) =
  ...
  static Serializer<GetKitContainersApiResponse> get serializer =>
      _$getKitContainersApiResponseSerializer;
}

abstract class GetKitContainersApiResponseActions extends ModelActions<
    GetKitContainersApiResponse,
    GetKitContainersApiResponseBuilder,
    GetKitContainersApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetKitContainersApiResponseActions(
          GetKitContainersApiResponseActionsOptions options) =>
      _$GetKitContainersApiResponseActions(options);
}
