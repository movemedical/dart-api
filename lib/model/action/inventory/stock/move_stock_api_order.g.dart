...
part of 'move_stock_api_order.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<MoveStockApiOrder> _$moveStockApiOrderSerializer =
    new _$MoveStockApiOrderSerializer();

class _$MoveStockApiOrderSerializer
    implements StructuredSerializer<MoveStockApiOrder> {
  @override
  final Iterable<Type> types = const [MoveStockApiOrder, _$MoveStockApiOrder];
  @override
  final String wireName =
      'movemedical_api/model/action/inventory/stock/MoveStockApiOrder';

  @override
  Iterable serialize(Serializers serializers, MoveStockApiOrder object,
      ...
      result
        ...
        ..add(serializers.serialize(object.shipments,
            specifiedType: const FullType(
                BuiltList, const [const FullType(MoveStockApiShipment)])));
    }
  ...
  @override
  MoveStockApiOrder deserialize(Serializers serializers, Iterable serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new MoveStockApiOrderBuilder();
...
class _$MoveStockApiOrder extends MoveStockApiOrder {
  @override
  final String loanId;
  @override
  ...
  @override
  final BuiltList<MoveStockApiShipment> shipments;

  factory _$MoveStockApiOrder([void updates(MoveStockApiOrderBuilder b)]) =>
      (new MoveStockApiOrderBuilder()..update(updates)).build();

  _$MoveStockApiOrder._(
      {this.loanId,
      this.orderReasonId,
      this.toLocationType,
      this.toLocationId,
  ...
  @override
  MoveStockApiOrder rebuild(void updates(MoveStockApiOrderBuilder b)) =>
      (toBuilder()..update(updates)).build();

  @override
  MoveStockApiOrderBuilder toBuilder() =>
      new MoveStockApiOrderBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is MoveStockApiOrder &&
        loanId == other.loanId &&
                                                        ...
                                                        $jc(
                                                            $jc(
                                                                $jc(
                                                                    $jc(
                                                                        $jc(
                                                                            $jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc(0, loanId.hashCode), orderReasonId.hashCode), toLocationType.hashCode), toLocationId.hashCode), opsOrgUnitId.hashCode), salesOrgUnitId.hashCode), toInventoryTypeId.hashCode), toResponsiblePartyType.hashCode), toResponsiblePartyId.hashCode), toHomeLocationType.hashCode), toHomeLocationId.hashCode), erpReference.hashCode),
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('MoveStockApiOrder')
          ..add('loanId', loanId)
...
class MoveStockApiOrderBuilder
    implements Builder<MoveStockApiOrder, MoveStockApiOrderBuilder> {
  _$MoveStockApiOrder _$v;
  ...
  ListBuilder<MoveStockApiShipment> _shipments;
  ListBuilder<MoveStockApiShipment> get shipments =>
      _$this._shipments ??= new ListBuilder<MoveStockApiShipment>();
  set shipments(ListBuilder<MoveStockApiShipment> shipments) =>
      _$this._shipments = shipments;

  MoveStockApiOrderBuilder();

  MoveStockApiOrderBuilder get _$this {
    if (_$v != null) {
      _loanId = _$v.loanId;
  ...
  @override
  void replace(MoveStockApiOrder other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$MoveStockApiOrder;
  }

  @override
  void update(void updates(MoveStockApiOrderBuilder b)) {
    if (updates != null) updates(this);
  }

  @override
  _$MoveStockApiOrder build() {
    _$MoveStockApiOrder _$result;
    try {
      _$result = _$v ??
          new _$MoveStockApiOrder._(
              loanId: loanId,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'MoveStockApiOrder', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
typedef StatefulActionsOptions<MoveStockApiOrder, MoveStockApiOrderBuilder,
    MoveStockApiOrderActions> MoveStockApiOrderActionsOptions();

class _$MoveStockApiOrderActions extends MoveStockApiOrderActions {
  final StatefulActionsOptions<MoveStockApiOrder, MoveStockApiOrderBuilder,
      MoveStockApiOrderActions> $options;

  final ActionDispatcher<MoveStockApiOrder> $replace;
  ...
  final FieldDispatcher<BuiltList<MoveStockApiShipment>> shipments;
  ...
  factory _$MoveStockApiOrderActions(MoveStockApiOrderActionsOptions options) =>
      _$MoveStockApiOrderActions._(options());

  @override
  MoveStockApiOrder get $initial => MoveStockApiOrder();

  @override
  MoveStockApiOrderBuilder $newBuilder() => MoveStockApiOrderBuilder();
  ...
  FullType _$fullType;
  @override
  FullType get $fullType => _$fullType ??= FullType(MoveStockApiOrder);
}
