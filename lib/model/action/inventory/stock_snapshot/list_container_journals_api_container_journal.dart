...
abstract class ListContainerJournalsApiContainerJournal implements Built<ListContainerJournalsApiContainerJournal, ListContainerJournalsApiContainerJournalBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListContainerJournalsApiContainerJournal([updates(ListContainerJournalsApiContainerJournalBuilder b)]) = _$ListContainerJournalsApiContainerJournal;
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<ListContainerJournalsApiContainerJournal> get serializer => _$listContainerJournalsApiContainerJournalSerializer;
}

abstract class ListContainerJournalsApiContainerJournalActions extends ModelActions<ListContainerJournalsApiContainerJournal, ListContainerJournalsApiContainerJournalBuilder, ListContainerJournalsApiContainerJournalActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListContainerJournalsApiContainerJournalActions(ListContainerJournalsApiContainerJournalActionsOptions options) => _$ListContainerJournalsApiContainerJournalActions(options);
}
