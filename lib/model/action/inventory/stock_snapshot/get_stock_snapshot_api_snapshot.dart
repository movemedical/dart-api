...
abstract class GetStockSnapshotApiSnapshot implements Built<GetStockSnapshotApiSnapshot, GetStockSnapshotApiSnapshotBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetStockSnapshotApiSnapshot([updates(GetStockSnapshotApiSnapshotBuilder b)]) = _$GetStockSnapshotApiSnapshot;
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<GetStockSnapshotApiSnapshot> get serializer => _$getStockSnapshotApiSnapshotSerializer;
}

abstract class GetStockSnapshotApiSnapshotActions extends ModelActions<GetStockSnapshotApiSnapshot, GetStockSnapshotApiSnapshotBuilder, GetStockSnapshotApiSnapshotActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetStockSnapshotApiSnapshotActions(GetStockSnapshotApiSnapshotActionsOptions options) => _$GetStockSnapshotApiSnapshotActions(options);
}
