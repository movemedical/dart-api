...
abstract class ListLocationJournalsApiResponse
    implements
        Built<ListLocationJournalsApiResponse,
            ListLocationJournalsApiResponseBuilder>,
        PaginatedListResponse<ListLocationJournalsApiLocationJournal> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListLocationJournalsApiResponse(
          [updates(ListLocationJournalsApiResponseBuilder b)]) =
  ...
  static Serializer<ListLocationJournalsApiResponse> get serializer =>
      _$listLocationJournalsApiResponseSerializer;
}

abstract class ListLocationJournalsApiResponseActions extends ModelActions<
    ListLocationJournalsApiResponse,
    ListLocationJournalsApiResponseBuilder,
    ListLocationJournalsApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListLocationJournalsApiResponseActions(
          ListLocationJournalsApiResponseActionsOptions options) =>
      _$ListLocationJournalsApiResponseActions(options);
}
