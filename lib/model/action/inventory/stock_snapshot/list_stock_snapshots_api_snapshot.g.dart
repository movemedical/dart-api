...
part of 'list_stock_snapshots_api_snapshot.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<ListStockSnapshotsApiSnapshot>
    _$listStockSnapshotsApiSnapshotSerializer =
    new _$ListStockSnapshotsApiSnapshotSerializer();

class _$ListStockSnapshotsApiSnapshotSerializer
    implements StructuredSerializer<ListStockSnapshotsApiSnapshot> {
  @override
  final Iterable<Type> types = const [
    ListStockSnapshotsApiSnapshot,
    _$ListStockSnapshotsApiSnapshot
  ];
  @override
  final String wireName =
      'movemedical_api/model/action/inventory/stock_snapshot/ListStockSnapshotsApiSnapshot';

  @override
  Iterable serialize(
      Serializers serializers, ListStockSnapshotsApiSnapshot object,
    ...
    if (object.transactionReferenceDisplayText != null) {
      result
        ..add('transactionReferenceDisplayText')
        ..add(serializers.serialize(object.transactionReferenceDisplayText,
            specifiedType: const FullType(String)));
    }
  ...
  @override
  ListStockSnapshotsApiSnapshot deserialize(
      Serializers serializers, Iterable serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new ListStockSnapshotsApiSnapshotBuilder();
      ...
      switch (key) {
        ...
        case 'transactionReferenceId':
          result.transactionReferenceId = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String;
          break;
        case 'transactionReferenceDisplayText':
          result.transactionReferenceDisplayText = serializers.deserialize(
              value,
              specifiedType: const FullType(String)) as String;
          break;
        case 'stockPlace':
...
class _$ListStockSnapshotsApiSnapshot extends ListStockSnapshotsApiSnapshot {
  @override
  final String id;
  @override
  ...
  @override
  final String transactionReferenceDisplayText;
  @override
  ...
  factory _$ListStockSnapshotsApiSnapshot(
          [void updates(ListStockSnapshotsApiSnapshotBuilder b)]) =>
      (new ListStockSnapshotsApiSnapshotBuilder()..update(updates)).build();

  _$ListStockSnapshotsApiSnapshot._(
      {this.id,
      this.transactionType,
      this.transactionReferenceType,
      this.transactionReferenceId,
      this.transactionReferenceDisplayText,
      this.stockPlace,
  ...
  @override
  ListStockSnapshotsApiSnapshot rebuild(
          void updates(ListStockSnapshotsApiSnapshotBuilder b)) =>
      (toBuilder()..update(updates)).build();

  @override
  ListStockSnapshotsApiSnapshotBuilder toBuilder() =>
      new ListStockSnapshotsApiSnapshotBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ListStockSnapshotsApiSnapshot &&
        id == other.id &&
        transactionType == other.transactionType &&
        transactionReferenceType == other.transactionReferenceType &&
        transactionReferenceId == other.transactionReferenceId &&
        transactionReferenceDisplayText ==
            other.transactionReferenceDisplayText &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('ListStockSnapshotsApiSnapshot')
          ..add('id', id)
...
class ListStockSnapshotsApiSnapshotBuilder
    implements
        Builder<ListStockSnapshotsApiSnapshot,
  ...
  ListStockSnapshotsApiSnapshotBuilder get _$this {
    if (_$v != null) {
      _id = _$v.id;
      _transactionType = _$v.transactionType;
      _transactionReferenceType = _$v.transactionReferenceType;
      _transactionReferenceId = _$v.transactionReferenceId;
      _transactionReferenceDisplayText = _$v.transactionReferenceDisplayText;
  ...
  @override
  void replace(ListStockSnapshotsApiSnapshot other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$ListStockSnapshotsApiSnapshot;
  }

  @override
  void update(void updates(ListStockSnapshotsApiSnapshotBuilder b)) {
    if (updates != null) updates(this);
  }

  @override
  _$ListStockSnapshotsApiSnapshot build() {
    _$ListStockSnapshotsApiSnapshot _$result;
    try {
      _$result = _$v ??
          new _$ListStockSnapshotsApiSnapshot._(
              id: id,
              transactionType: transactionType,
              transactionReferenceType: transactionReferenceType,
              transactionReferenceId: transactionReferenceId,
              transactionReferenceDisplayText: transactionReferenceDisplayText,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'ListStockSnapshotsApiSnapshot', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
typedef StatefulActionsOptions<
    ListStockSnapshotsApiSnapshot,
    ListStockSnapshotsApiSnapshotBuilder,
    ListStockSnapshotsApiSnapshotActions> ListStockSnapshotsApiSnapshotActionsOptions();

class _$ListStockSnapshotsApiSnapshotActions
    extends ListStockSnapshotsApiSnapshotActions {
  final StatefulActionsOptions<
      ListStockSnapshotsApiSnapshot,
      ListStockSnapshotsApiSnapshotBuilder,
      ListStockSnapshotsApiSnapshotActions> $options;

  final ActionDispatcher<ListStockSnapshotsApiSnapshot> $replace;
  final FieldDispatcher<String> id;
  final FieldDispatcher<StockTransactionType> transactionType;
  final FieldDispatcher<StockReferenceType> transactionReferenceType;
  final FieldDispatcher<String> transactionReferenceId;
  final FieldDispatcher<String> transactionReferenceDisplayText;
  ...
  _$ListStockSnapshotsApiSnapshotActions._(this.$options)
      : $replace = $options.action<ListStockSnapshotsApiSnapshot>(
        ...
        transactionReferenceDisplayText = $options.field<String>(
            'transactionReferenceDisplayText',
            (a) => a?.transactionReferenceDisplayText,
            (s) => s?.transactionReferenceDisplayText,
            (p, b) => p?.transactionReferenceDisplayText = b),
  ...
  factory _$ListStockSnapshotsApiSnapshotActions(
          ListStockSnapshotsApiSnapshotActionsOptions options) =>
      _$ListStockSnapshotsApiSnapshotActions._(options());

  @override
  ListStockSnapshotsApiSnapshot get $initial => ListStockSnapshotsApiSnapshot();

  @override
  ListStockSnapshotsApiSnapshotBuilder $newBuilder() =>
      ListStockSnapshotsApiSnapshotBuilder();
  ...
  void $reducer(ReducerBuilder reducer) {
    ...
    id.$reducer(reducer);
    transactionType.$reducer(reducer);
    transactionReferenceType.$reducer(reducer);
    transactionReferenceId.$reducer(reducer);
    transactionReferenceDisplayText.$reducer(reducer);
