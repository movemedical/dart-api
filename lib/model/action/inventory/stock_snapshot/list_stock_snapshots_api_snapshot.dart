...
abstract class ListStockSnapshotsApiSnapshot
    implements
        Built<ListStockSnapshotsApiSnapshot,
  ...
  factory ListStockSnapshotsApiSnapshot(
          [updates(ListStockSnapshotsApiSnapshotBuilder b)]) =
  ...
  static Serializer<ListStockSnapshotsApiSnapshot> get serializer =>
      _$listStockSnapshotsApiSnapshotSerializer;
}

abstract class ListStockSnapshotsApiSnapshotActions extends ModelActions<
    ListStockSnapshotsApiSnapshot,
    ListStockSnapshotsApiSnapshotBuilder,
    ListStockSnapshotsApiSnapshotActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListStockSnapshotsApiSnapshotActions(
          ListStockSnapshotsApiSnapshotActionsOptions options) =>
      _$ListStockSnapshotsApiSnapshotActions(options);
}
