...
abstract class ListLocationJournalsApiLocationJournal
    implements
        Built<ListLocationJournalsApiLocationJournal,
  ...
  factory ListLocationJournalsApiLocationJournal(
          [updates(ListLocationJournalsApiLocationJournalBuilder b)]) =
  ...
  static Serializer<ListLocationJournalsApiLocationJournal> get serializer =>
      _$listLocationJournalsApiLocationJournalSerializer;
}

abstract class ListLocationJournalsApiLocationJournalActions
    extends ModelActions<
        ListLocationJournalsApiLocationJournal,
        ListLocationJournalsApiLocationJournalBuilder,
        ListLocationJournalsApiLocationJournalActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListLocationJournalsApiLocationJournalActions(
          ListLocationJournalsApiLocationJournalActionsOptions options) =>
      _$ListLocationJournalsApiLocationJournalActions(options);
}
