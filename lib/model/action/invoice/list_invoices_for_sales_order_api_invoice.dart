...
abstract class ListInvoicesForSalesOrderApiInvoice
    implements
        Built<ListInvoicesForSalesOrderApiInvoice,
  ...
  factory ListInvoicesForSalesOrderApiInvoice(
          [updates(ListInvoicesForSalesOrderApiInvoiceBuilder b)]) =
  ...
  static Serializer<ListInvoicesForSalesOrderApiInvoice> get serializer =>
      _$listInvoicesForSalesOrderApiInvoiceSerializer;
}

abstract class ListInvoicesForSalesOrderApiInvoiceActions extends ModelActions<
    ListInvoicesForSalesOrderApiInvoice,
    ListInvoicesForSalesOrderApiInvoiceBuilder,
    ListInvoicesForSalesOrderApiInvoiceActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListInvoicesForSalesOrderApiInvoiceActions(
          ListInvoicesForSalesOrderApiInvoiceActionsOptions options) =>
      _$ListInvoicesForSalesOrderApiInvoiceActions(options);
}
