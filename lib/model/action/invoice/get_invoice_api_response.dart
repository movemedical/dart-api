...
abstract class GetInvoiceApiResponse
    implements Built<GetInvoiceApiResponse, GetInvoiceApiResponseBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetInvoiceApiResponse([updates(GetInvoiceApiResponseBuilder b)]) =
  ...
  static Serializer<GetInvoiceApiResponse> get serializer =>
      _$getInvoiceApiResponseSerializer;
}

abstract class GetInvoiceApiResponseActions extends ModelActions<
    GetInvoiceApiResponse,
    GetInvoiceApiResponseBuilder,
    GetInvoiceApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetInvoiceApiResponseActions(
          GetInvoiceApiResponseActionsOptions options) =>
      _$GetInvoiceApiResponseActions(options);
}
