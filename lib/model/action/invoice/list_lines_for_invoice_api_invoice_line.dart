...
abstract class ListLinesForInvoiceApiInvoiceLine
    implements
        Built<ListLinesForInvoiceApiInvoiceLine,
  ...
  factory ListLinesForInvoiceApiInvoiceLine(
          [updates(ListLinesForInvoiceApiInvoiceLineBuilder b)]) =
  ...
  static Serializer<ListLinesForInvoiceApiInvoiceLine> get serializer =>
      _$listLinesForInvoiceApiInvoiceLineSerializer;
}

abstract class ListLinesForInvoiceApiInvoiceLineActions extends ModelActions<
    ListLinesForInvoiceApiInvoiceLine,
    ListLinesForInvoiceApiInvoiceLineBuilder,
    ListLinesForInvoiceApiInvoiceLineActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListLinesForInvoiceApiInvoiceLineActions(
          ListLinesForInvoiceApiInvoiceLineActionsOptions options) =>
      _$ListLinesForInvoiceApiInvoiceLineActions(options);
}
