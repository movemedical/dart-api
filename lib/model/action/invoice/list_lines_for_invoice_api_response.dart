...
abstract class ListLinesForInvoiceApiResponse
    implements
        Built<ListLinesForInvoiceApiResponse,
  ...
  factory ListLinesForInvoiceApiResponse(
          [updates(ListLinesForInvoiceApiResponseBuilder b)]) =
  ...
  static Serializer<ListLinesForInvoiceApiResponse> get serializer =>
      _$listLinesForInvoiceApiResponseSerializer;
}

abstract class ListLinesForInvoiceApiResponseActions extends ModelActions<
    ListLinesForInvoiceApiResponse,
    ListLinesForInvoiceApiResponseBuilder,
    ListLinesForInvoiceApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListLinesForInvoiceApiResponseActions(
          ListLinesForInvoiceApiResponseActionsOptions options) =>
      _$ListLinesForInvoiceApiResponseActions(options);
}
