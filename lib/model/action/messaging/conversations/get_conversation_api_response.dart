...
abstract class GetConversationApiResponse
    implements
        Built<GetConversationApiResponse, GetConversationApiResponseBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetConversationApiResponse(
          [updates(GetConversationApiResponseBuilder b)]) =
  ...
  static Serializer<GetConversationApiResponse> get serializer =>
      _$getConversationApiResponseSerializer;
}

abstract class GetConversationApiResponseActions extends ModelActions<
    GetConversationApiResponse,
    GetConversationApiResponseBuilder,
    GetConversationApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetConversationApiResponseActions(
          GetConversationApiResponseActionsOptions options) =>
      _$GetConversationApiResponseActions(options);
}
