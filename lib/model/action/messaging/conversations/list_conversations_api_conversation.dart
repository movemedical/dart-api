...
abstract class ListConversationsApiConversation
    implements
        Built<ListConversationsApiConversation,
  ...
  factory ListConversationsApiConversation(
          [updates(ListConversationsApiConversationBuilder b)]) =
  ...
  static Serializer<ListConversationsApiConversation> get serializer =>
      _$listConversationsApiConversationSerializer;
}

abstract class ListConversationsApiConversationActions extends ModelActions<
    ListConversationsApiConversation,
    ListConversationsApiConversationBuilder,
    ListConversationsApiConversationActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListConversationsApiConversationActions(
          ListConversationsApiConversationActionsOptions options) =>
      _$ListConversationsApiConversationActions(options);
}
