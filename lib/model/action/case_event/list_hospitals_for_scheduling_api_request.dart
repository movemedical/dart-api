...
abstract class ListHospitalsForSchedulingApiRequest
    implements
        Built<ListHospitalsForSchedulingApiRequest,
  ...
  factory ListHospitalsForSchedulingApiRequest(
          [updates(ListHospitalsForSchedulingApiRequestBuilder b)]) =
  ...
  static Serializer<ListHospitalsForSchedulingApiRequest> get serializer =>
      _$listHospitalsForSchedulingApiRequestSerializer;
}

abstract class ListHospitalsForSchedulingApiRequestActions extends ModelActions<
    ListHospitalsForSchedulingApiRequest,
    ListHospitalsForSchedulingApiRequestBuilder,
    ListHospitalsForSchedulingApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListHospitalsForSchedulingApiRequestActions(
          ListHospitalsForSchedulingApiRequestActionsOptions options) =>
      _$ListHospitalsForSchedulingApiRequestActions(options);
}
