...
abstract class GetCaseEventHistoryApiResponse
    implements
        Built<GetCaseEventHistoryApiResponse,
  ...
  factory GetCaseEventHistoryApiResponse(
          [updates(GetCaseEventHistoryApiResponseBuilder b)]) =
  ...
  static Serializer<GetCaseEventHistoryApiResponse> get serializer =>
      _$getCaseEventHistoryApiResponseSerializer;
}

abstract class GetCaseEventHistoryApiResponseActions extends ModelActions<
    GetCaseEventHistoryApiResponse,
    GetCaseEventHistoryApiResponseBuilder,
    GetCaseEventHistoryApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetCaseEventHistoryApiResponseActions(
          GetCaseEventHistoryApiResponseActionsOptions options) =>
      _$GetCaseEventHistoryApiResponseActions(options);
}
