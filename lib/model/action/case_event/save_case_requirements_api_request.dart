...
abstract class SaveCaseRequirementsApiRequest
    implements
        Built<SaveCaseRequirementsApiRequest,
  ...
  factory SaveCaseRequirementsApiRequest(
          [updates(SaveCaseRequirementsApiRequestBuilder b)]) =
  ...
  static Serializer<SaveCaseRequirementsApiRequest> get serializer =>
      _$saveCaseRequirementsApiRequestSerializer;
}

abstract class SaveCaseRequirementsApiRequestActions extends ModelActions<
    SaveCaseRequirementsApiRequest,
    SaveCaseRequirementsApiRequestBuilder,
    SaveCaseRequirementsApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  FieldDispatcher<BuiltList<SaveCaseRequirementsApiRequirement>>
      get requirements;
  ...
  factory SaveCaseRequirementsApiRequestActions(
          SaveCaseRequirementsApiRequestActionsOptions options) =>
      _$SaveCaseRequirementsApiRequestActions(options);
}
