...
abstract class ListCaseRequirementsApiItemRequest
    implements
        Built<ListCaseRequirementsApiItemRequest,
  ...
  factory ListCaseRequirementsApiItemRequest(
          [updates(ListCaseRequirementsApiItemRequestBuilder b)]) =
  ...
  static Serializer<ListCaseRequirementsApiItemRequest> get serializer =>
      _$listCaseRequirementsApiItemRequestSerializer;
}

abstract class ListCaseRequirementsApiItemRequestActions extends ModelActions<
    ListCaseRequirementsApiItemRequest,
    ListCaseRequirementsApiItemRequestBuilder,
    ListCaseRequirementsApiItemRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListCaseRequirementsApiItemRequestActions(
          ListCaseRequirementsApiItemRequestActionsOptions options) =>
      _$ListCaseRequirementsApiItemRequestActions(options);
}
