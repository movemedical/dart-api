...
abstract class ListCaseUsageApiCaseUsageConstruct
    implements
        Built<ListCaseUsageApiCaseUsageConstruct,
  ...
  factory ListCaseUsageApiCaseUsageConstruct(
          [updates(ListCaseUsageApiCaseUsageConstructBuilder b)]) =
  ...
  static Serializer<ListCaseUsageApiCaseUsageConstruct> get serializer =>
      _$listCaseUsageApiCaseUsageConstructSerializer;
}

abstract class ListCaseUsageApiCaseUsageConstructActions extends ModelActions<
    ListCaseUsageApiCaseUsageConstruct,
    ListCaseUsageApiCaseUsageConstructBuilder,
    ListCaseUsageApiCaseUsageConstructActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListCaseUsageApiCaseUsageConstructActions(
          ListCaseUsageApiCaseUsageConstructActionsOptions options) =>
      _$ListCaseUsageApiCaseUsageConstructActions(options);
}
