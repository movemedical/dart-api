...
abstract class ListStockForUsageApiRequest
    implements
        Built<ListStockForUsageApiRequest, ListStockForUsageApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListStockForUsageApiRequest(
          [updates(ListStockForUsageApiRequestBuilder b)]) =
  ...
  static Serializer<ListStockForUsageApiRequest> get serializer =>
      _$listStockForUsageApiRequestSerializer;
}

abstract class ListStockForUsageApiRequestActions extends ModelActions<
    ListStockForUsageApiRequest,
    ListStockForUsageApiRequestBuilder,
    ListStockForUsageApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListStockForUsageApiRequestActions(
          ListStockForUsageApiRequestActionsOptions options) =>
      _$ListStockForUsageApiRequestActions(options);
}
