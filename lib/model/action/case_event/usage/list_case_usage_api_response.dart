...
abstract class ListCaseUsageApiResponse
    implements
        Built<ListCaseUsageApiResponse, ListCaseUsageApiResponseBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListCaseUsageApiResponse(
          [updates(ListCaseUsageApiResponseBuilder b)]) =
  ...
  static Serializer<ListCaseUsageApiResponse> get serializer =>
      _$listCaseUsageApiResponseSerializer;
}

abstract class ListCaseUsageApiResponseActions extends ModelActions<
    ListCaseUsageApiResponse,
    ListCaseUsageApiResponseBuilder,
    ListCaseUsageApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListCaseUsageApiResponseActions(
          ListCaseUsageApiResponseActionsOptions options) =>
      _$ListCaseUsageApiResponseActions(options);
}
