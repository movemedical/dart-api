...
abstract class ListCaseUsageApiCaseUsageOrder
    implements
        Built<ListCaseUsageApiCaseUsageOrder,
  ...
  factory ListCaseUsageApiCaseUsageOrder(
          [updates(ListCaseUsageApiCaseUsageOrderBuilder b)]) =
  ...
  static Serializer<ListCaseUsageApiCaseUsageOrder> get serializer =>
      _$listCaseUsageApiCaseUsageOrderSerializer;
}

abstract class ListCaseUsageApiCaseUsageOrderActions extends ModelActions<
    ListCaseUsageApiCaseUsageOrder,
    ListCaseUsageApiCaseUsageOrderBuilder,
    ListCaseUsageApiCaseUsageOrderActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListCaseUsageApiCaseUsageOrderActions(
          ListCaseUsageApiCaseUsageOrderActionsOptions options) =>
      _$ListCaseUsageApiCaseUsageOrderActions(options);
}
