...
abstract class BarcodeScansToUsageApiResponse
    implements
        Built<BarcodeScansToUsageApiResponse,
  ...
  factory BarcodeScansToUsageApiResponse(
          [updates(BarcodeScansToUsageApiResponseBuilder b)]) =
  ...
  static Serializer<BarcodeScansToUsageApiResponse> get serializer =>
      _$barcodeScansToUsageApiResponseSerializer;
}

abstract class BarcodeScansToUsageApiResponseActions extends ModelActions<
    BarcodeScansToUsageApiResponse,
    BarcodeScansToUsageApiResponseBuilder,
    BarcodeScansToUsageApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory BarcodeScansToUsageApiResponseActions(
          BarcodeScansToUsageApiResponseActionsOptions options) =>
      _$BarcodeScansToUsageApiResponseActions(options);
}
