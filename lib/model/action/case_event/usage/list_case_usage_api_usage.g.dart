...
class _$ListCaseUsageApiUsageSerializer
  ...
  final String wireName =
      'movemedical_api/model/action/case_event/usage/ListCaseUsageApiUsage';
  ...
  Iterable serialize(Serializers serializers, ListCaseUsageApiUsage object,
    ...
    if (object.billingCodeName != null) {
      result
        ..add('billingCodeName')
        ..add(serializers.serialize(object.billingCodeName,
            specifiedType: const FullType(String)));
    }
      ...
      switch (key) {
        ...
        case 'billingCodeId':
          result.billingCodeId = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String;
          break;
        case 'billingCodeName':
          result.billingCodeName = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String;
          break;
        case 'demandLoan':
...
class _$ListCaseUsageApiUsage extends ListCaseUsageApiUsage {
  ...
  bool operator ==(Object other) {
    ...
    return other is ListCaseUsageApiUsage &&
        ...
        billingCodeName == other.billingCodeName &&
                                                        ...
                                                        $jc(
                                                            $jc(
                                                                $jc(
                                                                    $jc(
                                                                        $jc(
                                                                            $jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc(0, id.hashCode), stockId.hashCode), stockPlace.hashCode), inventoryType.hashCode), caseUsageOrderId.hashCode), caseUsageConstructId.hashCode), stockItem.hashCode), price.hashCode), overridePrice.hashCode), hasOverridePrice.hashCode),
  ...
  String toString() {
    return (newBuiltValueToStringHelper('ListCaseUsageApiUsage')
          ...
          ..add('billingCodeName', billingCodeName)
...
class ListCaseUsageApiUsageBuilder
  ...
  ListCaseUsageApiUsageBuilder get _$this {
    if (_$v != null) {
      ...
      _billingCodeName = _$v.billingCodeName;
...
class _$ListCaseUsageApiUsageActions extends ListCaseUsageApiUsageActions {
  ...
  final FieldDispatcher<String> billingCodeName;
