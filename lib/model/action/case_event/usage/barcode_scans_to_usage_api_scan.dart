...
abstract class BarcodeScansToUsageApiScan
    implements
        Built<BarcodeScansToUsageApiScan, BarcodeScansToUsageApiScanBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory BarcodeScansToUsageApiScan(
          [updates(BarcodeScansToUsageApiScanBuilder b)]) =
  ...
  static Serializer<BarcodeScansToUsageApiScan> get serializer =>
      _$barcodeScansToUsageApiScanSerializer;
}

abstract class BarcodeScansToUsageApiScanActions extends ModelActions<
    BarcodeScansToUsageApiScan,
    BarcodeScansToUsageApiScanBuilder,
    BarcodeScansToUsageApiScanActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory BarcodeScansToUsageApiScanActions(
          BarcodeScansToUsageApiScanActionsOptions options) =>
      _$BarcodeScansToUsageApiScanActions(options);
}
