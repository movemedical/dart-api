...
import 'package:movemedical_api/model/action/case_event/usage/barcode_scans_to_usage_api_scan.dart';

part 'barcode_scans_to_usage_api_request.g.dart';

abstract class BarcodeScansToUsageApiRequest
    implements
        Built<BarcodeScansToUsageApiRequest,
  ...
  factory BarcodeScansToUsageApiRequest(
          [updates(BarcodeScansToUsageApiRequestBuilder b)]) =
  ...
  static Serializer<BarcodeScansToUsageApiRequest> get serializer =>
      _$barcodeScansToUsageApiRequestSerializer;
}

abstract class BarcodeScansToUsageApiRequestActions extends ModelActions<
    BarcodeScansToUsageApiRequest,
    BarcodeScansToUsageApiRequestBuilder,
    BarcodeScansToUsageApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory BarcodeScansToUsageApiRequestActions(
          BarcodeScansToUsageApiRequestActionsOptions options) =>
      _$BarcodeScansToUsageApiRequestActions(options);
}
