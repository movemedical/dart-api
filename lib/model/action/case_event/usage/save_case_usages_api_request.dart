...
import 'package:movemedical_api/model/action/case_event/usage/save_case_usages_api_usage.dart';
import 'package:movemedical_api/model/action/case_event/usage/save_case_usages_api_usage_order.dart';

part 'save_case_usages_api_request.g.dart';

abstract class SaveCaseUsagesApiRequest
    implements
        Built<SaveCaseUsagesApiRequest, SaveCaseUsagesApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory SaveCaseUsagesApiRequest(
          [updates(SaveCaseUsagesApiRequestBuilder b)]) =
  ...
  static Serializer<SaveCaseUsagesApiRequest> get serializer =>
      _$saveCaseUsagesApiRequestSerializer;
}

abstract class SaveCaseUsagesApiRequestActions extends ModelActions<
  ...
  factory SaveCaseUsagesApiRequestActions(
          SaveCaseUsagesApiRequestActionsOptions options) =>
      _$SaveCaseUsagesApiRequestActions(options);
}
