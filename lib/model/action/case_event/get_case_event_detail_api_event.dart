...
abstract class GetCaseEventDetailApiEvent
    implements
        Built<GetCaseEventDetailApiEvent, GetCaseEventDetailApiEventBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetCaseEventDetailApiEvent(
          [updates(GetCaseEventDetailApiEventBuilder b)]) =
  ...
  static Serializer<GetCaseEventDetailApiEvent> get serializer =>
      _$getCaseEventDetailApiEventSerializer;
}

abstract class GetCaseEventDetailApiEventActions extends ModelActions<
  ...
  factory GetCaseEventDetailApiEventActions(
          GetCaseEventDetailApiEventActionsOptions options) =>
      _$GetCaseEventDetailApiEventActions(options);
}
