...
abstract class ConfirmCaseRequirementsApiRequest
    implements
        Built<ConfirmCaseRequirementsApiRequest,
  ...
  factory ConfirmCaseRequirementsApiRequest(
          [updates(ConfirmCaseRequirementsApiRequestBuilder b)]) =
  ...
  static Serializer<ConfirmCaseRequirementsApiRequest> get serializer =>
      _$confirmCaseRequirementsApiRequestSerializer;
}

abstract class ConfirmCaseRequirementsApiRequestActions extends ModelActions<
    ConfirmCaseRequirementsApiRequest,
    ConfirmCaseRequirementsApiRequestBuilder,
    ConfirmCaseRequirementsApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ConfirmCaseRequirementsApiRequestActions(
          ConfirmCaseRequirementsApiRequestActionsOptions options) =>
      _$ConfirmCaseRequirementsApiRequestActions(options);
}
