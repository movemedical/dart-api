...
class _$ListCaseEventsApiRequestSerializer
  ...
  final String wireName =
      'movemedical_api/model/action/case_event/ListCaseEventsApiRequest';

  @override
  Iterable serialize(Serializers serializers, ListCaseEventsApiRequest object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object>[];
    if (object.canReturnCounts != null) {
      result
        ..add('canReturnCounts')
        ..add(serializers.serialize(object.canReturnCounts,
            specifiedType: const FullType(bool)));
    }
    if (object.forceReturnCounts != null) {
      result
        ..add('forceReturnCounts')
        ..add(serializers.serialize(object.forceReturnCounts,
            specifiedType: const FullType(bool)));
    }
  ...
  ListCaseEventsApiRequest deserialize(
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'canReturnCounts':
          result.canReturnCounts = serializers.deserialize(value,
              specifiedType: const FullType(bool)) as bool;
          break;
        case 'forceReturnCounts':
          result.forceReturnCounts = serializers.deserialize(value,
              specifiedType: const FullType(bool)) as bool;
          break;
        case 'startDate':
...
class _$ListCaseEventsApiRequest extends ListCaseEventsApiRequest {
  @override
  final bool canReturnCounts;
  @override
  final bool forceReturnCounts;
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is ListCaseEventsApiRequest &&
        canReturnCounts == other.canReturnCounts &&
        forceReturnCounts == other.forceReturnCounts &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper('ListCaseEventsApiRequest')
          ..add('canReturnCounts', canReturnCounts)
          ..add('forceReturnCounts', forceReturnCounts)
...
class ListCaseEventsApiRequestBuilder
  ...
  ListCaseEventsApiRequestBuilder get _$this {
    if (_$v != null) {
      _canReturnCounts = _$v.canReturnCounts;
      _forceReturnCounts = _$v.forceReturnCounts;
    ...
    try {
      _$result = _$v ??
          new _$ListCaseEventsApiRequest._(
              canReturnCounts: canReturnCounts,
              forceReturnCounts: forceReturnCounts,
              startDate: startDate,
              endDate: endDate,
