...
abstract class ListSurgeonPhysiciansForSchedulingApiResponse
    implements
        Built<ListSurgeonPhysiciansForSchedulingApiResponse,
  ...
  factory ListSurgeonPhysiciansForSchedulingApiResponse(
          [updates(ListSurgeonPhysiciansForSchedulingApiResponseBuilder b)]) =
  ...
  static Serializer<ListSurgeonPhysiciansForSchedulingApiResponse>
      get serializer =>
          _$listSurgeonPhysiciansForSchedulingApiResponseSerializer;
}

abstract class ListSurgeonPhysiciansForSchedulingApiResponseActions
    extends ModelActions<
        ListSurgeonPhysiciansForSchedulingApiResponse,
        ListSurgeonPhysiciansForSchedulingApiResponseBuilder,
        ListSurgeonPhysiciansForSchedulingApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListSurgeonPhysiciansForSchedulingApiResponseActions(
          ListSurgeonPhysiciansForSchedulingApiResponseActionsOptions
              options) =>
      _$ListSurgeonPhysiciansForSchedulingApiResponseActions(options);
}
