...
abstract class GetCaseEventDetailApiRequest
    implements
        Built<GetCaseEventDetailApiRequest,
  ...
  factory GetCaseEventDetailApiRequest(
          [updates(GetCaseEventDetailApiRequestBuilder b)]) =
  ...
  static Serializer<GetCaseEventDetailApiRequest> get serializer =>
      _$getCaseEventDetailApiRequestSerializer;
}

abstract class GetCaseEventDetailApiRequestActions extends ModelActions<
  ...
  factory GetCaseEventDetailApiRequestActions(
          GetCaseEventDetailApiRequestActionsOptions options) =>
      _$GetCaseEventDetailApiRequestActions(options);
}
