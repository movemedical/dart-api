...
abstract class ListCaseFilesApiCaseFile
    implements
        Built<ListCaseFilesApiCaseFile, ListCaseFilesApiCaseFileBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListCaseFilesApiCaseFile(
          [updates(ListCaseFilesApiCaseFileBuilder b)]) =
  ...
  static Serializer<ListCaseFilesApiCaseFile> get serializer =>
      _$listCaseFilesApiCaseFileSerializer;
}

abstract class ListCaseFilesApiCaseFileActions extends ModelActions<
    ListCaseFilesApiCaseFile,
    ListCaseFilesApiCaseFileBuilder,
    ListCaseFilesApiCaseFileActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListCaseFilesApiCaseFileActions(
          ListCaseFilesApiCaseFileActionsOptions options) =>
      _$ListCaseFilesApiCaseFileActions(options);
}
