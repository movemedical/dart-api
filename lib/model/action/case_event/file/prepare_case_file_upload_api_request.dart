...
abstract class PrepareCaseFileUploadApiRequest
    implements
        Built<PrepareCaseFileUploadApiRequest,
  ...
  factory PrepareCaseFileUploadApiRequest(
          [updates(PrepareCaseFileUploadApiRequestBuilder b)]) =
  ...
  static Serializer<PrepareCaseFileUploadApiRequest> get serializer =>
      _$prepareCaseFileUploadApiRequestSerializer;
}

abstract class PrepareCaseFileUploadApiRequestActions extends ModelActions<
    PrepareCaseFileUploadApiRequest,
    PrepareCaseFileUploadApiRequestBuilder,
    PrepareCaseFileUploadApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory PrepareCaseFileUploadApiRequestActions(
          PrepareCaseFileUploadApiRequestActionsOptions options) =>
      _$PrepareCaseFileUploadApiRequestActions(options);
}
