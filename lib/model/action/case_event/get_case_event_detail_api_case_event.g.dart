...
class _$GetCaseEventDetailApiCaseEventSerializer
  ...
  final String wireName =
      'movemedical_api/model/action/case_event/GetCaseEventDetailApiCaseEvent';
  ...
  Iterable serialize(
    ...
    if (object.caseCustomFieldValues != null) {
      result
        ..add('caseCustomFieldValues')
        ..add(serializers.serialize(object.caseCustomFieldValues,
            specifiedType: const FullType(
    ...
    if (object.implantLoanReturnData != null) {
      result
        ..add('implantLoanReturnData')
        ..add(serializers.serialize(object.implantLoanReturnData,
            specifiedType:
                const FullType(GetCaseEventDetailApiLoanReturnData)));
    }
    if (object.instrumentLoanReturnData != null) {
      result
        ..add('instrumentLoanReturnData')
        ..add(serializers.serialize(object.instrumentLoanReturnData,
            specifiedType:
                const FullType(GetCaseEventDetailApiLoanReturnData)));
    }
      ...
      switch (key) {
        ...
        case 'requirementsDeliverToOverrideAddress':
          result.requirementsDeliverToOverrideAddress.replace(serializers
              ...
              as Address);
          break;
        case 'caseCustomFieldValues':
          result.caseCustomFieldValues.replace(serializers.deserialize(value,
                  specifiedType: const FullType(
                      BuiltList, const [const FullType(CaseCustomFieldValue)]))
              as BuiltList);
          break;
        case 'poNumber':
          result.poNumber = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String;
          break;
        case 'implantLoanReturnData':
          result.implantLoanReturnData.replace(serializers.deserialize(value,
                  specifiedType:
                      const FullType(GetCaseEventDetailApiLoanReturnData))
              as GetCaseEventDetailApiLoanReturnData);
          break;
        case 'instrumentLoanReturnData':
          result.instrumentLoanReturnData.replace(serializers.deserialize(value,
                  specifiedType:
                      const FullType(GetCaseEventDetailApiLoanReturnData))
              as GetCaseEventDetailApiLoanReturnData);
          break;
...
class _$GetCaseEventDetailApiCaseEvent extends GetCaseEventDetailApiCaseEvent {
  ...
  @override
  final BuiltList<CaseCustomFieldValue> caseCustomFieldValues;
  @override
  final String poNumber;
  @override
  final GetCaseEventDetailApiLoanReturnData implantLoanReturnData;
  @override
  final GetCaseEventDetailApiLoanReturnData instrumentLoanReturnData;
  @override
  ...
  _$GetCaseEventDetailApiCaseEvent._(
      ...
      this.caseCustomFieldValues,
      this.poNumber,
      this.implantLoanReturnData,
  ...
  bool operator ==(Object other) {
    ...
    return other is GetCaseEventDetailApiCaseEvent &&
        ...
        caseCustomFieldValues == other.caseCustomFieldValues &&
        poNumber == other.poNumber &&
        implantLoanReturnData == other.implantLoanReturnData &&
        instrumentLoanReturnData == other.instrumentLoanReturnData &&
                ...
                $jc(
                    $jc(
                        $jc(
                                                        ...
                                                        $jc(
                                                            $jc(
                                                                $jc(
                                                                    $jc(
                                                                        $jc(
                                                                            $jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc(0, id.hashCode), status.hashCode), bodySide.hashCode), caseType.hashCode), bizUnit.hashCode), salesOu.hashCode), opsOu.hashCode), hospital.hashCode), physician.hashCode), physicianTemp.hashCode), patient.hashCode), hcr.hashCode), team.hashCode),
                                                                                coverage.hashCode),
                                                                            procedure.hashCode),
                            ...
                            caseCustomFieldValues.hashCode),
                        poNumber.hashCode),
                    implantLoanReturnData.hashCode),
                instrumentLoanReturnData.hashCode),
            salesLead.hashCode),
        opsLead.hashCode));
  }
  ...
  String toString() {
    return (newBuiltValueToStringHelper('GetCaseEventDetailApiCaseEvent')
          ...
          ..add('requirementsDeliverToOverrideAddress',
              requirementsDeliverToOverrideAddress)
          ..add('caseCustomFieldValues', caseCustomFieldValues)
          ..add('poNumber', poNumber)
          ..add('implantLoanReturnData', implantLoanReturnData)
          ..add('instrumentLoanReturnData', instrumentLoanReturnData)
...
class GetCaseEventDetailApiCaseEventBuilder
  ...
  set instrumentLoanReturnData(
      ...
      _$this._instrumentLoanReturnData = instrumentLoanReturnData;
  ...
  GetCaseEventDetailApiCaseEventBuilder get _$this {
    if (_$v != null) {
      ...
      _caseCustomFieldValues = _$v.caseCustomFieldValues?.toBuilder();
      _poNumber = _$v.poNumber;
      _implantLoanReturnData = _$v.implantLoanReturnData?.toBuilder();
      _instrumentLoanReturnData = _$v.instrumentLoanReturnData?.toBuilder();
    ...
    try {
      _$result = _$v ??
          new _$GetCaseEventDetailApiCaseEvent._(
              ...
              caseCustomFieldValues: _caseCustomFieldValues?.build(),
              poNumber: poNumber,
              implantLoanReturnData: _implantLoanReturnData?.build(),
              instrumentLoanReturnData: _instrumentLoanReturnData?.build(),
      ...
      try {
        ...
        _requirementsDeliverToOverrideAddress?.build();
        _$failedField = 'caseCustomFieldValues';
        _caseCustomFieldValues?.build();

        _$failedField = 'implantLoanReturnData';
        _implantLoanReturnData?.build();
        _$failedField = 'instrumentLoanReturnData';
        _instrumentLoanReturnData?.build();
...
class _$GetCaseEventDetailApiCaseEventActions
  ...
  final FieldDispatcher<BuiltList<CaseCustomFieldValue>> caseCustomFieldValues;
      ...
      : replace$ = options$.action<GetCaseEventDetailApiCaseEvent>(
        ...
        implantLoanReturnData = GetCaseEventDetailApiLoanReturnDataActions(() =>
            options$.stateful<
                ...
                'implantLoanReturnData',
                (a) => a.implantLoanReturnData,
                (s) => s?.implantLoanReturnData,
        ...
        instrumentLoanReturnData = GetCaseEventDetailApiLoanReturnDataActions(
            () => options$.stateful<
                    ...
                    GetCaseEventDetailApiLoanReturnDataActions>(
                'instrumentLoanReturnData',
                (a) => a.instrumentLoanReturnData,
                (s) => s?.instrumentLoanReturnData,
                (b) => b?.instrumentLoanReturnData,
                (parent, builder) =>
                    parent?.instrumentLoanReturnData = builder)),
