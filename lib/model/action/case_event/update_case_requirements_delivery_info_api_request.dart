...
abstract class UpdateCaseRequirementsDeliveryInfoApiRequest
    implements
        Built<UpdateCaseRequirementsDeliveryInfoApiRequest,
  ...
  factory UpdateCaseRequirementsDeliveryInfoApiRequest(
          [updates(UpdateCaseRequirementsDeliveryInfoApiRequestBuilder b)]) =
  ...
  static Serializer<UpdateCaseRequirementsDeliveryInfoApiRequest>
      get serializer =>
          _$updateCaseRequirementsDeliveryInfoApiRequestSerializer;
}

abstract class UpdateCaseRequirementsDeliveryInfoApiRequestActions
    extends ModelActions<
        UpdateCaseRequirementsDeliveryInfoApiRequest,
        UpdateCaseRequirementsDeliveryInfoApiRequestBuilder,
        UpdateCaseRequirementsDeliveryInfoApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory UpdateCaseRequirementsDeliveryInfoApiRequestActions(
          UpdateCaseRequirementsDeliveryInfoApiRequestActionsOptions options) =>
      _$UpdateCaseRequirementsDeliveryInfoApiRequestActions(options);
}
