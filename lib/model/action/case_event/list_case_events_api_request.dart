...
abstract class ListCaseEventsApiRequest
    implements
        Built<ListCaseEventsApiRequest, ListCaseEventsApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////

  @nullable
  bool get canReturnCounts;

  @nullable
  bool get forceReturnCounts;
  ...
  factory ListCaseEventsApiRequest(
          [updates(ListCaseEventsApiRequestBuilder b)]) =
  ...
  static Serializer<ListCaseEventsApiRequest> get serializer =>
      _$listCaseEventsApiRequestSerializer;
}

abstract class ListCaseEventsApiRequestActions extends ModelActions<
  ...
  FieldDispatcher<bool> get canReturnCounts;

  FieldDispatcher<bool> get forceReturnCounts;
  ...
  factory ListCaseEventsApiRequestActions(
          ListCaseEventsApiRequestActionsOptions options) =>
      _$ListCaseEventsApiRequestActions(options);
}
