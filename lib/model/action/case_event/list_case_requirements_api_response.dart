...
import 'package:movemedical_api/model/action/case_event/list_case_requirements_api_item_request.dart';

part 'list_case_requirements_api_response.g.dart';

abstract class ListCaseRequirementsApiResponse
    implements
        Built<ListCaseRequirementsApiResponse,
  ...
  factory ListCaseRequirementsApiResponse(
          [updates(ListCaseRequirementsApiResponseBuilder b)]) =
  ...
  static Serializer<ListCaseRequirementsApiResponse> get serializer =>
      _$listCaseRequirementsApiResponseSerializer;
}

abstract class ListCaseRequirementsApiResponseActions extends ModelActions<
    ListCaseRequirementsApiResponse,
    ListCaseRequirementsApiResponseBuilder,
    ListCaseRequirementsApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListCaseRequirementsApiResponseActions(
          ListCaseRequirementsApiResponseActionsOptions options) =>
      _$ListCaseRequirementsApiResponseActions(options);
}
