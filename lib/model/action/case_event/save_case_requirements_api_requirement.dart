...
abstract class SaveCaseRequirementsApiRequirement
    implements
        Built<SaveCaseRequirementsApiRequirement,
  ...
  factory SaveCaseRequirementsApiRequirement(
          [updates(SaveCaseRequirementsApiRequirementBuilder b)]) =
  ...
  static Serializer<SaveCaseRequirementsApiRequirement> get serializer =>
      _$saveCaseRequirementsApiRequirementSerializer;
}

abstract class SaveCaseRequirementsApiRequirementActions extends ModelActions<
    SaveCaseRequirementsApiRequirement,
    SaveCaseRequirementsApiRequirementBuilder,
    SaveCaseRequirementsApiRequirementActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory SaveCaseRequirementsApiRequirementActions(
          SaveCaseRequirementsApiRequirementActionsOptions options) =>
      _$SaveCaseRequirementsApiRequirementActions(options);
}
