...
class _$GetCaseEventDetailApiDisplayRulesSerializer
  ...
  final String wireName =
      'movemedical_api/model/action/case_event/GetCaseEventDetailApiDisplayRules';
  ...
  Iterable serialize(
    ...
    if (object.addPONumber != null) {
      result
        ..add('addPONumber')
        ..add(serializers.serialize(object.addPONumber,
            specifiedType: const FullType(bool)));
    }
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'overridePrice':
          ...
          break;
        case 'addPONumber':
          result.addPONumber = serializers.deserialize(value,
              specifiedType: const FullType(bool)) as bool;
          break;
        case 'loanReturn':
