...
abstract class EditCaseEventSchedulingApiRequest
    implements
        Built<EditCaseEventSchedulingApiRequest,
  ...
  factory EditCaseEventSchedulingApiRequest(
          [updates(EditCaseEventSchedulingApiRequestBuilder b)]) =
  ...
  static Serializer<EditCaseEventSchedulingApiRequest> get serializer =>
      _$editCaseEventSchedulingApiRequestSerializer;
}

abstract class EditCaseEventSchedulingApiRequestActions extends ModelActions<
    EditCaseEventSchedulingApiRequest,
    EditCaseEventSchedulingApiRequestBuilder,
    EditCaseEventSchedulingApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory EditCaseEventSchedulingApiRequestActions(
          EditCaseEventSchedulingApiRequestActionsOptions options) =>
      _$EditCaseEventSchedulingApiRequestActions(options);
}
