...
abstract class GetItemPricingApiItemPrice
    implements
        Built<GetItemPricingApiItemPrice, GetItemPricingApiItemPriceBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetItemPricingApiItemPrice(
          [updates(GetItemPricingApiItemPriceBuilder b)]) =
  ...
  static Serializer<GetItemPricingApiItemPrice> get serializer =>
      _$getItemPricingApiItemPriceSerializer;
}

abstract class GetItemPricingApiItemPriceActions extends ModelActions<
    GetItemPricingApiItemPrice,
    GetItemPricingApiItemPriceBuilder,
    GetItemPricingApiItemPriceActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetItemPricingApiItemPriceActions(
          GetItemPricingApiItemPriceActionsOptions options) =>
      _$GetItemPricingApiItemPriceActions(options);
}
