...
abstract class ListLinesForSalesOrderApiOrderLine
    implements
        Built<ListLinesForSalesOrderApiOrderLine,
  ...
  factory ListLinesForSalesOrderApiOrderLine(
          [updates(ListLinesForSalesOrderApiOrderLineBuilder b)]) =
  ...
  static Serializer<ListLinesForSalesOrderApiOrderLine> get serializer =>
      _$listLinesForSalesOrderApiOrderLineSerializer;
}

abstract class ListLinesForSalesOrderApiOrderLineActions extends ModelActions<
    ListLinesForSalesOrderApiOrderLine,
    ListLinesForSalesOrderApiOrderLineBuilder,
    ListLinesForSalesOrderApiOrderLineActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  FieldDispatcher<BuiltList<ListLinesForSalesOrderApiBackOrderDetail>>
  ...
  factory ListLinesForSalesOrderApiOrderLineActions(
          ListLinesForSalesOrderApiOrderLineActionsOptions options) =>
      _$ListLinesForSalesOrderApiOrderLineActions(options);
}
