...
abstract class SubmitSalesOrderApiResponse
    implements
        Built<SubmitSalesOrderApiResponse, SubmitSalesOrderApiResponseBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory SubmitSalesOrderApiResponse(
          [updates(SubmitSalesOrderApiResponseBuilder b)]) =
  ...
  static Serializer<SubmitSalesOrderApiResponse> get serializer =>
      _$submitSalesOrderApiResponseSerializer;
}

abstract class SubmitSalesOrderApiResponseActions extends ModelActions<
    SubmitSalesOrderApiResponse,
    SubmitSalesOrderApiResponseBuilder,
    SubmitSalesOrderApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory SubmitSalesOrderApiResponseActions(
          SubmitSalesOrderApiResponseActionsOptions options) =>
      _$SubmitSalesOrderApiResponseActions(options);
}
