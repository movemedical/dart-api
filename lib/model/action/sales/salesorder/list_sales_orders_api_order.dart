...
abstract class ListSalesOrdersApiOrder
    implements Built<ListSalesOrdersApiOrder, ListSalesOrdersApiOrderBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListSalesOrdersApiOrder([updates(ListSalesOrdersApiOrderBuilder b)]) =
  ...
  static Serializer<ListSalesOrdersApiOrder> get serializer =>
      _$listSalesOrdersApiOrderSerializer;
}

abstract class ListSalesOrdersApiOrderActions extends ModelActions<
    ListSalesOrdersApiOrder,
    ListSalesOrdersApiOrderBuilder,
    ListSalesOrdersApiOrderActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListSalesOrdersApiOrderActions(
          ListSalesOrdersApiOrderActionsOptions options) =>
      _$ListSalesOrdersApiOrderActions(options);
}
