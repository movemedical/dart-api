...
abstract class GetSalesOrderApiCustomerDetail
    implements
        Built<GetSalesOrderApiCustomerDetail,
  ...
  factory GetSalesOrderApiCustomerDetail(
          [updates(GetSalesOrderApiCustomerDetailBuilder b)]) =
  ...
  static Serializer<GetSalesOrderApiCustomerDetail> get serializer =>
      _$getSalesOrderApiCustomerDetailSerializer;
}

abstract class GetSalesOrderApiCustomerDetailActions extends ModelActions<
  ...
  factory GetSalesOrderApiCustomerDetailActions(
          GetSalesOrderApiCustomerDetailActionsOptions options) =>
      _$GetSalesOrderApiCustomerDetailActions(options);
}
