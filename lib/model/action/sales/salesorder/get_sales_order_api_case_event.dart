...
abstract class GetSalesOrderApiCaseEvent
    implements
        Built<GetSalesOrderApiCaseEvent, GetSalesOrderApiCaseEventBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetSalesOrderApiCaseEvent(
          [updates(GetSalesOrderApiCaseEventBuilder b)]) =
  ...
  static Serializer<GetSalesOrderApiCaseEvent> get serializer =>
      _$getSalesOrderApiCaseEventSerializer;
}

abstract class GetSalesOrderApiCaseEventActions extends ModelActions<
  ...
  factory GetSalesOrderApiCaseEventActions(
          GetSalesOrderApiCaseEventActionsOptions options) =>
      _$GetSalesOrderApiCaseEventActions(options);
}
