...
abstract class UpdateSalesOrderHeaderApiRequest
    implements
        Built<UpdateSalesOrderHeaderApiRequest,
  ...
  factory UpdateSalesOrderHeaderApiRequest(
          [updates(UpdateSalesOrderHeaderApiRequestBuilder b)]) =
  ...
  static Serializer<UpdateSalesOrderHeaderApiRequest> get serializer =>
      _$updateSalesOrderHeaderApiRequestSerializer;
}

abstract class UpdateSalesOrderHeaderApiRequestActions extends ModelActions<
    UpdateSalesOrderHeaderApiRequest,
    UpdateSalesOrderHeaderApiRequestBuilder,
    UpdateSalesOrderHeaderApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory UpdateSalesOrderHeaderApiRequestActions(
          UpdateSalesOrderHeaderApiRequestActionsOptions options) =>
      _$UpdateSalesOrderHeaderApiRequestActions(options);
}
