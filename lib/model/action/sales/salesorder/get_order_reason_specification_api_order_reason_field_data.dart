...
abstract class GetOrderReasonSpecificationApiOrderReasonFieldData
    implements
        Built<GetOrderReasonSpecificationApiOrderReasonFieldData,
  ...
  factory GetOrderReasonSpecificationApiOrderReasonFieldData(
          [updates(
  ...
  static Serializer<GetOrderReasonSpecificationApiOrderReasonFieldData>
      get serializer =>
          _$getOrderReasonSpecificationApiOrderReasonFieldDataSerializer;
}

abstract class GetOrderReasonSpecificationApiOrderReasonFieldDataActions
    extends ModelActions<
        GetOrderReasonSpecificationApiOrderReasonFieldData,
        GetOrderReasonSpecificationApiOrderReasonFieldDataBuilder,
        GetOrderReasonSpecificationApiOrderReasonFieldDataActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetOrderReasonSpecificationApiOrderReasonFieldDataActions(
          GetOrderReasonSpecificationApiOrderReasonFieldDataActionsOptions
              options) =>
      _$GetOrderReasonSpecificationApiOrderReasonFieldDataActions(options);
}
