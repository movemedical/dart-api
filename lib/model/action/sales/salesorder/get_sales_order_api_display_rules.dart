...
abstract class GetSalesOrderApiDisplayRules
    implements
        Built<GetSalesOrderApiDisplayRules,
  ...
  factory GetSalesOrderApiDisplayRules(
          [updates(GetSalesOrderApiDisplayRulesBuilder b)]) =
  ...
  static Serializer<GetSalesOrderApiDisplayRules> get serializer =>
      _$getSalesOrderApiDisplayRulesSerializer;
}

abstract class GetSalesOrderApiDisplayRulesActions extends ModelActions<
  ...
  factory GetSalesOrderApiDisplayRulesActions(
          GetSalesOrderApiDisplayRulesActionsOptions options) =>
      _$GetSalesOrderApiDisplayRulesActions(options);
}
