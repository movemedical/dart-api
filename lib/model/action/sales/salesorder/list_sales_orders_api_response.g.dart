...
class _$ListSalesOrdersApiResponseActions
  ...
  _$ListSalesOrdersApiResponseActions._(this.$options)
      : $replace = $options.action<ListSalesOrdersApiResponse>(
            '\$replace', (a) => a?.$replace),
        data = $options.actionField<BuiltList<ListSalesOrdersApiOrder>>(
  ...
  @override
  ListSalesOrdersApiResponse get $initial => ListSalesOrdersApiResponse();
...
// @override
// Serializer<ListSalesOrdersApiResponseListSalesOrdersApiResponseActions> get $serializer => ListSalesOrdersApiResponseListSalesOrdersApiResponseActions.serializer;
