...
class _$ListLinesForSalesOrderApiOrderLineActions
  ...
  _$ListLinesForSalesOrderApiOrderLineActions._(this.$options)
      : $replace = $options.action<ListLinesForSalesOrderApiOrderLine>(
        ...
        hasPriceOverride = $options.actionField<bool>(
            'hasPriceOverride',
        ...
        extendedPrice = $options.actionField<double>(
            'extendedPrice',
            (a) => a?.extendedPrice,
            (s) => s?.extendedPrice,
            (p, b) => p?.extendedPrice = b),
        backOrderDetails = $options
            .actionField<BuiltList<ListLinesForSalesOrderApiBackOrderDetail>>(
                'backOrderDetails',
...
// @override
// Serializer<ListLinesForSalesOrderApiOrderLineListLinesForSalesOrderApiOrderLineActions> get $serializer => ListLinesForSalesOrderApiOrderLineListLinesForSalesOrderApiOrderLineActions.serializer;
