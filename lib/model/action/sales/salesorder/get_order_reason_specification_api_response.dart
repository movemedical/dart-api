...
abstract class GetOrderReasonSpecificationApiResponse
    implements
        Built<GetOrderReasonSpecificationApiResponse,
  ...
  factory GetOrderReasonSpecificationApiResponse(
          [updates(GetOrderReasonSpecificationApiResponseBuilder b)]) =
  ...
  static Serializer<GetOrderReasonSpecificationApiResponse> get serializer =>
      _$getOrderReasonSpecificationApiResponseSerializer;
}

abstract class GetOrderReasonSpecificationApiResponseActions
    extends ModelActions<
        GetOrderReasonSpecificationApiResponse,
        GetOrderReasonSpecificationApiResponseBuilder,
        GetOrderReasonSpecificationApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////

  FieldDispatcher<BuiltList<GetOrderReasonSpecificationApiOrderReasonFieldData>>
      get fields;

  FieldDispatcher<BuiltList<GetOrderReasonSpecificationApiOrderReasonDoc>>
      get docs;
  ...
  factory GetOrderReasonSpecificationApiResponseActions(
          GetOrderReasonSpecificationApiResponseActionsOptions options) =>
      _$GetOrderReasonSpecificationApiResponseActions(options);
}
