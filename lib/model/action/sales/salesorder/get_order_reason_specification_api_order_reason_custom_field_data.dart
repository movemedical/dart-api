...
abstract class GetOrderReasonSpecificationApiOrderReasonCustomFieldData
    implements
        Built<GetOrderReasonSpecificationApiOrderReasonCustomFieldData,
  ...
  factory GetOrderReasonSpecificationApiOrderReasonCustomFieldData(
      [updates(
          GetOrderReasonSpecificationApiOrderReasonCustomFieldDataBuilder
              b)]) = _$GetOrderReasonSpecificationApiOrderReasonCustomFieldData;

  ////////////////////////////////
  /// Serializer
  ////////////////////////////////

  static Serializer<GetOrderReasonSpecificationApiOrderReasonCustomFieldData>
      get serializer =>
          _$getOrderReasonSpecificationApiOrderReasonCustomFieldDataSerializer;
}

abstract class GetOrderReasonSpecificationApiOrderReasonCustomFieldDataActions
    extends ModelActions<
        GetOrderReasonSpecificationApiOrderReasonCustomFieldData,
        GetOrderReasonSpecificationApiOrderReasonCustomFieldDataBuilder,
        GetOrderReasonSpecificationApiOrderReasonCustomFieldDataActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetOrderReasonSpecificationApiOrderReasonCustomFieldDataActions(
