...
abstract class CreateSalesOrderApiRequest
    implements
        Built<CreateSalesOrderApiRequest, CreateSalesOrderApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreateSalesOrderApiRequest(
          [updates(CreateSalesOrderApiRequestBuilder b)]) =
  ...
  static Serializer<CreateSalesOrderApiRequest> get serializer =>
      _$createSalesOrderApiRequestSerializer;
}

abstract class CreateSalesOrderApiRequestActions extends ModelActions<
    CreateSalesOrderApiRequest,
    CreateSalesOrderApiRequestBuilder,
    CreateSalesOrderApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreateSalesOrderApiRequestActions(
          CreateSalesOrderApiRequestActionsOptions options) =>
      _$CreateSalesOrderApiRequestActions(options);
}
