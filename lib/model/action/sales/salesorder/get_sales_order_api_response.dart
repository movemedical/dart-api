...
abstract class GetSalesOrderApiResponse implements Built<GetSalesOrderApiResponse, GetSalesOrderApiResponseBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetSalesOrderApiResponse([updates(GetSalesOrderApiResponseBuilder b)]) = _$GetSalesOrderApiResponse;
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<GetSalesOrderApiResponse> get serializer => _$getSalesOrderApiResponseSerializer;
}

abstract class GetSalesOrderApiResponseActions extends ModelActions<GetSalesOrderApiResponse, GetSalesOrderApiResponseBuilder, GetSalesOrderApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetSalesOrderApiResponseActions(GetSalesOrderApiResponseActionsOptions options) => _$GetSalesOrderApiResponseActions(options);
}
