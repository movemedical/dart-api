...
abstract class GetItemPricingApiResponse
    implements
        Built<GetItemPricingApiResponse, GetItemPricingApiResponseBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetItemPricingApiResponse(
          [updates(GetItemPricingApiResponseBuilder b)]) =
  ...
  static Serializer<GetItemPricingApiResponse> get serializer =>
      _$getItemPricingApiResponseSerializer;
}

abstract class GetItemPricingApiResponseActions extends ModelActions<
    GetItemPricingApiResponse,
    GetItemPricingApiResponseBuilder,
    GetItemPricingApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetItemPricingApiResponseActions(
          GetItemPricingApiResponseActionsOptions options) =>
      _$GetItemPricingApiResponseActions(options);
}
