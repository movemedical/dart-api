...
abstract class GetIntegrationIssueApiIssueUiSchema
    implements
        Built<GetIntegrationIssueApiIssueUiSchema,
  ...
  factory GetIntegrationIssueApiIssueUiSchema(
          [updates(GetIntegrationIssueApiIssueUiSchemaBuilder b)]) =
  ...
  static Serializer<GetIntegrationIssueApiIssueUiSchema> get serializer =>
      _$getIntegrationIssueApiIssueUiSchemaSerializer;
}

abstract class GetIntegrationIssueApiIssueUiSchemaActions extends ModelActions<
  ...
  factory GetIntegrationIssueApiIssueUiSchemaActions(
          GetIntegrationIssueApiIssueUiSchemaActionsOptions options) =>
      _$GetIntegrationIssueApiIssueUiSchemaActions(options);
}
