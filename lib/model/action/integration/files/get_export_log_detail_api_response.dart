...
abstract class GetExportLogDetailApiResponse
    implements
        Built<GetExportLogDetailApiResponse,
  ...
  factory GetExportLogDetailApiResponse(
          [updates(GetExportLogDetailApiResponseBuilder b)]) =
  ...
  static Serializer<GetExportLogDetailApiResponse> get serializer =>
      _$getExportLogDetailApiResponseSerializer;
}

abstract class GetExportLogDetailApiResponseActions extends ModelActions<
    GetExportLogDetailApiResponse,
    GetExportLogDetailApiResponseBuilder,
    GetExportLogDetailApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetExportLogDetailApiResponseActions(
          GetExportLogDetailApiResponseActionsOptions options) =>
      _$GetExportLogDetailApiResponseActions(options);
}
