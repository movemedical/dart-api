...
part of 'list_import_log_files_api_import_log_file.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<ListImportLogFilesApiImportLogFile>
    _$listImportLogFilesApiImportLogFileSerializer =
    new _$ListImportLogFilesApiImportLogFileSerializer();

class _$ListImportLogFilesApiImportLogFileSerializer
    implements StructuredSerializer<ListImportLogFilesApiImportLogFile> {
  @override
  final Iterable<Type> types = const [
    ListImportLogFilesApiImportLogFile,
    _$ListImportLogFilesApiImportLogFile
  ];
  @override
  final String wireName =
      'movemedical_api/model/action/integration/files/ListImportLogFilesApiImportLogFile';

  @override
  Iterable serialize(
      Serializers serializers, ListImportLogFilesApiImportLogFile object,
  ...
  @override
  ListImportLogFilesApiImportLogFile deserialize(
      Serializers serializers, Iterable serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new ListImportLogFilesApiImportLogFileBuilder();
...
class _$ListImportLogFilesApiImportLogFile
    extends ListImportLogFilesApiImportLogFile {
  @override
  final String id;
  @override
  final String jobKey;
  ...
  factory _$ListImportLogFilesApiImportLogFile(
          [void updates(ListImportLogFilesApiImportLogFileBuilder b)]) =>
      (new ListImportLogFilesApiImportLogFileBuilder()..update(updates))
          .build();

  _$ListImportLogFilesApiImportLogFile._(
      {this.id,
      this.jobKey,
      this.importLogId,
      this.fileId,
  ...
  @override
  ListImportLogFilesApiImportLogFile rebuild(
          void updates(ListImportLogFilesApiImportLogFileBuilder b)) =>
      (toBuilder()..update(updates)).build();

  @override
  ListImportLogFilesApiImportLogFileBuilder toBuilder() =>
      new ListImportLogFilesApiImportLogFileBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ListImportLogFilesApiImportLogFile &&
        id == other.id &&
        jobKey == other.jobKey &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('ListImportLogFilesApiImportLogFile')
          ..add('id', id)
          ..add('jobKey', jobKey)
...
class ListImportLogFilesApiImportLogFileBuilder
    implements
        Builder<ListImportLogFilesApiImportLogFile,
  ...
  ListImportLogFilesApiImportLogFileBuilder get _$this {
    if (_$v != null) {
      _id = _$v.id;
      _jobKey = _$v.jobKey;
  ...
  @override
  void replace(ListImportLogFilesApiImportLogFile other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$ListImportLogFilesApiImportLogFile;
  }

  @override
  void update(void updates(ListImportLogFilesApiImportLogFileBuilder b)) {
    if (updates != null) updates(this);
  }

  @override
  _$ListImportLogFilesApiImportLogFile build() {
    final _$result = _$v ??
        new _$ListImportLogFilesApiImportLogFile._(
            id: id,
            jobKey: jobKey,
...
typedef StatefulActionsOptions<
    ListImportLogFilesApiImportLogFile,
    ListImportLogFilesApiImportLogFileBuilder,
    ListImportLogFilesApiImportLogFileActions> ListImportLogFilesApiImportLogFileActionsOptions();

class _$ListImportLogFilesApiImportLogFileActions
    extends ListImportLogFilesApiImportLogFileActions {
  final StatefulActionsOptions<
      ListImportLogFilesApiImportLogFile,
      ListImportLogFilesApiImportLogFileBuilder,
      ListImportLogFilesApiImportLogFileActions> $options;

  final ActionDispatcher<ListImportLogFilesApiImportLogFile> $replace;
  ...
  _$ListImportLogFilesApiImportLogFileActions._(this.$options)
      : $replace = $options.action<ListImportLogFilesApiImportLogFile>(
            '\$replace', (a) => a?.$replace),
        ...
        successRecordCount = $options.actionField<int>(
            'successRecordCount',
            (a) => a?.successRecordCount,
            (s) => s?.successRecordCount,
            (p, b) => p?.successRecordCount = b),
        failRecordCount = $options.actionField<int>(
            'failRecordCount',
            (a) => a?.failRecordCount,
            (s) => s?.failRecordCount,
            (p, b) => p?.failRecordCount = b),
        skipRecordCount = $options.actionField<int>(
            'skipRecordCount',
            (a) => a?.skipRecordCount,
            (s) => s?.skipRecordCount,
            (p, b) => p?.skipRecordCount = b),
        outcome = $options.actionField<ImportLogFileOutcome>('outcome',
            (a) => a?.outcome, (s) => s?.outcome, (p, b) => p?.outcome = b),
        super._();

  factory _$ListImportLogFilesApiImportLogFileActions(
          ListImportLogFilesApiImportLogFileActionsOptions options) =>
      _$ListImportLogFilesApiImportLogFileActions._(options());

  @override
  ListImportLogFilesApiImportLogFile get $initial =>
      ListImportLogFilesApiImportLogFile();

  @override
  ListImportLogFilesApiImportLogFileBuilder $newBuilder() =>
      ListImportLogFilesApiImportLogFileBuilder();
...
// @override
// Serializer<ListImportLogFilesApiImportLogFileListImportLogFilesApiImportLogFileActions> get $serializer => ListImportLogFilesApiImportLogFileListImportLogFilesApiImportLogFileActions.serializer;

  FullType _$fullType;
  @override
  FullType get $fullType =>
      _$fullType ??= FullType(ListImportLogFilesApiImportLogFile);
}
