...
class _$ListImportLogsApiImportLogActions
  ...
  _$ListImportLogsApiImportLogActions._(this.$options)
      : $replace = $options.action<ListImportLogsApiImportLog>(
        ...
        importLogNumber = $options.actionField<int>(
            'importLogNumber',
            (a) => a?.importLogNumber,
            (s) => s?.importLogNumber,
        ...
        issueCount = $options.actionField<int>(
            ...
            (s) => s?.issueCount,
            (p, b) => p?.issueCount = b),
        skipCount = $options.actionField<int>('skipCount', (a) => a?.skipCount,
            (s) => s?.skipCount, (p, b) => p?.skipCount = b),
        successCount = $options.actionField<int>(
            'successCount',
            (a) => a?.successCount,
            (s) => s?.successCount,
...
// @override
// Serializer<ListImportLogsApiImportLogListImportLogsApiImportLogActions> get $serializer => ListImportLogsApiImportLogListImportLogsApiImportLogActions.serializer;
