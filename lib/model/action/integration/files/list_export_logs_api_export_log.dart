...
abstract class ListExportLogsApiExportLog
    implements
        Built<ListExportLogsApiExportLog, ListExportLogsApiExportLogBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListExportLogsApiExportLog(
          [updates(ListExportLogsApiExportLogBuilder b)]) =
  ...
  static Serializer<ListExportLogsApiExportLog> get serializer =>
      _$listExportLogsApiExportLogSerializer;
}

abstract class ListExportLogsApiExportLogActions extends ModelActions<
    ListExportLogsApiExportLog,
    ListExportLogsApiExportLogBuilder,
    ListExportLogsApiExportLogActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListExportLogsApiExportLogActions(
          ListExportLogsApiExportLogActionsOptions options) =>
      _$ListExportLogsApiExportLogActions(options);
}
