...
abstract class GetImportLogFileDetailApiResponse
    implements
        Built<GetImportLogFileDetailApiResponse,
  ...
  factory GetImportLogFileDetailApiResponse(
          [updates(GetImportLogFileDetailApiResponseBuilder b)]) =
  ...
  static Serializer<GetImportLogFileDetailApiResponse> get serializer =>
      _$getImportLogFileDetailApiResponseSerializer;
}

abstract class GetImportLogFileDetailApiResponseActions extends ModelActions<
    GetImportLogFileDetailApiResponse,
    GetImportLogFileDetailApiResponseBuilder,
    GetImportLogFileDetailApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetImportLogFileDetailApiResponseActions(
          GetImportLogFileDetailApiResponseActionsOptions options) =>
      _$GetImportLogFileDetailApiResponseActions(options);
}
