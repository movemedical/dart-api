...
abstract class ListExportLogFilesApiExportLogFile
    implements
        Built<ListExportLogFilesApiExportLogFile,
  ...
  factory ListExportLogFilesApiExportLogFile(
          [updates(ListExportLogFilesApiExportLogFileBuilder b)]) =
  ...
  static Serializer<ListExportLogFilesApiExportLogFile> get serializer =>
      _$listExportLogFilesApiExportLogFileSerializer;
}

abstract class ListExportLogFilesApiExportLogFileActions extends ModelActions<
    ListExportLogFilesApiExportLogFile,
    ListExportLogFilesApiExportLogFileBuilder,
    ListExportLogFilesApiExportLogFileActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListExportLogFilesApiExportLogFileActions(
          ListExportLogFilesApiExportLogFileActionsOptions options) =>
      _$ListExportLogFilesApiExportLogFileActions(options);
}
