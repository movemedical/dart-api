...
abstract class GetIntegrationIssueApiResponse
    implements
        Built<GetIntegrationIssueApiResponse,
  ...
  factory GetIntegrationIssueApiResponse(
          [updates(GetIntegrationIssueApiResponseBuilder b)]) =
  ...
  static Serializer<GetIntegrationIssueApiResponse> get serializer =>
      _$getIntegrationIssueApiResponseSerializer;
}

abstract class GetIntegrationIssueApiResponseActions extends ModelActions<
    GetIntegrationIssueApiResponse,
    GetIntegrationIssueApiResponseBuilder,
    GetIntegrationIssueApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetIntegrationIssueApiResponseActions(
          GetIntegrationIssueApiResponseActionsOptions options) =>
      _$GetIntegrationIssueApiResponseActions(options);
}
