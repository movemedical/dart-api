...
abstract class ListWebServiceLogsApiRequest
    implements
        Built<ListWebServiceLogsApiRequest,
  ...
  factory ListWebServiceLogsApiRequest(
          [updates(ListWebServiceLogsApiRequestBuilder b)]) =
  ...
  static Serializer<ListWebServiceLogsApiRequest> get serializer =>
      _$listWebServiceLogsApiRequestSerializer;
}

abstract class ListWebServiceLogsApiRequestActions extends ModelActions<
    ListWebServiceLogsApiRequest,
    ListWebServiceLogsApiRequestBuilder,
    ListWebServiceLogsApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListWebServiceLogsApiRequestActions(
          ListWebServiceLogsApiRequestActionsOptions options) =>
      _$ListWebServiceLogsApiRequestActions(options);
}
