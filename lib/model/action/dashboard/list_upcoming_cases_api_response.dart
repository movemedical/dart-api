...
abstract class ListUpcomingCasesApiResponse
    implements
        Built<ListUpcomingCasesApiResponse,
            ListUpcomingCasesApiResponseBuilder>,
        PaginatedListResponse<ListUpcomingCasesApiCaseEvent> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListUpcomingCasesApiResponse(
          [updates(ListUpcomingCasesApiResponseBuilder b)]) =
  ...
  static Serializer<ListUpcomingCasesApiResponse> get serializer =>
      _$listUpcomingCasesApiResponseSerializer;
}

abstract class ListUpcomingCasesApiResponseActions extends ModelActions<
    ListUpcomingCasesApiResponse,
    ListUpcomingCasesApiResponseBuilder,
    ListUpcomingCasesApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListUpcomingCasesApiResponseActions(
          ListUpcomingCasesApiResponseActionsOptions options) =>
      _$ListUpcomingCasesApiResponseActions(options);
}
