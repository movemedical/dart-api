...
abstract class ListOpenBillingsApiResponse
    implements
        Built<ListOpenBillingsApiResponse, ListOpenBillingsApiResponseBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListOpenBillingsApiResponse(
          [updates(ListOpenBillingsApiResponseBuilder b)]) =
  ...
  static Serializer<ListOpenBillingsApiResponse> get serializer =>
      _$listOpenBillingsApiResponseSerializer;
}

abstract class ListOpenBillingsApiResponseActions extends ModelActions<
    ListOpenBillingsApiResponse,
    ListOpenBillingsApiResponseBuilder,
    ListOpenBillingsApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListOpenBillingsApiResponseActions(
          ListOpenBillingsApiResponseActionsOptions options) =>
      _$ListOpenBillingsApiResponseActions(options);
}
