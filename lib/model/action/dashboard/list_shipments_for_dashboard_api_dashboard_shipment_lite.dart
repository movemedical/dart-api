...
abstract class ListShipmentsForDashboardApiDashboardShipmentLite
    implements
        Built<ListShipmentsForDashboardApiDashboardShipmentLite,
  ...
  factory ListShipmentsForDashboardApiDashboardShipmentLite(
          [updates(
  ...
  static Serializer<ListShipmentsForDashboardApiDashboardShipmentLite>
      get serializer =>
          _$listShipmentsForDashboardApiDashboardShipmentLiteSerializer;
}

abstract class ListShipmentsForDashboardApiDashboardShipmentLiteActions
    extends ModelActions<
        ListShipmentsForDashboardApiDashboardShipmentLite,
        ListShipmentsForDashboardApiDashboardShipmentLiteBuilder,
        ListShipmentsForDashboardApiDashboardShipmentLiteActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListShipmentsForDashboardApiDashboardShipmentLiteActions(
          ListShipmentsForDashboardApiDashboardShipmentLiteActionsOptions
              options) =>
      _$ListShipmentsForDashboardApiDashboardShipmentLiteActions(options);
}
