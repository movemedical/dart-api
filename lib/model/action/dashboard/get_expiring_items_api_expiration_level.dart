...
abstract class GetExpiringItemsApiExpirationLevel
    implements
        Built<GetExpiringItemsApiExpirationLevel,
  ...
  factory GetExpiringItemsApiExpirationLevel(
          [updates(GetExpiringItemsApiExpirationLevelBuilder b)]) =
  ...
  static Serializer<GetExpiringItemsApiExpirationLevel> get serializer =>
      _$getExpiringItemsApiExpirationLevelSerializer;
}

abstract class GetExpiringItemsApiExpirationLevelActions extends ModelActions<
    GetExpiringItemsApiExpirationLevel,
    GetExpiringItemsApiExpirationLevelBuilder,
    GetExpiringItemsApiExpirationLevelActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetExpiringItemsApiExpirationLevelActions(
          GetExpiringItemsApiExpirationLevelActionsOptions options) =>
      _$GetExpiringItemsApiExpirationLevelActions(options);
}
