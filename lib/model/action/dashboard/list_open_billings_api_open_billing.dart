...
abstract class ListOpenBillingsApiOpenBilling
    implements
        Built<ListOpenBillingsApiOpenBilling,
  ...
  factory ListOpenBillingsApiOpenBilling(
          [updates(ListOpenBillingsApiOpenBillingBuilder b)]) =
  ...
  static Serializer<ListOpenBillingsApiOpenBilling> get serializer =>
      _$listOpenBillingsApiOpenBillingSerializer;
}

abstract class ListOpenBillingsApiOpenBillingActions extends ModelActions<
    ListOpenBillingsApiOpenBilling,
    ListOpenBillingsApiOpenBillingBuilder,
    ListOpenBillingsApiOpenBillingActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListOpenBillingsApiOpenBillingActions(
          ListOpenBillingsApiOpenBillingActionsOptions options) =>
      _$ListOpenBillingsApiOpenBillingActions(options);
}
