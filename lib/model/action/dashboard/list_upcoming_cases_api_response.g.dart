...
class _$ListUpcomingCasesApiResponseActions
  ...
  _$ListUpcomingCasesApiResponseActions._(this.$options)
      : $replace = $options.action<ListUpcomingCasesApiResponse>(
            '\$replace', (a) => a?.$replace),
        data = $options.actionField<BuiltList<ListUpcomingCasesApiCaseEvent>>(
  ...
  @override
  ListUpcomingCasesApiResponse get $initial => ListUpcomingCasesApiResponse();
...
// @override
// Serializer<ListUpcomingCasesApiResponseListUpcomingCasesApiResponseActions> get $serializer => ListUpcomingCasesApiResponseListUpcomingCasesApiResponseActions.serializer;

  FullType _$fullType;
  @override
  FullType get $fullType =>
      _$fullType ??= FullType(ListUpcomingCasesApiResponse);
}
