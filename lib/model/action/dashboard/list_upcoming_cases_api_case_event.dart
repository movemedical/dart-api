...
abstract class ListUpcomingCasesApiCaseEvent
    implements
        Built<ListUpcomingCasesApiCaseEvent,
  ...
  factory ListUpcomingCasesApiCaseEvent(
          [updates(ListUpcomingCasesApiCaseEventBuilder b)]) =
  ...
  static Serializer<ListUpcomingCasesApiCaseEvent> get serializer =>
      _$listUpcomingCasesApiCaseEventSerializer;
}

abstract class ListUpcomingCasesApiCaseEventActions extends ModelActions<
    ListUpcomingCasesApiCaseEvent,
    ListUpcomingCasesApiCaseEventBuilder,
    ListUpcomingCasesApiCaseEventActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListUpcomingCasesApiCaseEventActions(
          ListUpcomingCasesApiCaseEventActionsOptions options) =>
      _$ListUpcomingCasesApiCaseEventActions(options);
}
