...
abstract class SearchHcrTeamsApiRequest
    implements
        Built<SearchHcrTeamsApiRequest, SearchHcrTeamsApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory SearchHcrTeamsApiRequest(
          [updates(SearchHcrTeamsApiRequestBuilder b)]) =
  ...
  static Serializer<SearchHcrTeamsApiRequest> get serializer =>
      _$searchHcrTeamsApiRequestSerializer;
}

abstract class SearchHcrTeamsApiRequestActions extends ModelActions<
    SearchHcrTeamsApiRequest,
    SearchHcrTeamsApiRequestBuilder,
    SearchHcrTeamsApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory SearchHcrTeamsApiRequestActions(
          SearchHcrTeamsApiRequestActionsOptions options) =>
      _$SearchHcrTeamsApiRequestActions(options);
}
