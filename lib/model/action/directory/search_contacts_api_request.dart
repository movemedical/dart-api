...
abstract class SearchContactsApiRequest
    implements
        Built<SearchContactsApiRequest, SearchContactsApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory SearchContactsApiRequest(
          [updates(SearchContactsApiRequestBuilder b)]) =
  ...
  static Serializer<SearchContactsApiRequest> get serializer =>
      _$searchContactsApiRequestSerializer;
}

abstract class SearchContactsApiRequestActions extends ModelActions<
    SearchContactsApiRequest,
    SearchContactsApiRequestBuilder,
    SearchContactsApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory SearchContactsApiRequestActions(
          SearchContactsApiRequestActionsOptions options) =>
      _$SearchContactsApiRequestActions(options);
}
