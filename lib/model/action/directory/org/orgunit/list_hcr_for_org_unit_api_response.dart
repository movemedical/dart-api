...
abstract class ListHCRForOrgUnitApiResponse
    implements
        Built<ListHCRForOrgUnitApiResponse,
            ListHCRForOrgUnitApiResponseBuilder>,
        PaginatedListResponse<ListHCRForOrgUnitApiHcrLink> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListHCRForOrgUnitApiResponse(
          [updates(ListHCRForOrgUnitApiResponseBuilder b)]) =
  ...
  static Serializer<ListHCRForOrgUnitApiResponse> get serializer =>
      _$listHCRForOrgUnitApiResponseSerializer;
}

abstract class ListHCRForOrgUnitApiResponseActions extends ModelActions<
    ListHCRForOrgUnitApiResponse,
    ListHCRForOrgUnitApiResponseBuilder,
    ListHCRForOrgUnitApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListHCRForOrgUnitApiResponseActions(
          ListHCRForOrgUnitApiResponseActionsOptions options) =>
      _$ListHCRForOrgUnitApiResponseActions(options);
}
