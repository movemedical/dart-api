...
abstract class UpdateOrgUnitApiRequest
    implements Built<UpdateOrgUnitApiRequest, UpdateOrgUnitApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory UpdateOrgUnitApiRequest([updates(UpdateOrgUnitApiRequestBuilder b)]) =
  ...
  static Serializer<UpdateOrgUnitApiRequest> get serializer =>
      _$updateOrgUnitApiRequestSerializer;
}

abstract class UpdateOrgUnitApiRequestActions extends ModelActions<
    UpdateOrgUnitApiRequest,
    UpdateOrgUnitApiRequestBuilder,
    UpdateOrgUnitApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory UpdateOrgUnitApiRequestActions(
          UpdateOrgUnitApiRequestActionsOptions options) =>
      _$UpdateOrgUnitApiRequestActions(options);
}
