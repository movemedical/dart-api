...
abstract class CreateOrgUnitApiRequest
    implements Built<CreateOrgUnitApiRequest, CreateOrgUnitApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreateOrgUnitApiRequest([updates(CreateOrgUnitApiRequestBuilder b)]) =
  ...
  static Serializer<CreateOrgUnitApiRequest> get serializer =>
      _$createOrgUnitApiRequestSerializer;
}

abstract class CreateOrgUnitApiRequestActions extends ModelActions<
    CreateOrgUnitApiRequest,
    CreateOrgUnitApiRequestBuilder,
    CreateOrgUnitApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreateOrgUnitApiRequestActions(
          CreateOrgUnitApiRequestActionsOptions options) =>
      _$CreateOrgUnitApiRequestActions(options);
}
