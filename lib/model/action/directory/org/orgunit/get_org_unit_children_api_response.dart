...
abstract class GetOrgUnitChildrenApiResponse
    implements
        Built<GetOrgUnitChildrenApiResponse,
  ...
  factory GetOrgUnitChildrenApiResponse(
          [updates(GetOrgUnitChildrenApiResponseBuilder b)]) =
  ...
  static Serializer<GetOrgUnitChildrenApiResponse> get serializer =>
      _$getOrgUnitChildrenApiResponseSerializer;
}

abstract class GetOrgUnitChildrenApiResponseActions extends ModelActions<
    GetOrgUnitChildrenApiResponse,
    GetOrgUnitChildrenApiResponseBuilder,
    GetOrgUnitChildrenApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetOrgUnitChildrenApiResponseActions(
          GetOrgUnitChildrenApiResponseActionsOptions options) =>
      _$GetOrgUnitChildrenApiResponseActions(options);
}
