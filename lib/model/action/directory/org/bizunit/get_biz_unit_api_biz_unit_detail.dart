...
abstract class GetBizUnitApiBizUnitDetail
    implements
        Built<GetBizUnitApiBizUnitDetail, GetBizUnitApiBizUnitDetailBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetBizUnitApiBizUnitDetail(
          [updates(GetBizUnitApiBizUnitDetailBuilder b)]) =
  ...
  static Serializer<GetBizUnitApiBizUnitDetail> get serializer =>
      _$getBizUnitApiBizUnitDetailSerializer;
}

abstract class GetBizUnitApiBizUnitDetailActions extends ModelActions<
  ...
  factory GetBizUnitApiBizUnitDetailActions(
          GetBizUnitApiBizUnitDetailActionsOptions options) =>
      _$GetBizUnitApiBizUnitDetailActions(options);
}
