...
abstract class GetFacilityApiFacilityDetail
    implements
        Built<GetFacilityApiFacilityDetail,
  ...
  factory GetFacilityApiFacilityDetail(
          [updates(GetFacilityApiFacilityDetailBuilder b)]) =
  ...
  static Serializer<GetFacilityApiFacilityDetail> get serializer =>
      _$getFacilityApiFacilityDetailSerializer;
}

abstract class GetFacilityApiFacilityDetailActions extends ModelActions<
  ...
  factory GetFacilityApiFacilityDetailActions(
          GetFacilityApiFacilityDetailActionsOptions options) =>
      _$GetFacilityApiFacilityDetailActions(options);
}
