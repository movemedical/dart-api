...
part 'update_facility_api_request.g.dart';

abstract class UpdateFacilityApiRequest implements Built<UpdateFacilityApiRequest, UpdateFacilityApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  UpdateFacilityApiRequest._();
  
  factory UpdateFacilityApiRequest([updates(UpdateFacilityApiRequestBuilder b)]) = _$UpdateFacilityApiRequest;
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<UpdateFacilityApiRequest> get serializer => _$updateFacilityApiRequestSerializer;
}

abstract class UpdateFacilityApiRequestActions extends ModelActions<UpdateFacilityApiRequest, UpdateFacilityApiRequestBuilder, UpdateFacilityApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  UpdateFacilityApiRequestActions._();
  
  factory UpdateFacilityApiRequestActions(UpdateFacilityApiRequestActionsOptions options) => _$UpdateFacilityApiRequestActions(options);
}
