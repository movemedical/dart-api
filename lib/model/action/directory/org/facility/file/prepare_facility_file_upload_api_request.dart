...
abstract class PrepareFacilityFileUploadApiRequest
    implements
        Built<PrepareFacilityFileUploadApiRequest,
  ...
  factory PrepareFacilityFileUploadApiRequest(
          [updates(PrepareFacilityFileUploadApiRequestBuilder b)]) =
  ...
  static Serializer<PrepareFacilityFileUploadApiRequest> get serializer =>
      _$prepareFacilityFileUploadApiRequestSerializer;
}

abstract class PrepareFacilityFileUploadApiRequestActions extends ModelActions<
    PrepareFacilityFileUploadApiRequest,
    PrepareFacilityFileUploadApiRequestBuilder,
    PrepareFacilityFileUploadApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory PrepareFacilityFileUploadApiRequestActions(
          PrepareFacilityFileUploadApiRequestActionsOptions options) =>
      _$PrepareFacilityFileUploadApiRequestActions(options);
}
