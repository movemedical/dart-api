...
part of 'create_facility_api_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<CreateFacilityApiRequest> _$createFacilityApiRequestSerializer =
    new _$CreateFacilityApiRequestSerializer();

class _$CreateFacilityApiRequestSerializer
    implements StructuredSerializer<CreateFacilityApiRequest> {
  @override
  ...
  final String wireName =
      'movemedical_api/model/action/directory/org/facility/CreateFacilityApiRequest';

  @override
  Iterable serialize(Serializers serializers, CreateFacilityApiRequest object,
  ...
  @override
  CreateFacilityApiRequest deserialize(
      Serializers serializers, Iterable serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new CreateFacilityApiRequestBuilder();
...
class _$CreateFacilityApiRequest extends CreateFacilityApiRequest {
  @override
  final String orgId;
  @override
  ...
  factory _$CreateFacilityApiRequest(
          [void updates(CreateFacilityApiRequestBuilder b)]) =>
      (new CreateFacilityApiRequestBuilder()..update(updates)).build();

  _$CreateFacilityApiRequest._(
      {this.orgId,
      this.facilityType,
      this.name,
      this.contactName,
  ...
  @override
  CreateFacilityApiRequest rebuild(
          void updates(CreateFacilityApiRequestBuilder b)) =>
      (toBuilder()..update(updates)).build();

  @override
  CreateFacilityApiRequestBuilder toBuilder() =>
      new CreateFacilityApiRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is CreateFacilityApiRequest &&
        orgId == other.orgId &&
                                                        ...
                                                        $jc(
                                                            $jc(
                                                                $jc(
                                                                    $jc(
                                                                        $jc(
                                                                            $jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc(0, orgId.hashCode), facilityType.hashCode), name.hashCode), contactName.hashCode), contactPhone.hashCode), timeZone.hashCode), caseLoaningMethodology.hashCode), restockType.hashCode), binManaged.hashCode), autoPutAway.hashCode), active.hashCode),
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('CreateFacilityApiRequest')
          ..add('orgId', orgId)
...
class CreateFacilityApiRequestBuilder
    implements
        Builder<CreateFacilityApiRequest, CreateFacilityApiRequestBuilder> {
  _$CreateFacilityApiRequest _$v;
  ...
  CreateFacilityApiRequestBuilder get _$this {
    if (_$v != null) {
      _orgId = _$v.orgId;
  ...
  @override
  void replace(CreateFacilityApiRequest other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$CreateFacilityApiRequest;
  }

  @override
  void update(void updates(CreateFacilityApiRequestBuilder b)) {
    if (updates != null) updates(this);
  }

  @override
  _$CreateFacilityApiRequest build() {
    _$CreateFacilityApiRequest _$result;
    try {
      _$result = _$v ??
          new _$CreateFacilityApiRequest._(
              orgId: orgId,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'CreateFacilityApiRequest', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
typedef StatefulActionsOptions<
    CreateFacilityApiRequest,
    CreateFacilityApiRequestBuilder,
    CreateFacilityApiRequestActions> CreateFacilityApiRequestActionsOptions();

class _$CreateFacilityApiRequestActions
    extends CreateFacilityApiRequestActions {
  final StatefulActionsOptions<
      CreateFacilityApiRequest,
      CreateFacilityApiRequestBuilder,
      CreateFacilityApiRequestActions> $options;

  final ActionDispatcher<CreateFacilityApiRequest> $replace;
  ...
  _$CreateFacilityApiRequestActions._(this.$options)
      : $replace = $options.action<CreateFacilityApiRequest>(
            '\$replace', (a) => a?.$replace),
  ...
  factory _$CreateFacilityApiRequestActions(
          CreateFacilityApiRequestActionsOptions options) =>
      _$CreateFacilityApiRequestActions._(options());

  @override
  CreateFacilityApiRequest get $initial => CreateFacilityApiRequest();

  @override
  CreateFacilityApiRequestBuilder $newBuilder() =>
      CreateFacilityApiRequestBuilder();
...
// @override
// Serializer<CreateFacilityApiRequestCreateFacilityApiRequestActions> get $serializer => CreateFacilityApiRequestCreateFacilityApiRequestActions.serializer;

  FullType _$fullType;
  @override
  FullType get $fullType => _$fullType ??= FullType(CreateFacilityApiRequest);
}
