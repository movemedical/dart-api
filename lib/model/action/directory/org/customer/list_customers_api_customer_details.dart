...
abstract class ListCustomersApiCustomerDetails
    implements
        Built<ListCustomersApiCustomerDetails,
  ...
  factory ListCustomersApiCustomerDetails(
          [updates(ListCustomersApiCustomerDetailsBuilder b)]) =
  ...
  static Serializer<ListCustomersApiCustomerDetails> get serializer =>
      _$listCustomersApiCustomerDetailsSerializer;
}

abstract class ListCustomersApiCustomerDetailsActions extends ModelActions<
  ...
  factory ListCustomersApiCustomerDetailsActions(
          ListCustomersApiCustomerDetailsActionsOptions options) =>
      _$ListCustomersApiCustomerDetailsActions(options);
}
