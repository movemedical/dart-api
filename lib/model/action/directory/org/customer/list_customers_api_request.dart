...
abstract class ListCustomersApiRequest
    implements Built<ListCustomersApiRequest, ListCustomersApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListCustomersApiRequest([updates(ListCustomersApiRequestBuilder b)]) =
  ...
  static Serializer<ListCustomersApiRequest> get serializer =>
      _$listCustomersApiRequestSerializer;
}

abstract class ListCustomersApiRequestActions extends ModelActions<
    ListCustomersApiRequest,
    ListCustomersApiRequestBuilder,
    ListCustomersApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListCustomersApiRequestActions(
          ListCustomersApiRequestActionsOptions options) =>
      _$ListCustomersApiRequestActions(options);
}
