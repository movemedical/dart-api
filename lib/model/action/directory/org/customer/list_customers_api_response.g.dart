...
class _$ListCustomersApiResponseActions
  ...
  _$ListCustomersApiResponseActions._(this.$options)
      : $replace = $options.action<ListCustomersApiResponse>(
            '\$replace', (a) => a?.$replace),
        data = $options.actionField<BuiltList<ListCustomersApiCustomerDetails>>(
  ...
  @override
  ListCustomersApiResponse get $initial => ListCustomersApiResponse();
...
// @override
// Serializer<ListCustomersApiResponseListCustomersApiResponseActions> get $serializer => ListCustomersApiResponseListCustomersApiResponseActions.serializer;

  FullType _$fullType;
  @override
  FullType get $fullType => _$fullType ??= FullType(ListCustomersApiResponse);
}
