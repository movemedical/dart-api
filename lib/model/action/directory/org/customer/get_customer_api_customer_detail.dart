...
abstract class GetCustomerApiCustomerDetail
    implements
        Built<GetCustomerApiCustomerDetail,
  ...
  factory GetCustomerApiCustomerDetail(
          [updates(GetCustomerApiCustomerDetailBuilder b)]) =
  ...
  static Serializer<GetCustomerApiCustomerDetail> get serializer =>
      _$getCustomerApiCustomerDetailSerializer;
}

abstract class GetCustomerApiCustomerDetailActions extends ModelActions<
  ...
  factory GetCustomerApiCustomerDetailActions(
          GetCustomerApiCustomerDetailActionsOptions options) =>
      _$GetCustomerApiCustomerDetailActions(options);
}
