...
abstract class UpdatePhysicianApiRequest
    implements
        Built<UpdatePhysicianApiRequest, UpdatePhysicianApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory UpdatePhysicianApiRequest(
          [updates(UpdatePhysicianApiRequestBuilder b)]) =
  ...
  static Serializer<UpdatePhysicianApiRequest> get serializer =>
      _$updatePhysicianApiRequestSerializer;
}

abstract class UpdatePhysicianApiRequestActions extends ModelActions<
    UpdatePhysicianApiRequest,
    UpdatePhysicianApiRequestBuilder,
    UpdatePhysicianApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory UpdatePhysicianApiRequestActions(
          UpdatePhysicianApiRequestActionsOptions options) =>
      _$UpdatePhysicianApiRequestActions(options);
}
