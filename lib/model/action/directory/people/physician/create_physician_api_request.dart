...
abstract class CreatePhysicianApiRequest
    implements
        Built<CreatePhysicianApiRequest, CreatePhysicianApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreatePhysicianApiRequest(
          [updates(CreatePhysicianApiRequestBuilder b)]) =
  ...
  static Serializer<CreatePhysicianApiRequest> get serializer =>
      _$createPhysicianApiRequestSerializer;
}

abstract class CreatePhysicianApiRequestActions extends ModelActions<
    CreatePhysicianApiRequest,
    CreatePhysicianApiRequestBuilder,
    CreatePhysicianApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreatePhysicianApiRequestActions(
          CreatePhysicianApiRequestActionsOptions options) =>
      _$CreatePhysicianApiRequestActions(options);
}
