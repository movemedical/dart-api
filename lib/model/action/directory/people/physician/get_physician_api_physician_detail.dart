...
abstract class GetPhysicianApiPhysicianDetail implements Built<GetPhysicianApiPhysicianDetail, GetPhysicianApiPhysicianDetailBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetPhysicianApiPhysicianDetail([updates(GetPhysicianApiPhysicianDetailBuilder b)]) = _$GetPhysicianApiPhysicianDetail;
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<GetPhysicianApiPhysicianDetail> get serializer => _$getPhysicianApiPhysicianDetailSerializer;
}

abstract class GetPhysicianApiPhysicianDetailActions extends ModelActions<GetPhysicianApiPhysicianDetail, GetPhysicianApiPhysicianDetailBuilder, GetPhysicianApiPhysicianDetailActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetPhysicianApiPhysicianDetailActions(GetPhysicianApiPhysicianDetailActionsOptions options) => _$GetPhysicianApiPhysicianDetailActions(options);
}
