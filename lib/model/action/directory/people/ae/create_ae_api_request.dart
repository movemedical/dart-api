...
abstract class CreateAeApiRequest implements Built<CreateAeApiRequest, CreateAeApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreateAeApiRequest([updates(CreateAeApiRequestBuilder b)]) = _$CreateAeApiRequest;
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<CreateAeApiRequest> get serializer => _$createAeApiRequestSerializer;
}

abstract class CreateAeApiRequestActions extends ModelActions<CreateAeApiRequest, CreateAeApiRequestBuilder, CreateAeApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreateAeApiRequestActions(CreateAeApiRequestActionsOptions options) => _$CreateAeApiRequestActions(options);
}
