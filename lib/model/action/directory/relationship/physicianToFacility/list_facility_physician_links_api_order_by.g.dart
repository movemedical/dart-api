...
ListFacilityPhysicianLinksApiOrderBy
    _$listFacilityPhysicianLinksApiOrderByValueOf(String name) {
  switch (name) {
    case 'NAME':
      return _$wireNAME;
    default:
...
final BuiltSet<ListFacilityPhysicianLinksApiOrderBy>
...
class _$ListFacilityPhysicianLinksApiOrderBySerializer
  ...
  final String wireName =
      'movemedical_api/model/action/directory/relationship/physicianToFacility/ListFacilityPhysicianLinksApiOrderBy';
