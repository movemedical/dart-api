...
ListPhysicianFacilityLinksApiOrderBy
    _$listPhysicianFacilityLinksApiOrderByValueOf(String name) {
  switch (name) {
    case 'NAME':
      return _$wireNAME;
    default:
...
final BuiltSet<ListPhysicianFacilityLinksApiOrderBy>
    _$listPhysicianFacilityLinksApiOrderByValues =
...
class _$ListPhysicianFacilityLinksApiOrderBySerializer
  ...
  final String wireName =
      'movemedical_api/model/action/directory/relationship/physicianToFacility/ListPhysicianFacilityLinksApiOrderBy';
