...
abstract class ListHcrColleagueLinksApiColleagueLink
    implements
        Built<ListHcrColleagueLinksApiColleagueLink,
  ...
  factory ListHcrColleagueLinksApiColleagueLink(
          [updates(ListHcrColleagueLinksApiColleagueLinkBuilder b)]) =
  ...
  static Serializer<ListHcrColleagueLinksApiColleagueLink> get serializer =>
      _$listHcrColleagueLinksApiColleagueLinkSerializer;
}

abstract class ListHcrColleagueLinksApiColleagueLinkActions
    extends ModelActions<
        ListHcrColleagueLinksApiColleagueLink,
        ListHcrColleagueLinksApiColleagueLinkBuilder,
        ListHcrColleagueLinksApiColleagueLinkActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListHcrColleagueLinksApiColleagueLinkActions(
          ListHcrColleagueLinksApiColleagueLinkActionsOptions options) =>
      _$ListHcrColleagueLinksApiColleagueLinkActions(options);
}
