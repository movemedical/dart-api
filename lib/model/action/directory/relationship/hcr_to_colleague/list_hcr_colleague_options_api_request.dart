...
abstract class ListHcrColleagueOptionsApiRequest
    implements
        Built<ListHcrColleagueOptionsApiRequest,
  ...
  factory ListHcrColleagueOptionsApiRequest(
          [updates(ListHcrColleagueOptionsApiRequestBuilder b)]) =
  ...
  static Serializer<ListHcrColleagueOptionsApiRequest> get serializer =>
      _$listHcrColleagueOptionsApiRequestSerializer;
}

abstract class ListHcrColleagueOptionsApiRequestActions extends ModelActions<
    ListHcrColleagueOptionsApiRequest,
    ListHcrColleagueOptionsApiRequestBuilder,
    ListHcrColleagueOptionsApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListHcrColleagueOptionsApiRequestActions(
          ListHcrColleagueOptionsApiRequestActionsOptions options) =>
      _$ListHcrColleagueOptionsApiRequestActions(options);
}
