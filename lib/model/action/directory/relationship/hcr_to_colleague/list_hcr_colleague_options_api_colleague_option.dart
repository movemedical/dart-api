...
abstract class ListHcrColleagueOptionsApiColleagueOption
    implements
        Built<ListHcrColleagueOptionsApiColleagueOption,
  ...
  factory ListHcrColleagueOptionsApiColleagueOption(
          [updates(ListHcrColleagueOptionsApiColleagueOptionBuilder b)]) =
  ...
  static Serializer<ListHcrColleagueOptionsApiColleagueOption> get serializer =>
      _$listHcrColleagueOptionsApiColleagueOptionSerializer;
}

abstract class ListHcrColleagueOptionsApiColleagueOptionActions
    extends ModelActions<
        ListHcrColleagueOptionsApiColleagueOption,
        ListHcrColleagueOptionsApiColleagueOptionBuilder,
        ListHcrColleagueOptionsApiColleagueOptionActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListHcrColleagueOptionsApiColleagueOptionActions(
          ListHcrColleagueOptionsApiColleagueOptionActionsOptions options) =>
      _$ListHcrColleagueOptionsApiColleagueOptionActions(options);
}
