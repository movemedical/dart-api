...
abstract class ListHcrColleagueLinksApiRequest
    implements
        Built<ListHcrColleagueLinksApiRequest,
  ...
  factory ListHcrColleagueLinksApiRequest(
          [updates(ListHcrColleagueLinksApiRequestBuilder b)]) =
  ...
  static Serializer<ListHcrColleagueLinksApiRequest> get serializer =>
      _$listHcrColleagueLinksApiRequestSerializer;
}

abstract class ListHcrColleagueLinksApiRequestActions extends ModelActions<
    ListHcrColleagueLinksApiRequest,
    ListHcrColleagueLinksApiRequestBuilder,
    ListHcrColleagueLinksApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListHcrColleagueLinksApiRequestActions(
          ListHcrColleagueLinksApiRequestActionsOptions options) =>
      _$ListHcrColleagueLinksApiRequestActions(options);
}
