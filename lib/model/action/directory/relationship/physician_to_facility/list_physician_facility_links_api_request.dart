...
abstract class ListPhysicianFacilityLinksApiRequest
    implements
        Built<ListPhysicianFacilityLinksApiRequest,
  ...
  factory ListPhysicianFacilityLinksApiRequest(
          [updates(ListPhysicianFacilityLinksApiRequestBuilder b)]) =
  ...
  static Serializer<ListPhysicianFacilityLinksApiRequest> get serializer =>
      _$listPhysicianFacilityLinksApiRequestSerializer;
}

abstract class ListPhysicianFacilityLinksApiRequestActions extends ModelActions<
    ListPhysicianFacilityLinksApiRequest,
    ListPhysicianFacilityLinksApiRequestBuilder,
    ListPhysicianFacilityLinksApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListPhysicianFacilityLinksApiRequestActions(
          ListPhysicianFacilityLinksApiRequestActionsOptions options) =>
      _$ListPhysicianFacilityLinksApiRequestActions(options);
}
