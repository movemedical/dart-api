...
abstract class ListDceToOrgUnitLinksApiResponse
    implements
        Built<ListDceToOrgUnitLinksApiResponse,
  ...
  factory ListDceToOrgUnitLinksApiResponse(
          [updates(ListDceToOrgUnitLinksApiResponseBuilder b)]) =
  ...
  static Serializer<ListDceToOrgUnitLinksApiResponse> get serializer =>
      _$listDceToOrgUnitLinksApiResponseSerializer;
}

abstract class ListDceToOrgUnitLinksApiResponseActions extends ModelActions<
    ListDceToOrgUnitLinksApiResponse,
    ListDceToOrgUnitLinksApiResponseBuilder,
    ListDceToOrgUnitLinksApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListDceToOrgUnitLinksApiResponseActions(
          ListDceToOrgUnitLinksApiResponseActionsOptions options) =>
      _$ListDceToOrgUnitLinksApiResponseActions(options);
}
