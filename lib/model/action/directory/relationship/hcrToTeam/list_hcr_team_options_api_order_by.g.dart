...
ListHcrTeamOptionsApiOrderBy _$listHcrTeamOptionsApiOrderByValueOf(
    String name) {
  switch (name) {
    case 'NAME':
      return _$wireNAME;
...
final BuiltSet<ListHcrTeamOptionsApiOrderBy>
    _$listHcrTeamOptionsApiOrderByValues = new BuiltSet<
...
class _$ListHcrTeamOptionsApiOrderBySerializer
  ...
  final String wireName =
      'movemedical_api/model/action/directory/relationship/hcrToTeam/ListHcrTeamOptionsApiOrderBy';
