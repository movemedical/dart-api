...
ListHcrOrgUnitOptionsApiOrderBy _$valueOf(String name) {
  switch (name) {
    case 'NAME':
      return _$wireNAME;
    default:
...
final BuiltSet<ListHcrOrgUnitOptionsApiOrderBy> _$values = new BuiltSet<
    ListHcrOrgUnitOptionsApiOrderBy>(const <ListHcrOrgUnitOptionsApiOrderBy>[
  _$wireNAME,
]);
