...
abstract class ListHcrOrgUnitOptionsApiRequest
    implements
        Built<ListHcrOrgUnitOptionsApiRequest,
  ...
  factory ListHcrOrgUnitOptionsApiRequest(
          [updates(ListHcrOrgUnitOptionsApiRequestBuilder b)]) =
  ...
  static Serializer<ListHcrOrgUnitOptionsApiRequest> get serializer =>
      _$listHcrOrgUnitOptionsApiRequestSerializer;
}

abstract class ListHcrOrgUnitOptionsApiRequestActions extends ModelActions<
    ListHcrOrgUnitOptionsApiRequest,
    ListHcrOrgUnitOptionsApiRequestBuilder,
    ListHcrOrgUnitOptionsApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListHcrOrgUnitOptionsApiRequestActions(
          ListHcrOrgUnitOptionsApiRequestActionsOptions options) =>
      _$ListHcrOrgUnitOptionsApiRequestActions(options);
}
