...
abstract class ListHcrOrgUnitOptionsApiResponse
    implements
        Built<ListHcrOrgUnitOptionsApiResponse,
  ...
  factory ListHcrOrgUnitOptionsApiResponse(
          [updates(ListHcrOrgUnitOptionsApiResponseBuilder b)]) =
  ...
  static Serializer<ListHcrOrgUnitOptionsApiResponse> get serializer =>
      _$listHcrOrgUnitOptionsApiResponseSerializer;
}

abstract class ListHcrOrgUnitOptionsApiResponseActions extends ModelActions<
    ListHcrOrgUnitOptionsApiResponse,
    ListHcrOrgUnitOptionsApiResponseBuilder,
    ListHcrOrgUnitOptionsApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListHcrOrgUnitOptionsApiResponseActions(
          ListHcrOrgUnitOptionsApiResponseActionsOptions options) =>
      _$ListHcrOrgUnitOptionsApiResponseActions(options);
}
