...
abstract class ListHcrOrgUnitLinksApiResponse
    implements
        Built<ListHcrOrgUnitLinksApiResponse,
  ...
  factory ListHcrOrgUnitLinksApiResponse(
          [updates(ListHcrOrgUnitLinksApiResponseBuilder b)]) =
  ...
  static Serializer<ListHcrOrgUnitLinksApiResponse> get serializer =>
      _$listHcrOrgUnitLinksApiResponseSerializer;
}

abstract class ListHcrOrgUnitLinksApiResponseActions extends ModelActions<
    ListHcrOrgUnitLinksApiResponse,
    ListHcrOrgUnitLinksApiResponseBuilder,
    ListHcrOrgUnitLinksApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListHcrOrgUnitLinksApiResponseActions(
          ListHcrOrgUnitLinksApiResponseActionsOptions options) =>
      _$ListHcrOrgUnitLinksApiResponseActions(options);
}
