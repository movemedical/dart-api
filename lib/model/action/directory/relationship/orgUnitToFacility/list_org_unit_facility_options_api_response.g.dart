...
class _$ListOrgUnitFacilityOptionsApiResponseSerializer
  ...
  final String wireName =
      'movemedical_api/model/action/directory/relationship/orgUnitToFacility/ListOrgUnitFacilityOptionsApiResponse';
...
class _$ListOrgUnitFacilityOptionsApiResponseActions
  ...
  _$ListOrgUnitFacilityOptionsApiResponseActions._(this.$options)
      : $replace = $options.action<ListOrgUnitFacilityOptionsApiResponse>(
            '\$replace', (a) => a?.$replace),
        data = $options.actionField<BuiltList<FacilityOption>>(
  ...
  @override
  ListOrgUnitFacilityOptionsApiResponse get $initial =>
      ListOrgUnitFacilityOptionsApiResponse();
...
// @override
// Serializer<ListOrgUnitFacilityOptionsApiResponseListOrgUnitFacilityOptionsApiResponseActions> get $serializer => ListOrgUnitFacilityOptionsApiResponseListOrgUnitFacilityOptionsApiResponseActions.serializer;

  FullType _$fullType;
  @override
  FullType get $fullType =>
      _$fullType ??= FullType(ListOrgUnitFacilityOptionsApiResponse);
}
