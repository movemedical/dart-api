...
ListFacilityOrgUnitLinksApiOrderBy _$listFacilityOrgUnitLinksApiOrderByValueOf(
    String name) {
  switch (name) {
    case 'NAME':
      return _$wireNAME;
...
final BuiltSet<ListFacilityOrgUnitLinksApiOrderBy>
    _$listFacilityOrgUnitLinksApiOrderByValues =
...
class _$ListFacilityOrgUnitLinksApiOrderBySerializer
  ...
  final String wireName =
      'movemedical_api/model/action/directory/relationship/orgUnitToFacility/ListFacilityOrgUnitLinksApiOrderBy';
