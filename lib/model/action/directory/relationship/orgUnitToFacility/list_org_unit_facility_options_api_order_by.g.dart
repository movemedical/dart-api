...
ListOrgUnitFacilityOptionsApiOrderBy
    _$listOrgUnitFacilityOptionsApiOrderByValueOf(String name) {
  switch (name) {
    case 'NAME':
      return _$wireNAME;
    default:
...
final BuiltSet<ListOrgUnitFacilityOptionsApiOrderBy>
    _$listOrgUnitFacilityOptionsApiOrderByValues =
...
class _$ListOrgUnitFacilityOptionsApiOrderBySerializer
  ...
  final String wireName =
      'movemedical_api/model/action/directory/relationship/orgUnitToFacility/ListOrgUnitFacilityOptionsApiOrderBy';
