...
class _$ListHcrColleagueLinksApiResponseSerializer
  ...
  final String wireName =
      'movemedical_api/model/action/directory/relationship/hcrToColleague/ListHcrColleagueLinksApiResponse';
...
class _$ListHcrColleagueLinksApiResponseActions
  ...
  _$ListHcrColleagueLinksApiResponseActions._(this.$options)
      : $replace = $options.action<ListHcrColleagueLinksApiResponse>(
            '\$replace', (a) => a?.$replace),
        data = $options
            .actionField<BuiltList<ListHcrColleagueLinksApiColleagueLink>>(
  ...
  @override
  ListHcrColleagueLinksApiResponse get $initial =>
      ListHcrColleagueLinksApiResponse();
...
// @override
// Serializer<ListHcrColleagueLinksApiResponseListHcrColleagueLinksApiResponseActions> get $serializer => ListHcrColleagueLinksApiResponseListHcrColleagueLinksApiResponseActions.serializer;

  FullType _$fullType;
  @override
  FullType get $fullType =>
      _$fullType ??= FullType(ListHcrColleagueLinksApiResponse);
}
