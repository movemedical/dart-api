...
abstract class ListRelationshipTypesForOrgUnitApiRequest
    implements
        Built<ListRelationshipTypesForOrgUnitApiRequest,
  ...
  factory ListRelationshipTypesForOrgUnitApiRequest(
          [updates(ListRelationshipTypesForOrgUnitApiRequestBuilder b)]) =
  ...
  static Serializer<ListRelationshipTypesForOrgUnitApiRequest> get serializer =>
      _$listRelationshipTypesForOrgUnitApiRequestSerializer;
}

abstract class ListRelationshipTypesForOrgUnitApiRequestActions
    extends ModelActions<
        ListRelationshipTypesForOrgUnitApiRequest,
        ListRelationshipTypesForOrgUnitApiRequestBuilder,
        ListRelationshipTypesForOrgUnitApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListRelationshipTypesForOrgUnitApiRequestActions(
          ListRelationshipTypesForOrgUnitApiRequestActionsOptions options) =>
      _$ListRelationshipTypesForOrgUnitApiRequestActions(options);
}
