...
ListTeamOrgUnitLinksApiOrderBy _$listTeamOrgUnitLinksApiOrderByValueOf(
    String name) {
  switch (name) {
    case 'NAME':
      return _$wireNAME;
...
final BuiltSet<ListTeamOrgUnitLinksApiOrderBy>
    _$listTeamOrgUnitLinksApiOrderByValues = new BuiltSet<
...
class _$ListTeamOrgUnitLinksApiOrderBySerializer
  ...
  final String wireName =
      'movemedical_api/model/action/directory/relationship/teamToOrgUnit/ListTeamOrgUnitLinksApiOrderBy';
