...
class _$ListOrgUnitTeamLinksApiResponseSerializer
  ...
  final String wireName =
      'movemedical_api/model/action/directory/relationship/teamToOrgUnit/ListOrgUnitTeamLinksApiResponse';
...
class _$ListOrgUnitTeamLinksApiResponseActions
  ...
  _$ListOrgUnitTeamLinksApiResponseActions._(this.$options)
      : $replace = $options.action<ListOrgUnitTeamLinksApiResponse>(
            '\$replace', (a) => a?.$replace),
        data = $options.actionField<BuiltList<ListOrgUnitTeamLinksApiTeamLink>>(
  ...
  @override
  ListOrgUnitTeamLinksApiResponse get $initial =>
      ListOrgUnitTeamLinksApiResponse();
...
// @override
// Serializer<ListOrgUnitTeamLinksApiResponseListOrgUnitTeamLinksApiResponseActions> get $serializer => ListOrgUnitTeamLinksApiResponseListOrgUnitTeamLinksApiResponseActions.serializer;

  FullType _$fullType;
  @override
  FullType get $fullType =>
      _$fullType ??= FullType(ListOrgUnitTeamLinksApiResponse);
}
