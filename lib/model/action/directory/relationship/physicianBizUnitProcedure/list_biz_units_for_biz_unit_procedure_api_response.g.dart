...
class _$ListBizUnitsForBizUnitProcedureApiResponseSerializer
  ...
  final String wireName =
      'movemedical_api/model/action/directory/relationship/physicianBizUnitProcedure/ListBizUnitsForBizUnitProcedureApiResponse';
...
class _$ListBizUnitsForBizUnitProcedureApiResponseActions
  ...
  _$ListBizUnitsForBizUnitProcedureApiResponseActions._(this.$options)
      : $replace = $options.action<ListBizUnitsForBizUnitProcedureApiResponse>(
            '\$replace', (a) => a?.$replace),
        data = $options
            .actionField<BuiltList<ListBizUnitsForBizUnitProcedureApiBizUnit>>(
  ...
  @override
  ListBizUnitsForBizUnitProcedureApiResponse get $initial =>
      ListBizUnitsForBizUnitProcedureApiResponse();
...
// @override
// Serializer<ListBizUnitsForBizUnitProcedureApiResponseListBizUnitsForBizUnitProcedureApiResponseActions> get $serializer => ListBizUnitsForBizUnitProcedureApiResponseListBizUnitsForBizUnitProcedureApiResponseActions.serializer;

  FullType _$fullType;
  @override
  FullType get $fullType =>
      _$fullType ??= FullType(ListBizUnitsForBizUnitProcedureApiResponse);
}
