...
part of 'get_ae_org_unit_link_api_detailed_org_unit_link.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<GetAeOrgUnitLinkApiDetailedOrgUnitLink>
    _$getAeOrgUnitLinkApiDetailedOrgUnitLinkSerializer =
    new _$GetAeOrgUnitLinkApiDetailedOrgUnitLinkSerializer();

class _$GetAeOrgUnitLinkApiDetailedOrgUnitLinkSerializer
    implements StructuredSerializer<GetAeOrgUnitLinkApiDetailedOrgUnitLink> {
  @override
  ...
  final String wireName =
      'movemedical_api/model/action/directory/relationship/ae_to_org_unit/GetAeOrgUnitLinkApiDetailedOrgUnitLink';

  @override
  Iterable serialize(
      Serializers serializers, GetAeOrgUnitLinkApiDetailedOrgUnitLink object,
    ...
    if (object.approveSalesOrder != null) {
      result
        ..add('approveSalesOrder')
        ..add(serializers.serialize(object.approveSalesOrder,
            specifiedType: const FullType(bool)));
    }
  ...
  @override
  GetAeOrgUnitLinkApiDetailedOrgUnitLink deserialize(
      Serializers serializers, Iterable serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GetAeOrgUnitLinkApiDetailedOrgUnitLinkBuilder();
      ...
      switch (key) {
        ...
        case 'manageZone':
          result.manageZone = serializers.deserialize(value,
              specifiedType: const FullType(bool)) as bool;
          break;
        case 'approveSalesOrder':
          result.approveSalesOrder = serializers.deserialize(value,
              specifiedType: const FullType(bool)) as bool;
          break;
...
class _$GetAeOrgUnitLinkApiDetailedOrgUnitLink
    extends GetAeOrgUnitLinkApiDetailedOrgUnitLink {
  @override
  final String id;
  @override
  ...
  @override
  final bool approveSalesOrder;
  @override
  final BuiltList<OuLinkToInventoryType> inventoryTypeLinks;

  factory _$GetAeOrgUnitLinkApiDetailedOrgUnitLink(
          [void updates(GetAeOrgUnitLinkApiDetailedOrgUnitLinkBuilder b)]) =>
      (new GetAeOrgUnitLinkApiDetailedOrgUnitLinkBuilder()..update(updates))
          .build();

  _$GetAeOrgUnitLinkApiDetailedOrgUnitLink._(
      {this.id,
      this.orgUnitId,
      this.orgUnitName,
      this.ouAccessType,
      ...
      this.approveLoanMax,
      this.manageZone,
      this.approveSalesOrder,
      this.inventoryTypeLinks})
      : super._();

  @override
  GetAeOrgUnitLinkApiDetailedOrgUnitLink rebuild(
          void updates(GetAeOrgUnitLinkApiDetailedOrgUnitLinkBuilder b)) =>
      (toBuilder()..update(updates)).build();

  @override
  GetAeOrgUnitLinkApiDetailedOrgUnitLinkBuilder toBuilder() =>
      new GetAeOrgUnitLinkApiDetailedOrgUnitLinkBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GetAeOrgUnitLinkApiDetailedOrgUnitLink &&
        id == other.id &&
        ...
        approveSalesOrder == other.approveSalesOrder &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
          ...
          ..add('approveSalesOrder', approveSalesOrder)
          ..add('inventoryTypeLinks', inventoryTypeLinks))
        .toString();
  }
}

class GetAeOrgUnitLinkApiDetailedOrgUnitLinkBuilder
    implements
        Builder<GetAeOrgUnitLinkApiDetailedOrgUnitLink,
            GetAeOrgUnitLinkApiDetailedOrgUnitLinkBuilder> {
  _$GetAeOrgUnitLinkApiDetailedOrgUnitLink _$v;
  ...
  bool _approveSalesOrder;
  bool get approveSalesOrder => _$this._approveSalesOrder;
  set approveSalesOrder(bool approveSalesOrder) =>
      _$this._approveSalesOrder = approveSalesOrder;
  ...
  GetAeOrgUnitLinkApiDetailedOrgUnitLinkBuilder get _$this {
    if (_$v != null) {
      _id = _$v.id;
      ...
      _approveSalesOrder = _$v.approveSalesOrder;
  ...
  @override
  void replace(GetAeOrgUnitLinkApiDetailedOrgUnitLink other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$GetAeOrgUnitLinkApiDetailedOrgUnitLink;
  }

  @override
  void update(void updates(GetAeOrgUnitLinkApiDetailedOrgUnitLinkBuilder b)) {
    if (updates != null) updates(this);
  }

  @override
  _$GetAeOrgUnitLinkApiDetailedOrgUnitLink build() {
    _$GetAeOrgUnitLinkApiDetailedOrgUnitLink _$result;
    try {
      _$result = _$v ??
          new _$GetAeOrgUnitLinkApiDetailedOrgUnitLink._(
              id: id,
              orgUnitId: orgUnitId,
              ...
              approveSalesOrder: approveSalesOrder,
...
typedef StatefulActionsOptions<
    GetAeOrgUnitLinkApiDetailedOrgUnitLink,
    GetAeOrgUnitLinkApiDetailedOrgUnitLinkBuilder,
    GetAeOrgUnitLinkApiDetailedOrgUnitLinkActions> GetAeOrgUnitLinkApiDetailedOrgUnitLinkActionsOptions();

class _$GetAeOrgUnitLinkApiDetailedOrgUnitLinkActions
    extends GetAeOrgUnitLinkApiDetailedOrgUnitLinkActions {
  final StatefulActionsOptions<
      GetAeOrgUnitLinkApiDetailedOrgUnitLink,
      GetAeOrgUnitLinkApiDetailedOrgUnitLinkBuilder,
      GetAeOrgUnitLinkApiDetailedOrgUnitLinkActions> $options;

  final ActionDispatcher<GetAeOrgUnitLinkApiDetailedOrgUnitLink> $replace;
  ...
  final FieldDispatcher<bool> approveSalesOrder;
  final FieldDispatcher<BuiltList<OuLinkToInventoryType>> inventoryTypeLinks;

  _$GetAeOrgUnitLinkApiDetailedOrgUnitLinkActions._(this.$options)
      : $replace = $options.action<GetAeOrgUnitLinkApiDetailedOrgUnitLink>(
            '\$replace', (a) => a?.$replace),
        ...
        approveSalesOrder = $options.field<bool>(
            'approveSalesOrder',
            (a) => a?.approveSalesOrder,
            (s) => s?.approveSalesOrder,
            (p, b) => p?.approveSalesOrder = b),
  ...
  factory _$GetAeOrgUnitLinkApiDetailedOrgUnitLinkActions(
          GetAeOrgUnitLinkApiDetailedOrgUnitLinkActionsOptions options) =>
      _$GetAeOrgUnitLinkApiDetailedOrgUnitLinkActions._(options());

  @override
  GetAeOrgUnitLinkApiDetailedOrgUnitLink get $initial =>
      GetAeOrgUnitLinkApiDetailedOrgUnitLink();

  @override
  GetAeOrgUnitLinkApiDetailedOrgUnitLinkBuilder $newBuilder() =>
      GetAeOrgUnitLinkApiDetailedOrgUnitLinkBuilder();
  ...
  void $reducer(ReducerBuilder reducer) {
    ...
    approveSalesOrder.$reducer(reducer);
  ...
  FullType get $fullType =>
      _$fullType ??= FullType(GetAeOrgUnitLinkApiDetailedOrgUnitLink);
}
