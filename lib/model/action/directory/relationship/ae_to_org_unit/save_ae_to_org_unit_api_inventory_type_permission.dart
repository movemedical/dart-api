...
abstract class SaveAeToOrgUnitApiInventoryTypePermission
    implements
        Built<SaveAeToOrgUnitApiInventoryTypePermission,
  ...
  factory SaveAeToOrgUnitApiInventoryTypePermission(
          [updates(SaveAeToOrgUnitApiInventoryTypePermissionBuilder b)]) =
  ...
  static Serializer<SaveAeToOrgUnitApiInventoryTypePermission> get serializer =>
      _$saveAeToOrgUnitApiInventoryTypePermissionSerializer;
}

abstract class SaveAeToOrgUnitApiInventoryTypePermissionActions
    extends ModelActions<
        SaveAeToOrgUnitApiInventoryTypePermission,
        SaveAeToOrgUnitApiInventoryTypePermissionBuilder,
        SaveAeToOrgUnitApiInventoryTypePermissionActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory SaveAeToOrgUnitApiInventoryTypePermissionActions(
          SaveAeToOrgUnitApiInventoryTypePermissionActionsOptions options) =>
      _$SaveAeToOrgUnitApiInventoryTypePermissionActions(options);
}
