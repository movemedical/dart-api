...
abstract class ListAeOrgUnitOptionsApiResponse
    implements
        Built<ListAeOrgUnitOptionsApiResponse,
  ...
  factory ListAeOrgUnitOptionsApiResponse(
          [updates(ListAeOrgUnitOptionsApiResponseBuilder b)]) =
  ...
  static Serializer<ListAeOrgUnitOptionsApiResponse> get serializer =>
      _$listAeOrgUnitOptionsApiResponseSerializer;
}

abstract class ListAeOrgUnitOptionsApiResponseActions extends ModelActions<
    ListAeOrgUnitOptionsApiResponse,
    ListAeOrgUnitOptionsApiResponseBuilder,
    ListAeOrgUnitOptionsApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListAeOrgUnitOptionsApiResponseActions(
          ListAeOrgUnitOptionsApiResponseActionsOptions options) =>
      _$ListAeOrgUnitOptionsApiResponseActions(options);
}
