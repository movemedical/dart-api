...
abstract class ListSalesOrgUnitItemCategoryLinksApiResponse
    implements
        Built<ListSalesOrgUnitItemCategoryLinksApiResponse,
  ...
  factory ListSalesOrgUnitItemCategoryLinksApiResponse(
          [updates(ListSalesOrgUnitItemCategoryLinksApiResponseBuilder b)]) =
  ...
  static Serializer<ListSalesOrgUnitItemCategoryLinksApiResponse>
      get serializer =>
          _$listSalesOrgUnitItemCategoryLinksApiResponseSerializer;
}

abstract class ListSalesOrgUnitItemCategoryLinksApiResponseActions
    extends ModelActions<
        ListSalesOrgUnitItemCategoryLinksApiResponse,
        ListSalesOrgUnitItemCategoryLinksApiResponseBuilder,
        ListSalesOrgUnitItemCategoryLinksApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListSalesOrgUnitItemCategoryLinksApiResponseActions(
          ListSalesOrgUnitItemCategoryLinksApiResponseActionsOptions options) =>
      _$ListSalesOrgUnitItemCategoryLinksApiResponseActions(options);
}
