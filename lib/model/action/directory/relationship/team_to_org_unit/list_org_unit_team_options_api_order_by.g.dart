...
ListOrgUnitTeamOptionsApiOrderBy _$valueOf(String name) {
  switch (name) {
    case 'NAME':
      return _$wireNAME;
    default:
...
final BuiltSet<ListOrgUnitTeamOptionsApiOrderBy> _$values = new BuiltSet<
    ListOrgUnitTeamOptionsApiOrderBy>(const <ListOrgUnitTeamOptionsApiOrderBy>[
  _$wireNAME,
]);
