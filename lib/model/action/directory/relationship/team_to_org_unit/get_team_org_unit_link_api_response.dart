...
abstract class GetTeamOrgUnitLinkApiResponse
    implements
        Built<GetTeamOrgUnitLinkApiResponse,
  ...
  factory GetTeamOrgUnitLinkApiResponse(
          [updates(GetTeamOrgUnitLinkApiResponseBuilder b)]) =
  ...
  static Serializer<GetTeamOrgUnitLinkApiResponse> get serializer =>
      _$getTeamOrgUnitLinkApiResponseSerializer;
}

abstract class GetTeamOrgUnitLinkApiResponseActions extends ModelActions<
    GetTeamOrgUnitLinkApiResponse,
    GetTeamOrgUnitLinkApiResponseBuilder,
    GetTeamOrgUnitLinkApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetTeamOrgUnitLinkApiResponseActions(
          GetTeamOrgUnitLinkApiResponseActionsOptions options) =>
      _$GetTeamOrgUnitLinkApiResponseActions(options);
}
