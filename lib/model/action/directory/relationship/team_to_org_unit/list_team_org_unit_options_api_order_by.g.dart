...
ListTeamOrgUnitOptionsApiOrderBy _$valueOf(String name) {
  switch (name) {
    case 'NAME':
      return _$wireNAME;
    default:
...
final BuiltSet<ListTeamOrgUnitOptionsApiOrderBy> _$values = new BuiltSet<
    ListTeamOrgUnitOptionsApiOrderBy>(const <ListTeamOrgUnitOptionsApiOrderBy>[
  _$wireNAME,
]);
...
class _$ListTeamOrgUnitOptionsApiOrderBySerializer
  ...
  final String wireName =
      'movemedical_api/model/action/directory/relationship/team_to_org_unit/ListTeamOrgUnitOptionsApiOrderBy';
