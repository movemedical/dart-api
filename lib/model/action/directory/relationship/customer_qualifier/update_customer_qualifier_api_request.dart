...
abstract class UpdateCustomerQualifierApiRequest
    implements
        Built<UpdateCustomerQualifierApiRequest,
  ...
  factory UpdateCustomerQualifierApiRequest(
          [updates(UpdateCustomerQualifierApiRequestBuilder b)]) =
  ...
  static Serializer<UpdateCustomerQualifierApiRequest> get serializer =>
      _$updateCustomerQualifierApiRequestSerializer;
}

abstract class UpdateCustomerQualifierApiRequestActions extends ModelActions<
    UpdateCustomerQualifierApiRequest,
    UpdateCustomerQualifierApiRequestBuilder,
    UpdateCustomerQualifierApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory UpdateCustomerQualifierApiRequestActions(
          UpdateCustomerQualifierApiRequestActionsOptions options) =>
      _$UpdateCustomerQualifierApiRequestActions(options);
}
