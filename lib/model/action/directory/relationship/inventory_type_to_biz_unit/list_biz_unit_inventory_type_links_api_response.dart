...
abstract class ListBizUnitInventoryTypeLinksApiResponse
    implements
        Built<ListBizUnitInventoryTypeLinksApiResponse,
  ...
  factory ListBizUnitInventoryTypeLinksApiResponse(
          [updates(ListBizUnitInventoryTypeLinksApiResponseBuilder b)]) =
  ...
  static Serializer<ListBizUnitInventoryTypeLinksApiResponse> get serializer =>
      _$listBizUnitInventoryTypeLinksApiResponseSerializer;
}

abstract class ListBizUnitInventoryTypeLinksApiResponseActions
    extends ModelActions<
        ListBizUnitInventoryTypeLinksApiResponse,
        ListBizUnitInventoryTypeLinksApiResponseBuilder,
        ListBizUnitInventoryTypeLinksApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////

  FieldDispatcher<BuiltList<ListBizUnitInventoryTypeLinksApiInventoryTypeLink>>
      get data;
  ...
  factory ListBizUnitInventoryTypeLinksApiResponseActions(
          ListBizUnitInventoryTypeLinksApiResponseActionsOptions options) =>
      _$ListBizUnitInventoryTypeLinksApiResponseActions(options);
}
