...
abstract class ListAeTeamOptionsApiResponse
    implements
        Built<ListAeTeamOptionsApiResponse,
  ...
  factory ListAeTeamOptionsApiResponse(
          [updates(ListAeTeamOptionsApiResponseBuilder b)]) =
  ...
  static Serializer<ListAeTeamOptionsApiResponse> get serializer =>
      _$listAeTeamOptionsApiResponseSerializer;
}

abstract class ListAeTeamOptionsApiResponseActions extends ModelActions<
    ListAeTeamOptionsApiResponse,
    ListAeTeamOptionsApiResponseBuilder,
    ListAeTeamOptionsApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListAeTeamOptionsApiResponseActions(
          ListAeTeamOptionsApiResponseActionsOptions options) =>
      _$ListAeTeamOptionsApiResponseActions(options);
}
