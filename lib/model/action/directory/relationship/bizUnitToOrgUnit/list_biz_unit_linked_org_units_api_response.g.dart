...
class _$ListBizUnitLinkedOrgUnitsApiResponseSerializer
  ...
  final String wireName =
      'movemedical_api/model/action/directory/relationship/bizUnitToOrgUnit/ListBizUnitLinkedOrgUnitsApiResponse';
...
class _$ListBizUnitLinkedOrgUnitsApiResponseActions
  ...
  _$ListBizUnitLinkedOrgUnitsApiResponseActions._(this.$options)
      : $replace = $options.action<ListBizUnitLinkedOrgUnitsApiResponse>(
            '\$replace', (a) => a?.$replace),
        data = $options
            .actionField<BuiltList<ListBizUnitLinkedOrgUnitsApiOrgUnitLink>>(
  ...
  @override
  ListBizUnitLinkedOrgUnitsApiResponse get $initial =>
      ListBizUnitLinkedOrgUnitsApiResponse();
...
// @override
// Serializer<ListBizUnitLinkedOrgUnitsApiResponseListBizUnitLinkedOrgUnitsApiResponseActions> get $serializer => ListBizUnitLinkedOrgUnitsApiResponseListBizUnitLinkedOrgUnitsApiResponseActions.serializer;

  FullType _$fullType;
  @override
  FullType get $fullType =>
      _$fullType ??= FullType(ListBizUnitLinkedOrgUnitsApiResponse);
}
