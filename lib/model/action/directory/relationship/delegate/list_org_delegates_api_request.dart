...
abstract class ListOrgDelegatesApiRequest
    implements
        Built<ListOrgDelegatesApiRequest, ListOrgDelegatesApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListOrgDelegatesApiRequest(
          [updates(ListOrgDelegatesApiRequestBuilder b)]) =
  ...
  static Serializer<ListOrgDelegatesApiRequest> get serializer =>
      _$listOrgDelegatesApiRequestSerializer;
}

abstract class ListOrgDelegatesApiRequestActions extends ModelActions<
    ListOrgDelegatesApiRequest,
    ListOrgDelegatesApiRequestBuilder,
    ListOrgDelegatesApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListOrgDelegatesApiRequestActions(
          ListOrgDelegatesApiRequestActionsOptions options) =>
      _$ListOrgDelegatesApiRequestActions(options);
}
