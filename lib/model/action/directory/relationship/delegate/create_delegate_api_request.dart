...
abstract class CreateDelegateApiRequest
    implements
        Built<CreateDelegateApiRequest, CreateDelegateApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreateDelegateApiRequest(
          [updates(CreateDelegateApiRequestBuilder b)]) =
  ...
  static Serializer<CreateDelegateApiRequest> get serializer =>
      _$createDelegateApiRequestSerializer;
}

abstract class CreateDelegateApiRequestActions extends ModelActions<
    CreateDelegateApiRequest,
    CreateDelegateApiRequestBuilder,
    CreateDelegateApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreateDelegateApiRequestActions(
          CreateDelegateApiRequestActionsOptions options) =>
      _$CreateDelegateApiRequestActions(options);
}
