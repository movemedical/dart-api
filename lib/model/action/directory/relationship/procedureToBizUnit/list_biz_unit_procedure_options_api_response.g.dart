...
class _$ListBizUnitProcedureOptionsApiResponseSerializer
  ...
  final String wireName =
      'movemedical_api/model/action/directory/relationship/procedureToBizUnit/ListBizUnitProcedureOptionsApiResponse';
  ...
  _$ListBizUnitProcedureOptionsApiResponseActions._(this.$options)
      : $replace = $options.action<ListBizUnitProcedureOptionsApiResponse>(
        ...
        data = $options.actionField<
                BuiltList<ListBizUnitProcedureOptionsApiProcedureOption>>(
...
// @override
// Serializer<ListBizUnitProcedureOptionsApiResponseListBizUnitProcedureOptionsApiResponseActions> get $serializer => ListBizUnitProcedureOptionsApiResponseListBizUnitProcedureOptionsApiResponseActions.serializer;
