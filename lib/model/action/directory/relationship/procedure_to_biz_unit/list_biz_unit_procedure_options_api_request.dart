...
abstract class ListBizUnitProcedureOptionsApiRequest
    implements
        Built<ListBizUnitProcedureOptionsApiRequest,
  ...
  factory ListBizUnitProcedureOptionsApiRequest(
          [updates(ListBizUnitProcedureOptionsApiRequestBuilder b)]) =
  ...
  static Serializer<ListBizUnitProcedureOptionsApiRequest> get serializer =>
      _$listBizUnitProcedureOptionsApiRequestSerializer;
}

abstract class ListBizUnitProcedureOptionsApiRequestActions
    extends ModelActions<
        ListBizUnitProcedureOptionsApiRequest,
        ListBizUnitProcedureOptionsApiRequestBuilder,
        ListBizUnitProcedureOptionsApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListBizUnitProcedureOptionsApiRequestActions(
          ListBizUnitProcedureOptionsApiRequestActionsOptions options) =>
      _$ListBizUnitProcedureOptionsApiRequestActions(options);
}
