...
abstract class ListProcedureBizUnitLinksApiRequest
    implements
        Built<ListProcedureBizUnitLinksApiRequest,
  ...
  factory ListProcedureBizUnitLinksApiRequest(
          [updates(ListProcedureBizUnitLinksApiRequestBuilder b)]) =
  ...
  static Serializer<ListProcedureBizUnitLinksApiRequest> get serializer =>
      _$listProcedureBizUnitLinksApiRequestSerializer;
}

abstract class ListProcedureBizUnitLinksApiRequestActions extends ModelActions<
    ListProcedureBizUnitLinksApiRequest,
    ListProcedureBizUnitLinksApiRequestBuilder,
    ListProcedureBizUnitLinksApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListProcedureBizUnitLinksApiRequestActions(
          ListProcedureBizUnitLinksApiRequestActionsOptions options) =>
      _$ListProcedureBizUnitLinksApiRequestActions(options);
}
