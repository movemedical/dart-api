...
abstract class ListProcedureBizUnitOptionsApiRequest
    implements
        Built<ListProcedureBizUnitOptionsApiRequest,
  ...
  factory ListProcedureBizUnitOptionsApiRequest(
          [updates(ListProcedureBizUnitOptionsApiRequestBuilder b)]) =
  ...
  static Serializer<ListProcedureBizUnitOptionsApiRequest> get serializer =>
      _$listProcedureBizUnitOptionsApiRequestSerializer;
}

abstract class ListProcedureBizUnitOptionsApiRequestActions
    extends ModelActions<
        ListProcedureBizUnitOptionsApiRequest,
        ListProcedureBizUnitOptionsApiRequestBuilder,
        ListProcedureBizUnitOptionsApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListProcedureBizUnitOptionsApiRequestActions(
          ListProcedureBizUnitOptionsApiRequestActionsOptions options) =>
      _$ListProcedureBizUnitOptionsApiRequestActions(options);
}
