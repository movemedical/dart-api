...
ListOrgUnitLinkOptionsForBizUnitApiOrderBy _$valueOf(String name) {
  switch (name) {
    case 'ORG_UNIT_NAME':
...
final BuiltSet<ListOrgUnitLinkOptionsForBizUnitApiOrderBy> _$values =
...
class _$ListOrgUnitLinkOptionsForBizUnitApiOrderBySerializer
  ...
  final String wireName =
      'movemedical_api/model/action/directory/relationship/biz_unit_to_org_unit/ListOrgUnitLinkOptionsForBizUnitApiOrderBy';
