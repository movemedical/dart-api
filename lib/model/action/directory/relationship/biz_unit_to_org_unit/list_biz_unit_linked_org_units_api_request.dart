...
abstract class ListBizUnitLinkedOrgUnitsApiRequest
    implements
        Built<ListBizUnitLinkedOrgUnitsApiRequest,
  ...
  factory ListBizUnitLinkedOrgUnitsApiRequest(
          [updates(ListBizUnitLinkedOrgUnitsApiRequestBuilder b)]) =
  ...
  static Serializer<ListBizUnitLinkedOrgUnitsApiRequest> get serializer =>
      _$listBizUnitLinkedOrgUnitsApiRequestSerializer;
}

abstract class ListBizUnitLinkedOrgUnitsApiRequestActions extends ModelActions<
    ListBizUnitLinkedOrgUnitsApiRequest,
    ListBizUnitLinkedOrgUnitsApiRequestBuilder,
    ListBizUnitLinkedOrgUnitsApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListBizUnitLinkedOrgUnitsApiRequestActions(
          ListBizUnitLinkedOrgUnitsApiRequestActionsOptions options) =>
      _$ListBizUnitLinkedOrgUnitsApiRequestActions(options);
}
