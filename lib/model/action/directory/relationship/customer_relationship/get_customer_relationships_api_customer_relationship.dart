...
abstract class GetCustomerRelationshipsApiCustomerRelationship
    implements
        Built<GetCustomerRelationshipsApiCustomerRelationship,
  ...
  factory GetCustomerRelationshipsApiCustomerRelationship(
          [updates(GetCustomerRelationshipsApiCustomerRelationshipBuilder b)]) =
  ...
  static Serializer<GetCustomerRelationshipsApiCustomerRelationship>
      get serializer =>
          _$getCustomerRelationshipsApiCustomerRelationshipSerializer;
}

abstract class GetCustomerRelationshipsApiCustomerRelationshipActions
    extends ModelActions<
        GetCustomerRelationshipsApiCustomerRelationship,
        GetCustomerRelationshipsApiCustomerRelationshipBuilder,
        GetCustomerRelationshipsApiCustomerRelationshipActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetCustomerRelationshipsApiCustomerRelationshipActions(
          GetCustomerRelationshipsApiCustomerRelationshipActionsOptions
              options) =>
      _$GetCustomerRelationshipsApiCustomerRelationshipActions(options);
}
