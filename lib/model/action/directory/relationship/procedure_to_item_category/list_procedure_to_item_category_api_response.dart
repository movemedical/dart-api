...
abstract class ListProcedureToItemCategoryApiResponse
    implements
        Built<ListProcedureToItemCategoryApiResponse,
  ...
  factory ListProcedureToItemCategoryApiResponse(
          [updates(ListProcedureToItemCategoryApiResponseBuilder b)]) =
  ...
  static Serializer<ListProcedureToItemCategoryApiResponse> get serializer =>
      _$listProcedureToItemCategoryApiResponseSerializer;
}

abstract class ListProcedureToItemCategoryApiResponseActions
    extends ModelActions<
        ListProcedureToItemCategoryApiResponse,
        ListProcedureToItemCategoryApiResponseBuilder,
        ListProcedureToItemCategoryApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////

  FieldDispatcher<
          BuiltList<ListProcedureToItemCategoryApiProcedureToItemCategory>>
      get data;
  ...
  factory ListProcedureToItemCategoryApiResponseActions(
          ListProcedureToItemCategoryApiResponseActionsOptions options) =>
      _$ListProcedureToItemCategoryApiResponseActions(options);
}
