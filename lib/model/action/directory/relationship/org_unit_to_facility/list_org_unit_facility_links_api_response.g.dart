...
class _$ListOrgUnitFacilityLinksApiResponseSerializer
  ...
  final String wireName =
      'movemedical_api/model/action/directory/relationship/org_unit_to_facility/ListOrgUnitFacilityLinksApiResponse';
...
class _$ListOrgUnitFacilityLinksApiResponseActions
  ...
  _$ListOrgUnitFacilityLinksApiResponseActions._(this.options$)
      : replace$ = options$.action<ListOrgUnitFacilityLinksApiResponse>(
            'replace\$', (a) => a?.replace$),
        data = options$
            .field<BuiltList<ListOrgUnitFacilityLinksApiOrgUnitFacilityLink>>(
  ...
  @override
  ListOrgUnitFacilityLinksApiResponse get initialState$ =>
      ListOrgUnitFacilityLinksApiResponse();
