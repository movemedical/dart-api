...
abstract class ListFacilityOrgUnitOptionsApiResponse
    implements
        Built<ListFacilityOrgUnitOptionsApiResponse,
  ...
  factory ListFacilityOrgUnitOptionsApiResponse(
          [updates(ListFacilityOrgUnitOptionsApiResponseBuilder b)]) =
  ...
  static Serializer<ListFacilityOrgUnitOptionsApiResponse> get serializer =>
      _$listFacilityOrgUnitOptionsApiResponseSerializer;
}

abstract class ListFacilityOrgUnitOptionsApiResponseActions
    extends ModelActions<
        ListFacilityOrgUnitOptionsApiResponse,
        ListFacilityOrgUnitOptionsApiResponseBuilder,
        ListFacilityOrgUnitOptionsApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListFacilityOrgUnitOptionsApiResponseActions(
          ListFacilityOrgUnitOptionsApiResponseActionsOptions options) =>
      _$ListFacilityOrgUnitOptionsApiResponseActions(options);
}
