...
abstract class AddOrgUnitToFacilityApiRequest
    implements
        Built<AddOrgUnitToFacilityApiRequest,
  ...
  factory AddOrgUnitToFacilityApiRequest(
          [updates(AddOrgUnitToFacilityApiRequestBuilder b)]) =
  ...
  static Serializer<AddOrgUnitToFacilityApiRequest> get serializer =>
      _$addOrgUnitToFacilityApiRequestSerializer;
}

abstract class AddOrgUnitToFacilityApiRequestActions extends ModelActions<
    AddOrgUnitToFacilityApiRequest,
    AddOrgUnitToFacilityApiRequestBuilder,
    AddOrgUnitToFacilityApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory AddOrgUnitToFacilityApiRequestActions(
          AddOrgUnitToFacilityApiRequestActionsOptions options) =>
      _$AddOrgUnitToFacilityApiRequestActions(options);
}
