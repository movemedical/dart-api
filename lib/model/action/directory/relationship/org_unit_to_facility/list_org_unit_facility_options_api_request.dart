...
abstract class ListOrgUnitFacilityOptionsApiRequest
    implements
        Built<ListOrgUnitFacilityOptionsApiRequest,
  ...
  factory ListOrgUnitFacilityOptionsApiRequest(
          [updates(ListOrgUnitFacilityOptionsApiRequestBuilder b)]) =
  ...
  static Serializer<ListOrgUnitFacilityOptionsApiRequest> get serializer =>
      _$listOrgUnitFacilityOptionsApiRequestSerializer;
}

abstract class ListOrgUnitFacilityOptionsApiRequestActions extends ModelActions<
    ListOrgUnitFacilityOptionsApiRequest,
    ListOrgUnitFacilityOptionsApiRequestBuilder,
    ListOrgUnitFacilityOptionsApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListOrgUnitFacilityOptionsApiRequestActions(
          ListOrgUnitFacilityOptionsApiRequestActionsOptions options) =>
      _$ListOrgUnitFacilityOptionsApiRequestActions(options);
}
