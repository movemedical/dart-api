...
abstract class ListOrgUnitFacilityLinksApiRequest
    implements
        Built<ListOrgUnitFacilityLinksApiRequest,
  ...
  factory ListOrgUnitFacilityLinksApiRequest(
          [updates(ListOrgUnitFacilityLinksApiRequestBuilder b)]) =
  ...
  static Serializer<ListOrgUnitFacilityLinksApiRequest> get serializer =>
      _$listOrgUnitFacilityLinksApiRequestSerializer;
}

abstract class ListOrgUnitFacilityLinksApiRequestActions extends ModelActions<
    ListOrgUnitFacilityLinksApiRequest,
    ListOrgUnitFacilityLinksApiRequestBuilder,
    ListOrgUnitFacilityLinksApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListOrgUnitFacilityLinksApiRequestActions(
          ListOrgUnitFacilityLinksApiRequestActionsOptions options) =>
      _$ListOrgUnitFacilityLinksApiRequestActions(options);
}
