...
abstract class ListPhysicianOrgUnitLinksApiRequest
    implements
        Built<ListPhysicianOrgUnitLinksApiRequest,
  ...
  factory ListPhysicianOrgUnitLinksApiRequest(
          [updates(ListPhysicianOrgUnitLinksApiRequestBuilder b)]) =
  ...
  static Serializer<ListPhysicianOrgUnitLinksApiRequest> get serializer =>
      _$listPhysicianOrgUnitLinksApiRequestSerializer;
}

abstract class ListPhysicianOrgUnitLinksApiRequestActions extends ModelActions<
    ListPhysicianOrgUnitLinksApiRequest,
    ListPhysicianOrgUnitLinksApiRequestBuilder,
    ListPhysicianOrgUnitLinksApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListPhysicianOrgUnitLinksApiRequestActions(
          ListPhysicianOrgUnitLinksApiRequestActionsOptions options) =>
      _$ListPhysicianOrgUnitLinksApiRequestActions(options);
}
