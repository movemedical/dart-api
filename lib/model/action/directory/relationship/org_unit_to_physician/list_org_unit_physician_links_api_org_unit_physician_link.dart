...
abstract class ListOrgUnitPhysicianLinksApiOrgUnitPhysicianLink
    implements
        Built<ListOrgUnitPhysicianLinksApiOrgUnitPhysicianLink,
  ...
  factory ListOrgUnitPhysicianLinksApiOrgUnitPhysicianLink(
          [updates(
  ...
  static Serializer<ListOrgUnitPhysicianLinksApiOrgUnitPhysicianLink>
      get serializer =>
          _$listOrgUnitPhysicianLinksApiOrgUnitPhysicianLinkSerializer;
}

abstract class ListOrgUnitPhysicianLinksApiOrgUnitPhysicianLinkActions
    extends ModelActions<
        ListOrgUnitPhysicianLinksApiOrgUnitPhysicianLink,
        ListOrgUnitPhysicianLinksApiOrgUnitPhysicianLinkBuilder,
        ListOrgUnitPhysicianLinksApiOrgUnitPhysicianLinkActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListOrgUnitPhysicianLinksApiOrgUnitPhysicianLinkActions(
          ListOrgUnitPhysicianLinksApiOrgUnitPhysicianLinkActionsOptions
              options) =>
      _$ListOrgUnitPhysicianLinksApiOrgUnitPhysicianLinkActions(options);
}
