...
abstract class ListOrgUnitPhysicianOptionsApiRequest
    implements
        Built<ListOrgUnitPhysicianOptionsApiRequest,
  ...
  factory ListOrgUnitPhysicianOptionsApiRequest(
          [updates(ListOrgUnitPhysicianOptionsApiRequestBuilder b)]) =
  ...
  static Serializer<ListOrgUnitPhysicianOptionsApiRequest> get serializer =>
      _$listOrgUnitPhysicianOptionsApiRequestSerializer;
}

abstract class ListOrgUnitPhysicianOptionsApiRequestActions
    extends ModelActions<
        ListOrgUnitPhysicianOptionsApiRequest,
        ListOrgUnitPhysicianOptionsApiRequestBuilder,
        ListOrgUnitPhysicianOptionsApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListOrgUnitPhysicianOptionsApiRequestActions(
          ListOrgUnitPhysicianOptionsApiRequestActionsOptions options) =>
      _$ListOrgUnitPhysicianOptionsApiRequestActions(options);
}
