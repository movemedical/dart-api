...
abstract class ListPhysicianOrgUnitOptionsApiRequest
    implements
        Built<ListPhysicianOrgUnitOptionsApiRequest,
  ...
  factory ListPhysicianOrgUnitOptionsApiRequest(
          [updates(ListPhysicianOrgUnitOptionsApiRequestBuilder b)]) =
  ...
  static Serializer<ListPhysicianOrgUnitOptionsApiRequest> get serializer =>
      _$listPhysicianOrgUnitOptionsApiRequestSerializer;
}

abstract class ListPhysicianOrgUnitOptionsApiRequestActions
    extends ModelActions<
        ListPhysicianOrgUnitOptionsApiRequest,
        ListPhysicianOrgUnitOptionsApiRequestBuilder,
        ListPhysicianOrgUnitOptionsApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListPhysicianOrgUnitOptionsApiRequestActions(
          ListPhysicianOrgUnitOptionsApiRequestActionsOptions options) =>
      _$ListPhysicianOrgUnitOptionsApiRequestActions(options);
}
