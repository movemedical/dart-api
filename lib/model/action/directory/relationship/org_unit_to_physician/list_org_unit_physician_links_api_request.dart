...
abstract class ListOrgUnitPhysicianLinksApiRequest
    implements
        Built<ListOrgUnitPhysicianLinksApiRequest,
  ...
  factory ListOrgUnitPhysicianLinksApiRequest(
          [updates(ListOrgUnitPhysicianLinksApiRequestBuilder b)]) =
  ...
  static Serializer<ListOrgUnitPhysicianLinksApiRequest> get serializer =>
      _$listOrgUnitPhysicianLinksApiRequestSerializer;
}

abstract class ListOrgUnitPhysicianLinksApiRequestActions extends ModelActions<
    ListOrgUnitPhysicianLinksApiRequest,
    ListOrgUnitPhysicianLinksApiRequestBuilder,
    ListOrgUnitPhysicianLinksApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListOrgUnitPhysicianLinksApiRequestActions(
          ListOrgUnitPhysicianLinksApiRequestActionsOptions options) =>
      _$ListOrgUnitPhysicianLinksApiRequestActions(options);
}
