...
abstract class CreateShipToAddressApiRequest implements Built<CreateShipToAddressApiRequest, CreateShipToAddressApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreateShipToAddressApiRequest([updates(CreateShipToAddressApiRequestBuilder b)]) = _$CreateShipToAddressApiRequest;
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<CreateShipToAddressApiRequest> get serializer => _$createShipToAddressApiRequestSerializer;
}

abstract class CreateShipToAddressApiRequestActions extends ModelActions<CreateShipToAddressApiRequest, CreateShipToAddressApiRequestBuilder, CreateShipToAddressApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreateShipToAddressApiRequestActions(CreateShipToAddressApiRequestActionsOptions options) => _$CreateShipToAddressApiRequestActions(options);
}
