...
class ListDeliverToAddressesApiOrderBy extends EnumClass {
  ...
  static const ListDeliverToAddressesApiOrderBy CUSTOMER_REFERENCE = _$wireCUSTOMER_REFERENCE;
  static const ListDeliverToAddressesApiOrderBy CUSTOMER_KEY = _$wireCUSTOMER_KEY;
  ...
  static BuiltSet<ListDeliverToAddressesApiOrderBy> get values => _$listDeliverToAddressesApiOrderByValues;
  
  static ListDeliverToAddressesApiOrderBy valueOf(String name) => _$listDeliverToAddressesApiOrderByValueOf(name);
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<ListDeliverToAddressesApiOrderBy> get serializer => _$listDeliverToAddressesApiOrderBySerializer;
}
