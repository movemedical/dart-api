...
abstract class ListDeliverToAddressesApiResponse
    implements
        Built<ListDeliverToAddressesApiResponse,
  ...
  factory ListDeliverToAddressesApiResponse(
          [updates(ListDeliverToAddressesApiResponseBuilder b)]) =
  ...
  static Serializer<ListDeliverToAddressesApiResponse> get serializer =>
      _$listDeliverToAddressesApiResponseSerializer;
}

abstract class ListDeliverToAddressesApiResponseActions extends ModelActions<
    ListDeliverToAddressesApiResponse,
    ListDeliverToAddressesApiResponseBuilder,
    ListDeliverToAddressesApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListDeliverToAddressesApiResponseActions(
          ListDeliverToAddressesApiResponseActionsOptions options) =>
      _$ListDeliverToAddressesApiResponseActions(options);
}
