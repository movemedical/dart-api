...
class SearchDeliverToAddressesApiOrderBy extends EnumClass {
  ...
  static const SearchDeliverToAddressesApiOrderBy POSTAL_CODE = _$wirePOSTAL_CODE;
  ...
  static BuiltSet<SearchDeliverToAddressesApiOrderBy> get values => _$searchDeliverToAddressesApiOrderByValues;
  
  static SearchDeliverToAddressesApiOrderBy valueOf(String name) => _$searchDeliverToAddressesApiOrderByValueOf(name);
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<SearchDeliverToAddressesApiOrderBy> get serializer => _$searchDeliverToAddressesApiOrderBySerializer;
}
