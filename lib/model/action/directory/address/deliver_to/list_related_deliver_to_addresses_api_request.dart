...
import 'package:movemedical_api/model/action/directory/address/deliver_to/list_related_deliver_to_addresses_api_order_by.dart';
import 'package:movemedical_api/model/order_by_params.dart';
import 'package:movemedical_api/model/pagination_params.dart';

part 'list_related_deliver_to_addresses_api_request.g.dart';

abstract class ListRelatedDeliverToAddressesApiRequest
    implements
        Built<ListRelatedDeliverToAddressesApiRequest,
  ...
  factory ListRelatedDeliverToAddressesApiRequest(
          [updates(ListRelatedDeliverToAddressesApiRequestBuilder b)]) =
  ...
  static Serializer<ListRelatedDeliverToAddressesApiRequest> get serializer =>
      _$listRelatedDeliverToAddressesApiRequestSerializer;
}

abstract class ListRelatedDeliverToAddressesApiRequestActions
    extends ModelActions<
        ListRelatedDeliverToAddressesApiRequest,
        ListRelatedDeliverToAddressesApiRequestBuilder,
        ListRelatedDeliverToAddressesApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListRelatedDeliverToAddressesApiRequestActions(
          ListRelatedDeliverToAddressesApiRequestActionsOptions options) =>
      _$ListRelatedDeliverToAddressesApiRequestActions(options);
}
