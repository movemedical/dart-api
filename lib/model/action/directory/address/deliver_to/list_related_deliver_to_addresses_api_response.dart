...
abstract class ListRelatedDeliverToAddressesApiResponse
    implements
        Built<ListRelatedDeliverToAddressesApiResponse,
  ...
  factory ListRelatedDeliverToAddressesApiResponse(
          [updates(ListRelatedDeliverToAddressesApiResponseBuilder b)]) =
  ...
  static Serializer<ListRelatedDeliverToAddressesApiResponse> get serializer =>
      _$listRelatedDeliverToAddressesApiResponseSerializer;
}

abstract class ListRelatedDeliverToAddressesApiResponseActions
    extends ModelActions<
        ListRelatedDeliverToAddressesApiResponse,
        ListRelatedDeliverToAddressesApiResponseBuilder,
        ListRelatedDeliverToAddressesApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListRelatedDeliverToAddressesApiResponseActions(
          ListRelatedDeliverToAddressesApiResponseActionsOptions options) =>
      _$ListRelatedDeliverToAddressesApiResponseActions(options);
}
