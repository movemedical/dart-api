...
abstract class SearchDeliverToAddressesApiRequest
    implements
        Built<SearchDeliverToAddressesApiRequest,
  ...
  factory SearchDeliverToAddressesApiRequest(
          [updates(SearchDeliverToAddressesApiRequestBuilder b)]) =
  ...
  static Serializer<SearchDeliverToAddressesApiRequest> get serializer =>
      _$searchDeliverToAddressesApiRequestSerializer;
}

abstract class SearchDeliverToAddressesApiRequestActions extends ModelActions<
    SearchDeliverToAddressesApiRequest,
    SearchDeliverToAddressesApiRequestBuilder,
    SearchDeliverToAddressesApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory SearchDeliverToAddressesApiRequestActions(
          SearchDeliverToAddressesApiRequestActionsOptions options) =>
      _$SearchDeliverToAddressesApiRequestActions(options);
}
