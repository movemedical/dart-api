...
ListBillToAddressesApiOrderBy _$listBillToAddressesApiOrderByValueOf(
    String name) {
  switch (name) {
    case 'LINE1':
      return _$wireLINE1;
...
final BuiltSet<ListBillToAddressesApiOrderBy>
    _$listBillToAddressesApiOrderByValues = new BuiltSet<
...
class _$ListBillToAddressesApiOrderBySerializer
  ...
  final String wireName =
      'movemedical_api/model/action/directory/address/billTo/ListBillToAddressesApiOrderBy';
