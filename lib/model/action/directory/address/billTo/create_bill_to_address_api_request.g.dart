...
part of 'create_bill_to_address_api_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<CreateBillToAddressApiRequest>
    _$createBillToAddressApiRequestSerializer =
    new _$CreateBillToAddressApiRequestSerializer();

class _$CreateBillToAddressApiRequestSerializer
    implements StructuredSerializer<CreateBillToAddressApiRequest> {
  @override
  final Iterable<Type> types = const [
    CreateBillToAddressApiRequest,
    _$CreateBillToAddressApiRequest
  ];
  @override
  final String wireName =
      'movemedical_api/model/action/directory/address/billTo/CreateBillToAddressApiRequest';

  @override
  Iterable serialize(
      Serializers serializers, CreateBillToAddressApiRequest object,
  ...
  @override
  CreateBillToAddressApiRequest deserialize(
      Serializers serializers, Iterable serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new CreateBillToAddressApiRequestBuilder();
...
class _$CreateBillToAddressApiRequest extends CreateBillToAddressApiRequest {
  @override
  ...
  factory _$CreateBillToAddressApiRequest(
          [void updates(CreateBillToAddressApiRequestBuilder b)]) =>
      (new CreateBillToAddressApiRequestBuilder()..update(updates)).build();

  _$CreateBillToAddressApiRequest._(
      {this.customerId,
      this.facilityId,
  ...
  @override
  CreateBillToAddressApiRequest rebuild(
          void updates(CreateBillToAddressApiRequestBuilder b)) =>
      (toBuilder()..update(updates)).build();

  @override
  CreateBillToAddressApiRequestBuilder toBuilder() =>
      new CreateBillToAddressApiRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is CreateBillToAddressApiRequest &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('CreateBillToAddressApiRequest')
...
class CreateBillToAddressApiRequestBuilder
    implements
        Builder<CreateBillToAddressApiRequest,
            CreateBillToAddressApiRequestBuilder> {
  _$CreateBillToAddressApiRequest _$v;
  ...
  CreateBillToAddressApiRequestBuilder get _$this {
    if (_$v != null) {
  ...
  @override
  void replace(CreateBillToAddressApiRequest other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$CreateBillToAddressApiRequest;
  }

  @override
  void update(void updates(CreateBillToAddressApiRequestBuilder b)) {
    if (updates != null) updates(this);
  }

  @override
  _$CreateBillToAddressApiRequest build() {
    final _$result = _$v ??
        new _$CreateBillToAddressApiRequest._(
...
typedef StatefulActionsOptions<
    CreateBillToAddressApiRequest,
    CreateBillToAddressApiRequestBuilder,
    CreateBillToAddressApiRequestActions> CreateBillToAddressApiRequestActionsOptions();

class _$CreateBillToAddressApiRequestActions
    extends CreateBillToAddressApiRequestActions {
  final StatefulActionsOptions<
      CreateBillToAddressApiRequest,
      CreateBillToAddressApiRequestBuilder,
      CreateBillToAddressApiRequestActions> $options;

  final ActionDispatcher<CreateBillToAddressApiRequest> $replace;
  ...
  _$CreateBillToAddressApiRequestActions._(this.$options)
      : $replace = $options.action<CreateBillToAddressApiRequest>(
            '\$replace', (a) => a?.$replace),
  ...
  factory _$CreateBillToAddressApiRequestActions(
          CreateBillToAddressApiRequestActionsOptions options) =>
      _$CreateBillToAddressApiRequestActions._(options());

  @override
  CreateBillToAddressApiRequest get $initial => CreateBillToAddressApiRequest();

  @override
  CreateBillToAddressApiRequestBuilder $newBuilder() =>
      CreateBillToAddressApiRequestBuilder();
...
// @override
// Serializer<CreateBillToAddressApiRequestCreateBillToAddressApiRequestActions> get $serializer => CreateBillToAddressApiRequestCreateBillToAddressApiRequestActions.serializer;

  FullType _$fullType;
  @override
  FullType get $fullType =>
      _$fullType ??= FullType(CreateBillToAddressApiRequest);
}
