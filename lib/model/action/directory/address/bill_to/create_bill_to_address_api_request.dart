...
abstract class CreateBillToAddressApiRequest
    implements
        Built<CreateBillToAddressApiRequest,
  ...
  factory CreateBillToAddressApiRequest(
          [updates(CreateBillToAddressApiRequestBuilder b)]) =
  ...
  static Serializer<CreateBillToAddressApiRequest> get serializer =>
      _$createBillToAddressApiRequestSerializer;
}

abstract class CreateBillToAddressApiRequestActions extends ModelActions<
    CreateBillToAddressApiRequest,
    CreateBillToAddressApiRequestBuilder,
    CreateBillToAddressApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreateBillToAddressApiRequestActions(
          CreateBillToAddressApiRequestActionsOptions options) =>
      _$CreateBillToAddressApiRequestActions(options);
}
