...
abstract class ListContactsForSearchApiRequest
    implements
        Built<ListContactsForSearchApiRequest,
  ...
  factory ListContactsForSearchApiRequest(
          [updates(ListContactsForSearchApiRequestBuilder b)]) =
  ...
  static Serializer<ListContactsForSearchApiRequest> get serializer =>
      _$listContactsForSearchApiRequestSerializer;
}

abstract class ListContactsForSearchApiRequestActions extends ModelActions<
    ListContactsForSearchApiRequest,
    ListContactsForSearchApiRequestBuilder,
    ListContactsForSearchApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListContactsForSearchApiRequestActions(
          ListContactsForSearchApiRequestActionsOptions options) =>
      _$ListContactsForSearchApiRequestActions(options);
}
