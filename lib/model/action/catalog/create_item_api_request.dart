...
abstract class CreateItemApiRequest implements Built<CreateItemApiRequest, CreateItemApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreateItemApiRequest([updates(CreateItemApiRequestBuilder b)]) = _$CreateItemApiRequest;
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<CreateItemApiRequest> get serializer => _$createItemApiRequestSerializer;
}

abstract class CreateItemApiRequestActions extends ModelActions<CreateItemApiRequest, CreateItemApiRequestBuilder, CreateItemApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreateItemApiRequestActions(CreateItemApiRequestActionsOptions options) => _$CreateItemApiRequestActions(options);
}
