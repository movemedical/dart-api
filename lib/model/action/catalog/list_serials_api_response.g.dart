...
class _$ListSerialsApiResponseActions extends ListSerialsApiResponseActions {
  ...
  _$ListSerialsApiResponseActions._(this.$options)
      : $replace = $options.action<ListSerialsApiResponse>(
            '\$replace', (a) => a?.$replace),
        data = $options.actionField<BuiltList<Serial>>(
...
// @override
// Serializer<ListSerialsApiResponseListSerialsApiResponseActions> get $serializer => ListSerialsApiResponseListSerialsApiResponseActions.serializer;
