...
class ListItemsApiOrderBy extends EnumClass {
  ...
  static BuiltSet<ListItemsApiOrderBy> get values => _$listItemsApiOrderByValues;
  
  static ListItemsApiOrderBy valueOf(String name) => _$listItemsApiOrderByValueOf(name);
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<ListItemsApiOrderBy> get serializer => _$listItemsApiOrderBySerializer;
}
