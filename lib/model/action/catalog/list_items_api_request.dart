...
abstract class ListItemsApiRequest
    implements Built<ListItemsApiRequest, ListItemsApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListItemsApiRequest([updates(ListItemsApiRequestBuilder b)]) =
  ...
  static Serializer<ListItemsApiRequest> get serializer =>
      _$listItemsApiRequestSerializer;
}

abstract class ListItemsApiRequestActions extends ModelActions<
    ListItemsApiRequest,
    ListItemsApiRequestBuilder,
    ListItemsApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListItemsApiRequestActions(
          ListItemsApiRequestActionsOptions options) =>
      _$ListItemsApiRequestActions(options);
}
