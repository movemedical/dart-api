...
abstract class ListItemCategoriesLinkedToItemApiResponse
    implements
        Built<ListItemCategoriesLinkedToItemApiResponse,
  ...
  factory ListItemCategoriesLinkedToItemApiResponse(
          [updates(ListItemCategoriesLinkedToItemApiResponseBuilder b)]) =
  ...
  static Serializer<ListItemCategoriesLinkedToItemApiResponse> get serializer =>
      _$listItemCategoriesLinkedToItemApiResponseSerializer;
}

abstract class ListItemCategoriesLinkedToItemApiResponseActions
    extends ModelActions<
        ListItemCategoriesLinkedToItemApiResponse,
        ListItemCategoriesLinkedToItemApiResponseBuilder,
        ListItemCategoriesLinkedToItemApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListItemCategoriesLinkedToItemApiResponseActions(
          ListItemCategoriesLinkedToItemApiResponseActionsOptions options) =>
      _$ListItemCategoriesLinkedToItemApiResponseActions(options);
}
