...
abstract class SearchLotsSerialsApiResponse
    implements
        Built<SearchLotsSerialsApiResponse,
  ...
  factory SearchLotsSerialsApiResponse(
          [updates(SearchLotsSerialsApiResponseBuilder b)]) =
  ...
  static Serializer<SearchLotsSerialsApiResponse> get serializer =>
      _$searchLotsSerialsApiResponseSerializer;
}

abstract class SearchLotsSerialsApiResponseActions extends ModelActions<
    SearchLotsSerialsApiResponse,
    SearchLotsSerialsApiResponseBuilder,
    SearchLotsSerialsApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory SearchLotsSerialsApiResponseActions(
          SearchLotsSerialsApiResponseActionsOptions options) =>
      _$SearchLotsSerialsApiResponseActions(options);
}
