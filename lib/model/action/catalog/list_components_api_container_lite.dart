...
abstract class ListComponentsApiContainerLite
    implements
        Built<ListComponentsApiContainerLite,
  ...
  factory ListComponentsApiContainerLite(
          [updates(ListComponentsApiContainerLiteBuilder b)]) =
  ...
  static Serializer<ListComponentsApiContainerLite> get serializer =>
      _$listComponentsApiContainerLiteSerializer;
}

abstract class ListComponentsApiContainerLiteActions extends ModelActions<
    ListComponentsApiContainerLite,
    ListComponentsApiContainerLiteBuilder,
    ListComponentsApiContainerLiteActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListComponentsApiContainerLiteActions(
          ListComponentsApiContainerLiteActionsOptions options) =>
      _$ListComponentsApiContainerLiteActions(options);
}
