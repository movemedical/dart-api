...
abstract class SaveComponentsApiItemSpecIds
    implements
        Built<SaveComponentsApiItemSpecIds,
  ...
  factory SaveComponentsApiItemSpecIds(
          [updates(SaveComponentsApiItemSpecIdsBuilder b)]) =
  ...
  static Serializer<SaveComponentsApiItemSpecIds> get serializer =>
      _$saveComponentsApiItemSpecIdsSerializer;
}

abstract class SaveComponentsApiItemSpecIdsActions extends ModelActions<
  ...
  factory SaveComponentsApiItemSpecIdsActions(
          SaveComponentsApiItemSpecIdsActionsOptions options) =>
      _$SaveComponentsApiItemSpecIdsActions(options);
}
