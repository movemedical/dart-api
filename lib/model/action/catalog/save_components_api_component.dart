...
abstract class SaveComponentsApiComponent
    implements
        Built<SaveComponentsApiComponent, SaveComponentsApiComponentBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory SaveComponentsApiComponent(
          [updates(SaveComponentsApiComponentBuilder b)]) =
  ...
  static Serializer<SaveComponentsApiComponent> get serializer =>
      _$saveComponentsApiComponentSerializer;
}

abstract class SaveComponentsApiComponentActions extends ModelActions<
    SaveComponentsApiComponent,
    SaveComponentsApiComponentBuilder,
    SaveComponentsApiComponentActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory SaveComponentsApiComponentActions(
          SaveComponentsApiComponentActionsOptions options) =>
      _$SaveComponentsApiComponentActions(options);
}
