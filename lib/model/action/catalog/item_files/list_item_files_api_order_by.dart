...
class ListItemFilesApiOrderBy extends EnumClass {
  ...
  static BuiltSet<ListItemFilesApiOrderBy> get values => _$listItemFilesApiOrderByValues;
  
  static ListItemFilesApiOrderBy valueOf(String name) => _$listItemFilesApiOrderByValueOf(name);
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<ListItemFilesApiOrderBy> get serializer => _$listItemFilesApiOrderBySerializer;
}
