...
abstract class ListNotificationsApiResponse
    implements
        Built<ListNotificationsApiResponse,
            ListNotificationsApiResponseBuilder>,
        PaginatedListResponse<ListNotificationsApiNotification> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListNotificationsApiResponse(
          [updates(ListNotificationsApiResponseBuilder b)]) =
  ...
  static Serializer<ListNotificationsApiResponse> get serializer =>
      _$listNotificationsApiResponseSerializer;
}

abstract class ListNotificationsApiResponseActions extends ModelActions<
    ListNotificationsApiResponse,
    ListNotificationsApiResponseBuilder,
    ListNotificationsApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListNotificationsApiResponseActions(
          ListNotificationsApiResponseActionsOptions options) =>
      _$ListNotificationsApiResponseActions(options);
}
