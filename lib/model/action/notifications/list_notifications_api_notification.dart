...
abstract class ListNotificationsApiNotification
    implements
        Built<ListNotificationsApiNotification,
  ...
  factory ListNotificationsApiNotification(
          [updates(ListNotificationsApiNotificationBuilder b)]) =
  ...
  static Serializer<ListNotificationsApiNotification> get serializer =>
      _$listNotificationsApiNotificationSerializer;
}

abstract class ListNotificationsApiNotificationActions extends ModelActions<
    ListNotificationsApiNotification,
    ListNotificationsApiNotificationBuilder,
    ListNotificationsApiNotificationActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListNotificationsApiNotificationActions(
          ListNotificationsApiNotificationActionsOptions options) =>
      _$ListNotificationsApiNotificationActions(options);
}
