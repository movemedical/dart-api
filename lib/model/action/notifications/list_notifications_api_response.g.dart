...
class _$ListNotificationsApiResponseActions
  ...
  _$ListNotificationsApiResponseActions._(this.$options)
      : $replace = $options.action<ListNotificationsApiResponse>(
            '\$replace', (a) => a?.$replace),
        data =
            $options.actionField<BuiltList<ListNotificationsApiNotification>>(
  ...
  @override
  ListNotificationsApiResponse get $initial => ListNotificationsApiResponse();
...
// @override
// Serializer<ListNotificationsApiResponseListNotificationsApiResponseActions> get $serializer => ListNotificationsApiResponseListNotificationsApiResponseActions.serializer;

  FullType _$fullType;
  @override
  FullType get $fullType =>
      _$fullType ??= FullType(ListNotificationsApiResponse);
}
