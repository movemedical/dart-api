...
abstract class ListOrderLineCancelReasonsApiResponse
    implements
        Built<ListOrderLineCancelReasonsApiResponse,
  ...
  factory ListOrderLineCancelReasonsApiResponse(
          [updates(ListOrderLineCancelReasonsApiResponseBuilder b)]) =
  ...
  static Serializer<ListOrderLineCancelReasonsApiResponse> get serializer =>
      _$listOrderLineCancelReasonsApiResponseSerializer;
}

abstract class ListOrderLineCancelReasonsApiResponseActions
    extends ModelActions<
        ListOrderLineCancelReasonsApiResponse,
        ListOrderLineCancelReasonsApiResponseBuilder,
        ListOrderLineCancelReasonsApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////

  FieldDispatcher<BuiltList<ListOrderLineCancelReasonsApiOrderLineCancelReason>>
      get data;
  ...
  factory ListOrderLineCancelReasonsApiResponseActions(
          ListOrderLineCancelReasonsApiResponseActionsOptions options) =>
      _$ListOrderLineCancelReasonsApiResponseActions(options);
}
