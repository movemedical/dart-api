...
abstract class ListMobileVersionBlacklistApiBlacklistedVersion
    implements
        Built<ListMobileVersionBlacklistApiBlacklistedVersion,
  ...
  factory ListMobileVersionBlacklistApiBlacklistedVersion(
          [updates(ListMobileVersionBlacklistApiBlacklistedVersionBuilder b)]) =
  ...
  static Serializer<ListMobileVersionBlacklistApiBlacklistedVersion>
      get serializer =>
          _$listMobileVersionBlacklistApiBlacklistedVersionSerializer;
}

abstract class ListMobileVersionBlacklistApiBlacklistedVersionActions
    extends ModelActions<
        ListMobileVersionBlacklistApiBlacklistedVersion,
        ListMobileVersionBlacklistApiBlacklistedVersionBuilder,
        ListMobileVersionBlacklistApiBlacklistedVersionActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListMobileVersionBlacklistApiBlacklistedVersionActions(
          ListMobileVersionBlacklistApiBlacklistedVersionActionsOptions
              options) =>
      _$ListMobileVersionBlacklistApiBlacklistedVersionActions(options);
}
