...
abstract class GetDeliveryScheduleProfileApiResponse
    implements
        Built<GetDeliveryScheduleProfileApiResponse,
  ...
  factory GetDeliveryScheduleProfileApiResponse(
          [updates(GetDeliveryScheduleProfileApiResponseBuilder b)]) =
  ...
  static Serializer<GetDeliveryScheduleProfileApiResponse> get serializer =>
      _$getDeliveryScheduleProfileApiResponseSerializer;
}

abstract class GetDeliveryScheduleProfileApiResponseActions
    extends ModelActions<
        GetDeliveryScheduleProfileApiResponse,
        GetDeliveryScheduleProfileApiResponseBuilder,
        GetDeliveryScheduleProfileApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetDeliveryScheduleProfileApiResponseActions(
          GetDeliveryScheduleProfileApiResponseActionsOptions options) =>
      _$GetDeliveryScheduleProfileApiResponseActions(options);
}
