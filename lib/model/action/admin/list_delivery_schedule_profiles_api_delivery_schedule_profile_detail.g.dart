...
part of 'list_delivery_schedule_profiles_api_delivery_schedule_profile_detail.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetail>
    _$listDeliveryScheduleProfilesApiDeliveryScheduleProfileDetailSerializer =
    new _$ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetailSerializer();

class _$ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetailSerializer
    implements
  ...
  final String wireName =
      'movemedical_api/model/action/admin/ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetail';

  @override
  Iterable serialize(Serializers serializers,
      ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetail object,
  ...
  @override
  ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetail deserialize(
      Serializers serializers, Iterable serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result =
        new ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetailBuilder();
...
class _$ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetail
    extends ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetail {
  @override
  final String id;
  @override
  final String name;
  ...
  factory _$ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetail(
          [void updates(
  ...
  _$ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetail._(
      {this.id,
      this.name,
      this.orgId,
      this.orgName,
  ...
  @override
  ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetail rebuild(
          void updates(
              ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetailBuilder
                  b)) =>
  ...
  bool operator ==(Object other) {
    ...
    return other
            is ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetail &&
        id == other.id &&
        name == other.name &&
        orgId == other.orgId &&
...
class ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetailBuilder
    implements
        Builder<ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetail,
            ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetailBuilder> {
  _$ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetail _$v;
  ...
  @override
  void replace(
      ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetail other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v =
        other as _$ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetail;
  }
  ...
  @override
  _$ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetail build() {
    final _$result = _$v ??
        new _$ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetail._(
            id: id,
            name: name,
            orgId: orgId,
            orgName: orgName,
...
typedef StatefulActionsOptions<
    ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetail,
    ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetailBuilder,
    ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetailActions> ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetailActionsOptions();

class _$ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetailActions
    extends ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetailActions {
  ...
  final ActionDispatcher<
      ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetail> $replace;
  ...
  _$ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetailActions._(
      this.$options)
  ...
  factory _$ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetailActions(
  ...
  @override
  ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetail get $initial =>
      ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetail();
...
// Serializer<ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetailListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetailActions> get $serializer => ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetailListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetailActions.serializer;
  ...
  FullType get $fullType => _$fullType ??=
      FullType(ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetail);
}
