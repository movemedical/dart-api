...
abstract class ListDeliveryScheduleProfilesApiRequest
    implements
        Built<ListDeliveryScheduleProfilesApiRequest,
  ...
  factory ListDeliveryScheduleProfilesApiRequest(
          [updates(ListDeliveryScheduleProfilesApiRequestBuilder b)]) =
  ...
  static Serializer<ListDeliveryScheduleProfilesApiRequest> get serializer =>
      _$listDeliveryScheduleProfilesApiRequestSerializer;
}

abstract class ListDeliveryScheduleProfilesApiRequestActions
    extends ModelActions<
        ListDeliveryScheduleProfilesApiRequest,
        ListDeliveryScheduleProfilesApiRequestBuilder,
        ListDeliveryScheduleProfilesApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListDeliveryScheduleProfilesApiRequestActions(
          ListDeliveryScheduleProfilesApiRequestActionsOptions options) =>
      _$ListDeliveryScheduleProfilesApiRequestActions(options);
}
