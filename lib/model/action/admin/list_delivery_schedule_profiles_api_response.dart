...
abstract class ListDeliveryScheduleProfilesApiResponse
    implements
        Built<ListDeliveryScheduleProfilesApiResponse,
  ...
  @nullable
  BuiltList<ListDeliveryScheduleProfilesApiDeliveryScheduleProfileDetail>
      get data;
  ...
  factory ListDeliveryScheduleProfilesApiResponse(
          [updates(ListDeliveryScheduleProfilesApiResponseBuilder b)]) =
  ...
  static Serializer<ListDeliveryScheduleProfilesApiResponse> get serializer =>
      _$listDeliveryScheduleProfilesApiResponseSerializer;
}

abstract class ListDeliveryScheduleProfilesApiResponseActions
    extends ModelActions<
        ListDeliveryScheduleProfilesApiResponse,
        ListDeliveryScheduleProfilesApiResponseBuilder,
        ListDeliveryScheduleProfilesApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListDeliveryScheduleProfilesApiResponseActions(
          ListDeliveryScheduleProfilesApiResponseActionsOptions options) =>
      _$ListDeliveryScheduleProfilesApiResponseActions(options);
}
