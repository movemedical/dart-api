...
abstract class ListNotesApiNoteRecord
    implements Built<ListNotesApiNoteRecord, ListNotesApiNoteRecordBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListNotesApiNoteRecord([updates(ListNotesApiNoteRecordBuilder b)]) =
  ...
  static Serializer<ListNotesApiNoteRecord> get serializer =>
      _$listNotesApiNoteRecordSerializer;
}

abstract class ListNotesApiNoteRecordActions extends ModelActions<
    ListNotesApiNoteRecord,
    ListNotesApiNoteRecordBuilder,
    ListNotesApiNoteRecordActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListNotesApiNoteRecordActions(
          ListNotesApiNoteRecordActionsOptions options) =>
      _$ListNotesApiNoteRecordActions(options);
}
