...
abstract class CreateNoteApiRequest
    implements Built<CreateNoteApiRequest, CreateNoteApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreateNoteApiRequest([updates(CreateNoteApiRequestBuilder b)]) =
  ...
  static Serializer<CreateNoteApiRequest> get serializer =>
      _$createNoteApiRequestSerializer;
}

abstract class CreateNoteApiRequestActions extends ModelActions<
    CreateNoteApiRequest,
    CreateNoteApiRequestBuilder,
    CreateNoteApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreateNoteApiRequestActions(
          CreateNoteApiRequestActionsOptions options) =>
      _$CreateNoteApiRequestActions(options);
}
