...
abstract class UpdatePreferenceCardProductGroupsApiProductGroupUpdate
    implements
        Built<UpdatePreferenceCardProductGroupsApiProductGroupUpdate,
  ...
  factory UpdatePreferenceCardProductGroupsApiProductGroupUpdate(
      [updates(
          UpdatePreferenceCardProductGroupsApiProductGroupUpdateBuilder
              b)]) = _$UpdatePreferenceCardProductGroupsApiProductGroupUpdate;

  ////////////////////////////////
  /// Serializer
  ////////////////////////////////

  static Serializer<UpdatePreferenceCardProductGroupsApiProductGroupUpdate>
      get serializer =>
          _$updatePreferenceCardProductGroupsApiProductGroupUpdateSerializer;
}

abstract class UpdatePreferenceCardProductGroupsApiProductGroupUpdateActions
    extends ModelActions<
        UpdatePreferenceCardProductGroupsApiProductGroupUpdate,
        UpdatePreferenceCardProductGroupsApiProductGroupUpdateBuilder,
        UpdatePreferenceCardProductGroupsApiProductGroupUpdateActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory UpdatePreferenceCardProductGroupsApiProductGroupUpdateActions(
          UpdatePreferenceCardProductGroupsApiProductGroupUpdateActionsOptions
              options) =>
      _$UpdatePreferenceCardProductGroupsApiProductGroupUpdateActions(options);
}
