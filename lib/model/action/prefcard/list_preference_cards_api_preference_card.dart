...
abstract class ListPreferenceCardsApiPreferenceCard
    implements
        Built<ListPreferenceCardsApiPreferenceCard,
  ...
  factory ListPreferenceCardsApiPreferenceCard(
          [updates(ListPreferenceCardsApiPreferenceCardBuilder b)]) =
  ...
  static Serializer<ListPreferenceCardsApiPreferenceCard> get serializer =>
      _$listPreferenceCardsApiPreferenceCardSerializer;
}

abstract class ListPreferenceCardsApiPreferenceCardActions extends ModelActions<
    ListPreferenceCardsApiPreferenceCard,
    ListPreferenceCardsApiPreferenceCardBuilder,
    ListPreferenceCardsApiPreferenceCardActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListPreferenceCardsApiPreferenceCardActions(
          ListPreferenceCardsApiPreferenceCardActionsOptions options) =>
      _$ListPreferenceCardsApiPreferenceCardActions(options);
}
