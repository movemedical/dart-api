...
abstract class UpdatePreferenceCardItemsApiRequest
    implements
        Built<UpdatePreferenceCardItemsApiRequest,
  ...
  factory UpdatePreferenceCardItemsApiRequest(
          [updates(UpdatePreferenceCardItemsApiRequestBuilder b)]) =
  ...
  static Serializer<UpdatePreferenceCardItemsApiRequest> get serializer =>
      _$updatePreferenceCardItemsApiRequestSerializer;
}

abstract class UpdatePreferenceCardItemsApiRequestActions extends ModelActions<
    UpdatePreferenceCardItemsApiRequest,
    UpdatePreferenceCardItemsApiRequestBuilder,
    UpdatePreferenceCardItemsApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  FieldDispatcher<BuiltList<UpdatePreferenceCardItemsApiItemAdd>>
      get itemsToAdd;

  FieldDispatcher<BuiltList<UpdatePreferenceCardItemsApiItemUpdate>>
      get itemsToUpdate;
  ...
  factory UpdatePreferenceCardItemsApiRequestActions(
          UpdatePreferenceCardItemsApiRequestActionsOptions options) =>
      _$UpdatePreferenceCardItemsApiRequestActions(options);
}
