...
abstract class UpdatePreferenceCardProductGroupsApiProductGroupAdd
    implements
        Built<UpdatePreferenceCardProductGroupsApiProductGroupAdd,
  ...
  factory UpdatePreferenceCardProductGroupsApiProductGroupAdd(
          [updates(
  ...
  static Serializer<UpdatePreferenceCardProductGroupsApiProductGroupAdd>
      get serializer =>
          _$updatePreferenceCardProductGroupsApiProductGroupAddSerializer;
}

abstract class UpdatePreferenceCardProductGroupsApiProductGroupAddActions
    extends ModelActions<
        UpdatePreferenceCardProductGroupsApiProductGroupAdd,
        UpdatePreferenceCardProductGroupsApiProductGroupAddBuilder,
        UpdatePreferenceCardProductGroupsApiProductGroupAddActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory UpdatePreferenceCardProductGroupsApiProductGroupAddActions(
          UpdatePreferenceCardProductGroupsApiProductGroupAddActionsOptions
              options) =>
      _$UpdatePreferenceCardProductGroupsApiProductGroupAddActions(options);
}
