...
abstract class PreviewApplyPreferenceCardsToCaseApiResponse
    implements
        Built<PreviewApplyPreferenceCardsToCaseApiResponse,
  ...
  factory PreviewApplyPreferenceCardsToCaseApiResponse(
          [updates(PreviewApplyPreferenceCardsToCaseApiResponseBuilder b)]) =
  ...
  static Serializer<PreviewApplyPreferenceCardsToCaseApiResponse>
      get serializer =>
          _$previewApplyPreferenceCardsToCaseApiResponseSerializer;
}

abstract class PreviewApplyPreferenceCardsToCaseApiResponseActions
    extends ModelActions<
        PreviewApplyPreferenceCardsToCaseApiResponse,
        PreviewApplyPreferenceCardsToCaseApiResponseBuilder,
        PreviewApplyPreferenceCardsToCaseApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////

  FieldDispatcher<BuiltList<PreviewApplyPreferenceCardsToCaseApiPreview>>
      get preview;
  ...
  factory PreviewApplyPreferenceCardsToCaseApiResponseActions(
          PreviewApplyPreferenceCardsToCaseApiResponseActionsOptions options) =>
      _$PreviewApplyPreferenceCardsToCaseApiResponseActions(options);
}
