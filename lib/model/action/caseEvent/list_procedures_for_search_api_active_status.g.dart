...
ListProceduresForSearchApiActiveStatus
    _$listProceduresForSearchApiActiveStatusValueOf(String name) {
  switch (name) {
    case 'ACTIVE':
      return _$wireACTIVE;
    case 'INACTIVE':
...
final BuiltSet<ListProceduresForSearchApiActiveStatus>
...
class _$ListProceduresForSearchApiActiveStatusSerializer
  ...
  final String wireName =
      'movemedical_api/model/action/caseEvent/ListProceduresForSearchApiActiveStatus';
