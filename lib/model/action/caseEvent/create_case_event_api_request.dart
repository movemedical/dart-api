...
import 'package:movemedical_api/model/action/caseEvent/create_case_event_api_insurance.dart';
import 'package:movemedical_api/model/sql/enums/case_event_status.dart';

part 'create_case_event_api_request.g.dart';

abstract class CreateCaseEventApiRequest implements Built<CreateCaseEventApiRequest, CreateCaseEventApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreateCaseEventApiRequest([updates(CreateCaseEventApiRequestBuilder b)]) = _$CreateCaseEventApiRequest;
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<CreateCaseEventApiRequest> get serializer => _$createCaseEventApiRequestSerializer;
}

abstract class CreateCaseEventApiRequestActions extends ModelActions<CreateCaseEventApiRequest, CreateCaseEventApiRequestBuilder, CreateCaseEventApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CreateCaseEventApiRequestActions(CreateCaseEventApiRequestActionsOptions options) => _$CreateCaseEventApiRequestActions(options);
}
