...
class ListProceduresForSearchApiActiveStatus extends EnumClass {
  ...
  static BuiltSet<ListProceduresForSearchApiActiveStatus> get values => _$listProceduresForSearchApiActiveStatusValues;
  
  static ListProceduresForSearchApiActiveStatus valueOf(String name) => _$listProceduresForSearchApiActiveStatusValueOf(name);
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<ListProceduresForSearchApiActiveStatus> get serializer => _$listProceduresForSearchApiActiveStatusSerializer;
}
