...
class ListCaseEventsApiOrderBy extends EnumClass {
  ...
  static const ListCaseEventsApiOrderBy PROCEDURE_SUB_PROCEDURE = _$wirePROCEDURE_SUB_PROCEDURE;
  ...
  static BuiltSet<ListCaseEventsApiOrderBy> get values => _$listCaseEventsApiOrderByValues;
  
  static ListCaseEventsApiOrderBy valueOf(String name) => _$listCaseEventsApiOrderByValueOf(name);
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<ListCaseEventsApiOrderBy> get serializer => _$listCaseEventsApiOrderBySerializer;
}
