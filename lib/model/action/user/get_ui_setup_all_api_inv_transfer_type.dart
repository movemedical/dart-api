...
abstract class GetUiSetupAllApiInvTransferType implements Built<GetUiSetupAllApiInvTransferType, GetUiSetupAllApiInvTransferTypeBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetUiSetupAllApiInvTransferType([updates(GetUiSetupAllApiInvTransferTypeBuilder b)]) = _$GetUiSetupAllApiInvTransferType;
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<GetUiSetupAllApiInvTransferType> get serializer => _$getUiSetupAllApiInvTransferTypeSerializer;
}

abstract class GetUiSetupAllApiInvTransferTypeActions extends ModelActions<GetUiSetupAllApiInvTransferType, GetUiSetupAllApiInvTransferTypeBuilder, GetUiSetupAllApiInvTransferTypeActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetUiSetupAllApiInvTransferTypeActions(GetUiSetupAllApiInvTransferTypeActionsOptions options) => _$GetUiSetupAllApiInvTransferTypeActions(options);
}
