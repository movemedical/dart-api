...
abstract class ListUsersApiUser implements Built<ListUsersApiUser, ListUsersApiUserBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListUsersApiUser([updates(ListUsersApiUserBuilder b)]) = _$ListUsersApiUser;
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<ListUsersApiUser> get serializer => _$listUsersApiUserSerializer;
}

abstract class ListUsersApiUserActions extends ModelActions<ListUsersApiUser, ListUsersApiUserBuilder, ListUsersApiUserActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListUsersApiUserActions(ListUsersApiUserActionsOptions options) => _$ListUsersApiUserActions(options);
}
