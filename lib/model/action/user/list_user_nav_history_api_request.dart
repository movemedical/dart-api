...
abstract class ListUserNavHistoryApiRequest
    implements
        Built<ListUserNavHistoryApiRequest,
  ...
  factory ListUserNavHistoryApiRequest(
          [updates(ListUserNavHistoryApiRequestBuilder b)]) =
  ...
  static Serializer<ListUserNavHistoryApiRequest> get serializer =>
      _$listUserNavHistoryApiRequestSerializer;
}

abstract class ListUserNavHistoryApiRequestActions extends ModelActions<
    ListUserNavHistoryApiRequest,
    ListUserNavHistoryApiRequestBuilder,
    ListUserNavHistoryApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListUserNavHistoryApiRequestActions(
          ListUserNavHistoryApiRequestActionsOptions options) =>
      _$ListUserNavHistoryApiRequestActions(options);
}
