...
abstract class GetUiSetupAllApiUserPermissions
    implements
        Built<GetUiSetupAllApiUserPermissions,
  ...
  factory GetUiSetupAllApiUserPermissions(
          [updates(GetUiSetupAllApiUserPermissionsBuilder b)]) =
  ...
  static Serializer<GetUiSetupAllApiUserPermissions> get serializer =>
      _$getUiSetupAllApiUserPermissionsSerializer;
}

abstract class GetUiSetupAllApiUserPermissionsActions extends ModelActions<
  ...
  factory GetUiSetupAllApiUserPermissionsActions(
          GetUiSetupAllApiUserPermissionsActionsOptions options) =>
      _$GetUiSetupAllApiUserPermissionsActions(options);
}
