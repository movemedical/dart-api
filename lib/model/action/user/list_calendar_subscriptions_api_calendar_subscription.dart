...
abstract class ListCalendarSubscriptionsApiCalendarSubscription
    implements
        Built<ListCalendarSubscriptionsApiCalendarSubscription,
  ...
  factory ListCalendarSubscriptionsApiCalendarSubscription(
          [updates(
  ...
  static Serializer<ListCalendarSubscriptionsApiCalendarSubscription>
      get serializer =>
          _$listCalendarSubscriptionsApiCalendarSubscriptionSerializer;
}

abstract class ListCalendarSubscriptionsApiCalendarSubscriptionActions
    extends ModelActions<
        ListCalendarSubscriptionsApiCalendarSubscription,
        ListCalendarSubscriptionsApiCalendarSubscriptionBuilder,
        ListCalendarSubscriptionsApiCalendarSubscriptionActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ListCalendarSubscriptionsApiCalendarSubscriptionActions(
          ListCalendarSubscriptionsApiCalendarSubscriptionActionsOptions
              options) =>
      _$ListCalendarSubscriptionsApiCalendarSubscriptionActions(options);
}
