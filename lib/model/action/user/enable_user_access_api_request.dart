...
abstract class EnableUserAccessApiRequest
    implements
        Built<EnableUserAccessApiRequest, EnableUserAccessApiRequestBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory EnableUserAccessApiRequest(
          [updates(EnableUserAccessApiRequestBuilder b)]) =
  ...
  static Serializer<EnableUserAccessApiRequest> get serializer =>
      _$enableUserAccessApiRequestSerializer;
}

abstract class EnableUserAccessApiRequestActions extends ModelActions<
    EnableUserAccessApiRequest,
    EnableUserAccessApiRequestBuilder,
    EnableUserAccessApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory EnableUserAccessApiRequestActions(
          EnableUserAccessApiRequestActionsOptions options) =>
      _$EnableUserAccessApiRequestActions(options);
}
