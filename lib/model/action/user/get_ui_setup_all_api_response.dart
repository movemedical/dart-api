...
abstract class GetUiSetupAllApiResponse
    implements
        Built<GetUiSetupAllApiResponse, GetUiSetupAllApiResponseBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetUiSetupAllApiResponse(
          [updates(GetUiSetupAllApiResponseBuilder b)]) =
  ...
  static Serializer<GetUiSetupAllApiResponse> get serializer =>
      _$getUiSetupAllApiResponseSerializer;
}

abstract class GetUiSetupAllApiResponseActions extends ModelActions<
  ...
  factory GetUiSetupAllApiResponseActions(
          GetUiSetupAllApiResponseActionsOptions options) =>
      _$GetUiSetupAllApiResponseActions(options);
}
