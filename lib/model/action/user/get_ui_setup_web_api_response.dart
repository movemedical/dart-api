...
abstract class GetUiSetupWebApiResponse
    implements
        Built<GetUiSetupWebApiResponse, GetUiSetupWebApiResponseBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory GetUiSetupWebApiResponse(
          [updates(GetUiSetupWebApiResponseBuilder b)]) =
  ...
  static Serializer<GetUiSetupWebApiResponse> get serializer =>
      _$getUiSetupWebApiResponseSerializer;
}

abstract class GetUiSetupWebApiResponseActions extends ModelActions<
    GetUiSetupWebApiResponse,
    GetUiSetupWebApiResponseBuilder,
    GetUiSetupWebApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  FieldDispatcher<BuiltList<GetUiSetupWebApiDashboardWidget>>
  ...
  factory GetUiSetupWebApiResponseActions(
          GetUiSetupWebApiResponseActionsOptions options) =>
      _$GetUiSetupWebApiResponseActions(options);
}
