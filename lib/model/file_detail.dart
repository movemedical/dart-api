...
abstract class FileDetailActions
    extends ModelActions<FileDetail, FileDetailBuilder, FileDetailActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory FileDetailActions(FileDetailActionsOptions options) =>
      _$FileDetailActions(options);
}
