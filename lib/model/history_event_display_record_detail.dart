...
abstract class HistoryEventDisplayRecordDetail
    implements
        Built<HistoryEventDisplayRecordDetail,
  ...
  factory HistoryEventDisplayRecordDetail(
          [updates(HistoryEventDisplayRecordDetailBuilder b)]) =
  ...
  static Serializer<HistoryEventDisplayRecordDetail> get serializer =>
      _$historyEventDisplayRecordDetailSerializer;
}

abstract class HistoryEventDisplayRecordDetailActions extends ModelActions<
    HistoryEventDisplayRecordDetail,
    HistoryEventDisplayRecordDetailBuilder,
    HistoryEventDisplayRecordDetailActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory HistoryEventDisplayRecordDetailActions(
          HistoryEventDisplayRecordDetailActionsOptions options) =>
      _$HistoryEventDisplayRecordDetailActions(options);
}
