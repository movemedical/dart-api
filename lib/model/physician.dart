...
abstract class PhysicianActions extends ModelActions<Physician, PhysicianBuilder, PhysicianActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory PhysicianActions(PhysicianActionsOptions options) => _$PhysicianActions(options);
}
