...
abstract class CustomAction implements Built<CustomAction, CustomActionBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
...
abstract class CustomActionActions extends ModelActions<CustomAction, CustomActionBuilder, CustomActionActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CustomActionActions(CustomActionActionsOptions options) => _$CustomActionActions(options);
}
