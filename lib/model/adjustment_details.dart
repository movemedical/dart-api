...
abstract class AdjustmentDetails implements Built<AdjustmentDetails, AdjustmentDetailsBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory AdjustmentDetails([updates(AdjustmentDetailsBuilder b)]) = _$AdjustmentDetails;
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<AdjustmentDetails> get serializer => _$adjustmentDetailsSerializer;
}

abstract class AdjustmentDetailsActions extends ModelActions<AdjustmentDetails, AdjustmentDetailsBuilder, AdjustmentDetailsActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory AdjustmentDetailsActions(AdjustmentDetailsActionsOptions options) => _$AdjustmentDetailsActions(options);
}
