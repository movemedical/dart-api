...
class ShipmentFileType extends EnumClass {
  ...
  static ShipmentFileType valueOf(String name) => _$shipmentFileTypeValueOf(name);
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<ShipmentFileType> get serializer => _$shipmentFileTypeSerializer;
}
