...
abstract class PersonNameActions
    extends ModelActions<PersonName, PersonNameBuilder, PersonNameActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory PersonNameActions(PersonNameActionsOptions options) =>
      _$PersonNameActions(options);
}
