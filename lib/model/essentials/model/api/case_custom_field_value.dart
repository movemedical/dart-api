...
abstract class CaseCustomFieldValue
    implements Built<CaseCustomFieldValue, CaseCustomFieldValueBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CaseCustomFieldValue([updates(CaseCustomFieldValueBuilder b)]) =
  ...
  static Serializer<CaseCustomFieldValue> get serializer =>
      _$caseCustomFieldValueSerializer;
}

abstract class CaseCustomFieldValueActions extends ModelActions<
    CaseCustomFieldValue,
    CaseCustomFieldValueBuilder,
    CaseCustomFieldValueActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CaseCustomFieldValueActions(
          CaseCustomFieldValueActionsOptions options) =>
      _$CaseCustomFieldValueActions(options);
}
