...
class PresenceEventType extends EnumClass {
  ...
  static PresenceEventType valueOf(String name) => _$presenceEventTypeValueOf(name);
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<PresenceEventType> get serializer => _$presenceEventTypeSerializer;
}
