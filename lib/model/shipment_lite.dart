...
abstract class ShipmentLite
    implements Built<ShipmentLite, ShipmentLiteBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
...
abstract class ShipmentLiteActions extends ModelActions<ShipmentLite,
    ShipmentLiteBuilder, ShipmentLiteActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ShipmentLiteActions(ShipmentLiteActionsOptions options) =>
      _$ShipmentLiteActions(options);
}
