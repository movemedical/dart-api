...
abstract class DBComponentActions
    extends ModelActions<DBComponent, DBComponentBuilder, DBComponentActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory DBComponentActions(DBComponentActionsOptions options) =>
      _$DBComponentActions(options);
}
