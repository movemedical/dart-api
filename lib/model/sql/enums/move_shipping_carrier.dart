...
class MoveShippingCarrier extends EnumClass {
  ...
  static BuiltSet<MoveShippingCarrier> get values => _$moveShippingCarrierValues;
  
  static MoveShippingCarrier valueOf(String name) => _$moveShippingCarrierValueOf(name);
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<MoveShippingCarrier> get serializer => _$moveShippingCarrierSerializer;
}
