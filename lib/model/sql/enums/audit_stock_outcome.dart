...
class AuditStockOutcome extends EnumClass {
  ...
  static const AuditStockOutcome COMPONENT_VARIANCES = _$wireCOMPONENT_VARIANCES;
  ...
  static AuditStockOutcome valueOf(String name) => _$auditStockOutcomeValueOf(name);
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<AuditStockOutcome> get serializer => _$auditStockOutcomeSerializer;
}
