...
class CaseLoaningMethodology extends EnumClass {
  ...
  static BuiltSet<CaseLoaningMethodology> get values => _$caseLoaningMethodologyValues;
  
  static CaseLoaningMethodology valueOf(String name) => _$caseLoaningMethodologyValueOf(name);
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<CaseLoaningMethodology> get serializer => _$caseLoaningMethodologySerializer;
}
