...
class AdjustmentReferenceType extends EnumClass {
  ...
  static BuiltSet<AdjustmentReferenceType> get values => _$adjustmentReferenceTypeValues;
  
  static AdjustmentReferenceType valueOf(String name) => _$adjustmentReferenceTypeValueOf(name);
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<AdjustmentReferenceType> get serializer => _$adjustmentReferenceTypeSerializer;
}
