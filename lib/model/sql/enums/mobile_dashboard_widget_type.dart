...
class MobileDashboardWidgetType extends EnumClass {
  ...
  static const MobileDashboardWidgetType SALES_ORDER_CREATE = _$wireSALES_ORDER_CREATE;
  static const MobileDashboardWidgetType STOCK_ORDER_CREATE = _$wireSTOCK_ORDER_CREATE;
  static const MobileDashboardWidgetType STOCK_SEARCH = _$wireSTOCK_SEARCH;
  static const MobileDashboardWidgetType INVENTORY_TRANSFER = _$wireINVENTORY_TRANSFER;
  ...
  static BuiltSet<MobileDashboardWidgetType> get values => _$mobileDashboardWidgetTypeValues;
  
  static MobileDashboardWidgetType valueOf(String name) => _$mobileDashboardWidgetTypeValueOf(name);
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<MobileDashboardWidgetType> get serializer => _$mobileDashboardWidgetTypeSerializer;
}
