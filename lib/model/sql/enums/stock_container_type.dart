...
class StockContainerType extends EnumClass {
  ...
  static StockContainerType valueOf(String name) => _$stockContainerTypeValueOf(name);
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<StockContainerType> get serializer => _$stockContainerTypeSerializer;
}
