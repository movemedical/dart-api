...
class IntegrationIssueStatus extends EnumClass {
  ...
  static BuiltSet<IntegrationIssueStatus> get values => _$integrationIssueStatusValues;
  
  static IntegrationIssueStatus valueOf(String name) => _$integrationIssueStatusValueOf(name);
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<IntegrationIssueStatus> get serializer => _$integrationIssueStatusSerializer;
}
