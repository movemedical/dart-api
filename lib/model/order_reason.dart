...
abstract class OrderReasonActions
    extends ModelActions<OrderReason, OrderReasonBuilder, OrderReasonActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory OrderReasonActions(OrderReasonActionsOptions options) =>
      _$OrderReasonActions(options);
}
