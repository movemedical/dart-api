...
abstract class OrgUnitActions
    extends ModelActions<OrgUnit, OrgUnitBuilder, OrgUnitActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory OrgUnitActions(OrgUnitActionsOptions options) =>
      _$OrgUnitActions(options);
}
