...
abstract class StockPlaceActions extends ModelActions<StockPlace, StockPlaceBuilder, StockPlaceActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory StockPlaceActions(StockPlaceActionsOptions options) => _$StockPlaceActions(options);
}
