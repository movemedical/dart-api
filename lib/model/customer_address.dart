...
abstract class CustomerAddress implements Built<CustomerAddress, CustomerAddressBuilder> {
  ...
  factory CustomerAddress([updates(CustomerAddressBuilder b)]) = _$CustomerAddress;
...
abstract class CustomerAddressActions extends ModelActions<CustomerAddress, CustomerAddressBuilder, CustomerAddressActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CustomerAddressActions(CustomerAddressActionsOptions options) => _$CustomerAddressActions(options);
}
