...
abstract class CustomDocActions extends ModelActions<CustomDoc, CustomDocBuilder, CustomDocActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CustomDocActions(CustomDocActionsOptions options) => _$CustomDocActions(options);
}
