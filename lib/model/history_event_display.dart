...
abstract class HistoryEventDisplay
    implements Built<HistoryEventDisplay, HistoryEventDisplayBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory HistoryEventDisplay([updates(HistoryEventDisplayBuilder b)]) =
  ...
  static Serializer<HistoryEventDisplay> get serializer =>
      _$historyEventDisplaySerializer;
}

abstract class HistoryEventDisplayActions extends ModelActions<
    HistoryEventDisplay,
    HistoryEventDisplayBuilder,
    HistoryEventDisplayActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory HistoryEventDisplayActions(
          HistoryEventDisplayActionsOptions options) =>
      _$HistoryEventDisplayActions(options);
}
