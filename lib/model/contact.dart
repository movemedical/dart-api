...
abstract class ContactActions extends ModelActions<Contact, ContactBuilder, ContactActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory ContactActions(ContactActionsOptions options) => _$ContactActions(options);
}
