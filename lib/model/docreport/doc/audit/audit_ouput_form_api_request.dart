...
abstract class AuditOuputFormApiRequest
    implements
        Built<AuditOuputFormApiRequest, AuditOuputFormApiRequestBuilder>,
  ...
  factory AuditOuputFormApiRequest(
          [updates(AuditOuputFormApiRequestBuilder b)]) =
  ...
  static Serializer<AuditOuputFormApiRequest> get serializer =>
      _$auditOuputFormApiRequestSerializer;
}

abstract class AuditOuputFormApiRequestActions extends ModelActions<
    AuditOuputFormApiRequest,
    AuditOuputFormApiRequestBuilder,
    AuditOuputFormApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory AuditOuputFormApiRequestActions(
          AuditOuputFormApiRequestActionsOptions options) =>
      _$AuditOuputFormApiRequestActions(options);
}
