...
abstract class RequestShipmentPickListDocApiRequest
    implements
        Built<RequestShipmentPickListDocApiRequest,
  ...
  factory RequestShipmentPickListDocApiRequest(
          [updates(RequestShipmentPickListDocApiRequestBuilder b)]) =
  ...
  static Serializer<RequestShipmentPickListDocApiRequest> get serializer =>
      _$requestShipmentPickListDocApiRequestSerializer;
}

abstract class RequestShipmentPickListDocApiRequestActions extends ModelActions<
    RequestShipmentPickListDocApiRequest,
    RequestShipmentPickListDocApiRequestBuilder,
    RequestShipmentPickListDocApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory RequestShipmentPickListDocApiRequestActions(
          RequestShipmentPickListDocApiRequestActionsOptions options) =>
      _$RequestShipmentPickListDocApiRequestActions(options);
}
