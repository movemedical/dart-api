...
abstract class CustomCaseDocApiRequest
    implements
        Built<CustomCaseDocApiRequest, CustomCaseDocApiRequestBuilder>,
  ...
  factory CustomCaseDocApiRequest([updates(CustomCaseDocApiRequestBuilder b)]) =
  ...
  static Serializer<CustomCaseDocApiRequest> get serializer =>
      _$customCaseDocApiRequestSerializer;
}

abstract class CustomCaseDocApiRequestActions extends ModelActions<
    CustomCaseDocApiRequest,
    CustomCaseDocApiRequestBuilder,
    CustomCaseDocApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CustomCaseDocApiRequestActions(
          CustomCaseDocApiRequestActionsOptions options) =>
      _$CustomCaseDocApiRequestActions(options);
}
