...
abstract class RequestKitBillOfMaterialsDocApiRequest
    implements
        Built<RequestKitBillOfMaterialsDocApiRequest,
  ...
  factory RequestKitBillOfMaterialsDocApiRequest(
          [updates(RequestKitBillOfMaterialsDocApiRequestBuilder b)]) =
  ...
  static Serializer<RequestKitBillOfMaterialsDocApiRequest> get serializer =>
      _$requestKitBillOfMaterialsDocApiRequestSerializer;
}

abstract class RequestKitBillOfMaterialsDocApiRequestActions
    extends ModelActions<
        RequestKitBillOfMaterialsDocApiRequest,
        RequestKitBillOfMaterialsDocApiRequestBuilder,
        RequestKitBillOfMaterialsDocApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory RequestKitBillOfMaterialsDocApiRequestActions(
          RequestKitBillOfMaterialsDocApiRequestActionsOptions options) =>
      _$RequestKitBillOfMaterialsDocApiRequestActions(options);
}
