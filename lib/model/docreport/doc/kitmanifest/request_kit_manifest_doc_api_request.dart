...
abstract class RequestKitManifestDocApiRequest
    implements
        Built<RequestKitManifestDocApiRequest,
  ...
  factory RequestKitManifestDocApiRequest(
          [updates(RequestKitManifestDocApiRequestBuilder b)]) =
  ...
  static Serializer<RequestKitManifestDocApiRequest> get serializer =>
      _$requestKitManifestDocApiRequestSerializer;
}

abstract class RequestKitManifestDocApiRequestActions extends ModelActions<
    RequestKitManifestDocApiRequest,
    RequestKitManifestDocApiRequestBuilder,
    RequestKitManifestDocApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory RequestKitManifestDocApiRequestActions(
          RequestKitManifestDocApiRequestActionsOptions options) =>
      _$RequestKitManifestDocApiRequestActions(options);
}
