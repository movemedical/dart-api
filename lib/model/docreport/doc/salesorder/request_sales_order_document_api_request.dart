...
abstract class RequestSalesOrderDocumentApiRequest
    implements
        Built<RequestSalesOrderDocumentApiRequest,
  ...
  factory RequestSalesOrderDocumentApiRequest(
          [updates(RequestSalesOrderDocumentApiRequestBuilder b)]) =
  ...
  static Serializer<RequestSalesOrderDocumentApiRequest> get serializer =>
      _$requestSalesOrderDocumentApiRequestSerializer;
}

abstract class RequestSalesOrderDocumentApiRequestActions extends ModelActions<
    RequestSalesOrderDocumentApiRequest,
    RequestSalesOrderDocumentApiRequestBuilder,
    RequestSalesOrderDocumentApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory RequestSalesOrderDocumentApiRequestActions(
          RequestSalesOrderDocumentApiRequestActionsOptions options) =>
      _$RequestSalesOrderDocumentApiRequestActions(options);
}
