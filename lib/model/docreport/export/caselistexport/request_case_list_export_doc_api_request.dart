...
abstract class RequestCaseListExportDocApiRequest
    implements
        Built<RequestCaseListExportDocApiRequest,
  ...
  factory RequestCaseListExportDocApiRequest(
          [updates(RequestCaseListExportDocApiRequestBuilder b)]) =
  ...
  static Serializer<RequestCaseListExportDocApiRequest> get serializer =>
      _$requestCaseListExportDocApiRequestSerializer;
}

abstract class RequestCaseListExportDocApiRequestActions extends ModelActions<
    RequestCaseListExportDocApiRequest,
    RequestCaseListExportDocApiRequestBuilder,
    RequestCaseListExportDocApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory RequestCaseListExportDocApiRequestActions(
          RequestCaseListExportDocApiRequestActionsOptions options) =>
      _$RequestCaseListExportDocApiRequestActions(options);
}
