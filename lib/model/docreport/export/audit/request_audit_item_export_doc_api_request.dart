...
abstract class RequestAuditItemExportDocApiRequest
    implements
        Built<RequestAuditItemExportDocApiRequest,
  ...
  factory RequestAuditItemExportDocApiRequest(
          [updates(RequestAuditItemExportDocApiRequestBuilder b)]) =
  ...
  static Serializer<RequestAuditItemExportDocApiRequest> get serializer =>
      _$requestAuditItemExportDocApiRequestSerializer;
}

abstract class RequestAuditItemExportDocApiRequestActions extends ModelActions<
    RequestAuditItemExportDocApiRequest,
    RequestAuditItemExportDocApiRequestBuilder,
    RequestAuditItemExportDocApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory RequestAuditItemExportDocApiRequestActions(
          RequestAuditItemExportDocApiRequestActionsOptions options) =>
      _$RequestAuditItemExportDocApiRequestActions(options);
}
