...
part of 'request_open_billing_report_api_response.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<RequestOpenBillingReportApiResponse>
    _$requestOpenBillingReportApiResponseSerializer =
    new _$RequestOpenBillingReportApiResponseSerializer();

class _$RequestOpenBillingReportApiResponseSerializer
    implements StructuredSerializer<RequestOpenBillingReportApiResponse> {
  @override
  ...
  final String wireName =
      'movemedical_api/model/docreport/report/openbilling/RequestOpenBillingReportApiResponse';

  @override
  Iterable serialize(
      Serializers serializers, RequestOpenBillingReportApiResponse object,
  ...
  @override
  RequestOpenBillingReportApiResponse deserialize(
      Serializers serializers, Iterable serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new RequestOpenBillingReportApiResponseBuilder();
...
class _$RequestOpenBillingReportApiResponse
    extends RequestOpenBillingReportApiResponse {
  @override
  ...
  factory _$RequestOpenBillingReportApiResponse(
          [void updates(RequestOpenBillingReportApiResponseBuilder b)]) =>
      (new RequestOpenBillingReportApiResponseBuilder()..update(updates))
          .build();

  _$RequestOpenBillingReportApiResponse._(
      {this.docReportId, this.hcrTeam, this.hospital})
      : super._();

  @override
  RequestOpenBillingReportApiResponse rebuild(
          void updates(RequestOpenBillingReportApiResponseBuilder b)) =>
      (toBuilder()..update(updates)).build();

  @override
  RequestOpenBillingReportApiResponseBuilder toBuilder() =>
      new RequestOpenBillingReportApiResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is RequestOpenBillingReportApiResponse &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('RequestOpenBillingReportApiResponse')
...
class RequestOpenBillingReportApiResponseBuilder
    implements
        Builder<RequestOpenBillingReportApiResponse,
  ...
  RequestOpenBillingReportApiResponseBuilder get _$this {
    if (_$v != null) {
  ...
  @override
  void replace(RequestOpenBillingReportApiResponse other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$RequestOpenBillingReportApiResponse;
  }

  @override
  void update(void updates(RequestOpenBillingReportApiResponseBuilder b)) {
    if (updates != null) updates(this);
  }

  @override
  _$RequestOpenBillingReportApiResponse build() {
    _$RequestOpenBillingReportApiResponse _$result;
    try {
      _$result = _$v ??
          new _$RequestOpenBillingReportApiResponse._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'RequestOpenBillingReportApiResponse', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
...
typedef StatefulActionsOptions<
    RequestOpenBillingReportApiResponse,
    RequestOpenBillingReportApiResponseBuilder,
    RequestOpenBillingReportApiResponseActions> RequestOpenBillingReportApiResponseActionsOptions();

class _$RequestOpenBillingReportApiResponseActions
    extends RequestOpenBillingReportApiResponseActions {
  ...
  factory _$RequestOpenBillingReportApiResponseActions(
