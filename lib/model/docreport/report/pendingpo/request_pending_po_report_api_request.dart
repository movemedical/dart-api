...
abstract class RequestPendingPoReportApiRequest
    implements
        Built<RequestPendingPoReportApiRequest,
  ...
  factory RequestPendingPoReportApiRequest(
          [updates(RequestPendingPoReportApiRequestBuilder b)]) =
  ...
  static Serializer<RequestPendingPoReportApiRequest> get serializer =>
      _$requestPendingPoReportApiRequestSerializer;
}

abstract class RequestPendingPoReportApiRequestActions extends ModelActions<
    RequestPendingPoReportApiRequest,
    RequestPendingPoReportApiRequestBuilder,
    RequestPendingPoReportApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory RequestPendingPoReportApiRequestActions(
          RequestPendingPoReportApiRequestActionsOptions options) =>
      _$RequestPendingPoReportApiRequestActions(options);
}
