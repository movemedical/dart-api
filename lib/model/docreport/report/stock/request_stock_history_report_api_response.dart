...
abstract class RequestStockHistoryReportApiResponse
    implements
        Built<RequestStockHistoryReportApiResponse,
  ...
  factory RequestStockHistoryReportApiResponse(
          [updates(RequestStockHistoryReportApiResponseBuilder b)]) =
  ...
  static Serializer<RequestStockHistoryReportApiResponse> get serializer =>
      _$requestStockHistoryReportApiResponseSerializer;
}

abstract class RequestStockHistoryReportApiResponseActions extends ModelActions<
    RequestStockHistoryReportApiResponse,
    RequestStockHistoryReportApiResponseBuilder,
    RequestStockHistoryReportApiResponseActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory RequestStockHistoryReportApiResponseActions(
          RequestStockHistoryReportApiResponseActionsOptions options) =>
      _$RequestStockHistoryReportApiResponseActions(options);
}
