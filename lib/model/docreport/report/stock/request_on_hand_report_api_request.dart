...
abstract class RequestOnHandReportApiRequest
    implements
        Built<RequestOnHandReportApiRequest,
  ...
  factory RequestOnHandReportApiRequest(
          [updates(RequestOnHandReportApiRequestBuilder b)]) =
  ...
  static Serializer<RequestOnHandReportApiRequest> get serializer =>
      _$requestOnHandReportApiRequestSerializer;
}

abstract class RequestOnHandReportApiRequestActions extends ModelActions<
    RequestOnHandReportApiRequest,
    RequestOnHandReportApiRequestBuilder,
    RequestOnHandReportApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory RequestOnHandReportApiRequestActions(
          RequestOnHandReportApiRequestActionsOptions options) =>
      _$RequestOnHandReportApiRequestActions(options);
}
