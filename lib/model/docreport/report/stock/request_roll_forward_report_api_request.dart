...
abstract class RequestRollForwardReportApiRequest
    implements
        Built<RequestRollForwardReportApiRequest,
  ...
  factory RequestRollForwardReportApiRequest(
          [updates(RequestRollForwardReportApiRequestBuilder b)]) =
  ...
  static Serializer<RequestRollForwardReportApiRequest> get serializer =>
      _$requestRollForwardReportApiRequestSerializer;
}

abstract class RequestRollForwardReportApiRequestActions extends ModelActions<
    RequestRollForwardReportApiRequest,
    RequestRollForwardReportApiRequestBuilder,
    RequestRollForwardReportApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory RequestRollForwardReportApiRequestActions(
          RequestRollForwardReportApiRequestActionsOptions options) =>
      _$RequestRollForwardReportApiRequestActions(options);
}
