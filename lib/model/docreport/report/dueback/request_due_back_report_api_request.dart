...
abstract class RequestDueBackReportApiRequest implements Built<RequestDueBackReportApiRequest, RequestDueBackReportApiRequestBuilder>, MoveDocReportRequest {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory RequestDueBackReportApiRequest([updates(RequestDueBackReportApiRequestBuilder b)]) = _$RequestDueBackReportApiRequest;
  
  ////////////////////////////////
  /// Serializer
  ////////////////////////////////
  
  static Serializer<RequestDueBackReportApiRequest> get serializer => _$requestDueBackReportApiRequestSerializer;
}

abstract class RequestDueBackReportApiRequestActions extends ModelActions<RequestDueBackReportApiRequest, RequestDueBackReportApiRequestBuilder, RequestDueBackReportApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory RequestDueBackReportApiRequestActions(RequestDueBackReportApiRequestActionsOptions options) => _$RequestDueBackReportApiRequestActions(options);
}
