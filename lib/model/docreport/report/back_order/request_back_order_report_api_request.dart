...
abstract class RequestBackOrderReportApiRequest
    implements
        Built<RequestBackOrderReportApiRequest,
  ...
  factory RequestBackOrderReportApiRequest(
          [updates(RequestBackOrderReportApiRequestBuilder b)]) =
  ...
  static Serializer<RequestBackOrderReportApiRequest> get serializer =>
      _$requestBackOrderReportApiRequestSerializer;
}

abstract class RequestBackOrderReportApiRequestActions extends ModelActions<
    RequestBackOrderReportApiRequest,
    RequestBackOrderReportApiRequestBuilder,
    RequestBackOrderReportApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory RequestBackOrderReportApiRequestActions(
          RequestBackOrderReportApiRequestActionsOptions options) =>
      _$RequestBackOrderReportApiRequestActions(options);
}
