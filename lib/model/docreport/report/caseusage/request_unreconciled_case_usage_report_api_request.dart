...
abstract class RequestUnreconciledCaseUsageReportApiRequest
    implements
        Built<RequestUnreconciledCaseUsageReportApiRequest,
  ...
  factory RequestUnreconciledCaseUsageReportApiRequest(
          [updates(RequestUnreconciledCaseUsageReportApiRequestBuilder b)]) =
  ...
  static Serializer<RequestUnreconciledCaseUsageReportApiRequest>
      get serializer =>
          _$requestUnreconciledCaseUsageReportApiRequestSerializer;
}

abstract class RequestUnreconciledCaseUsageReportApiRequestActions
    extends ModelActions<
        RequestUnreconciledCaseUsageReportApiRequest,
        RequestUnreconciledCaseUsageReportApiRequestBuilder,
        RequestUnreconciledCaseUsageReportApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory RequestUnreconciledCaseUsageReportApiRequestActions(
          RequestUnreconciledCaseUsageReportApiRequestActionsOptions options) =>
      _$RequestUnreconciledCaseUsageReportApiRequestActions(options);
}
