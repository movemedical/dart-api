...
abstract class RequestCreditHoldReportApiRequest
    implements
        Built<RequestCreditHoldReportApiRequest,
  ...
  factory RequestCreditHoldReportApiRequest(
          [updates(RequestCreditHoldReportApiRequestBuilder b)]) =
  ...
  static Serializer<RequestCreditHoldReportApiRequest> get serializer =>
      _$requestCreditHoldReportApiRequestSerializer;
}

abstract class RequestCreditHoldReportApiRequestActions extends ModelActions<
    RequestCreditHoldReportApiRequest,
    RequestCreditHoldReportApiRequestBuilder,
    RequestCreditHoldReportApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory RequestCreditHoldReportApiRequestActions(
          RequestCreditHoldReportApiRequestActionsOptions options) =>
      _$RequestCreditHoldReportApiRequestActions(options);
}
