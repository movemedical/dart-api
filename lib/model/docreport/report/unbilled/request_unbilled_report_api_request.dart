...
abstract class RequestUnbilledReportApiRequest
    implements
        Built<RequestUnbilledReportApiRequest,
  ...
  factory RequestUnbilledReportApiRequest(
          [updates(RequestUnbilledReportApiRequestBuilder b)]) =
  ...
  static Serializer<RequestUnbilledReportApiRequest> get serializer =>
      _$requestUnbilledReportApiRequestSerializer;
}

abstract class RequestUnbilledReportApiRequestActions extends ModelActions<
    RequestUnbilledReportApiRequest,
    RequestUnbilledReportApiRequestBuilder,
    RequestUnbilledReportApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory RequestUnbilledReportApiRequestActions(
          RequestUnbilledReportApiRequestActionsOptions options) =>
      _$RequestUnbilledReportApiRequestActions(options);
}
