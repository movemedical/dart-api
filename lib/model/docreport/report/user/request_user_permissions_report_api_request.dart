...
abstract class RequestUserPermissionsReportApiRequest
    implements
        Built<RequestUserPermissionsReportApiRequest,
  ...
  factory RequestUserPermissionsReportApiRequest(
          [updates(RequestUserPermissionsReportApiRequestBuilder b)]) =
  ...
  static Serializer<RequestUserPermissionsReportApiRequest> get serializer =>
      _$requestUserPermissionsReportApiRequestSerializer;
}

abstract class RequestUserPermissionsReportApiRequestActions
    extends ModelActions<
        RequestUserPermissionsReportApiRequest,
        RequestUserPermissionsReportApiRequestBuilder,
        RequestUserPermissionsReportApiRequestActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory RequestUserPermissionsReportApiRequestActions(
          RequestUserPermissionsReportApiRequestActionsOptions options) =>
      _$RequestUserPermissionsReportApiRequestActions(options);
}
