...
abstract class BizUnitActions extends ModelActions<BizUnit, BizUnitBuilder, BizUnitActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory BizUnitActions(BizUnitActionsOptions options) => _$BizUnitActions(options);
}
