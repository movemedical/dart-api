...
abstract class LocationData
    implements Built<LocationData, LocationDataBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
...
abstract class LocationDataActions extends ModelActions<LocationData,
    LocationDataBuilder, LocationDataActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory LocationDataActions(LocationDataActionsOptions options) =>
      _$LocationDataActions(options);
}
