...
abstract class HistoryEventDisplayRecord
    implements
        Built<HistoryEventDisplayRecord, HistoryEventDisplayRecordBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory HistoryEventDisplayRecord(
          [updates(HistoryEventDisplayRecordBuilder b)]) =
  ...
  static Serializer<HistoryEventDisplayRecord> get serializer =>
      _$historyEventDisplayRecordSerializer;
}

abstract class HistoryEventDisplayRecordActions extends ModelActions<
    HistoryEventDisplayRecord,
    HistoryEventDisplayRecordBuilder,
    HistoryEventDisplayRecordActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory HistoryEventDisplayRecordActions(
          HistoryEventDisplayRecordActionsOptions options) =>
      _$HistoryEventDisplayRecordActions(options);
}
