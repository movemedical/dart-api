...
abstract class CustomFieldValue
    implements Built<CustomFieldValue, CustomFieldValueBuilder> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CustomFieldValue([updates(CustomFieldValueBuilder b)]) =
      _$CustomFieldValue;
  ...
  static Serializer<CustomFieldValue> get serializer =>
      _$customFieldValueSerializer;
}

abstract class CustomFieldValueActions extends ModelActions<CustomFieldValue,
    CustomFieldValueBuilder, CustomFieldValueActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory CustomFieldValueActions(CustomFieldValueActionsOptions options) =>
      _$CustomFieldValueActions(options);
}
