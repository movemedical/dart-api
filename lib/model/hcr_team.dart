...
abstract class HcrTeamActions
    extends ModelActions<HcrTeam, HcrTeamBuilder, HcrTeamActions> {
  ////////////////////////////////
  /// Fields
  ////////////////////////////////
  ...
  factory HcrTeamActions(HcrTeamActionsOptions options) =>
      _$HcrTeamActions(options);
}
