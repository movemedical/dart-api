...
abstract class PushDispatcher extends StatelessActions<PushDispatcher> {
  ...
  ActionDispatcher<CaseEventFileUpdatePushMessage> get caseEventFileUpdatePushMessage;
  
  ActionDispatcher<CaseEventUpdatePushMessage> get caseEventUpdatePushMessage;
  
  ActionDispatcher<CaseRequirementsUpdatedPushMessage> get caseRequirementsUpdatedPushMessage;
  
  ActionDispatcher<CaseScheduleUpdatePushMessage> get caseScheduleUpdatePushMessage;
  ...
  PushType findByName(String name) {
    ...
    switch (name) {
      case 'AuditFilePushMessage':
        return PushType<AuditFilePushMessage>('AuditFilePushMessage', AuditFilePushMessage.serializer, auditFilePushMessage);
      case 'AuditFileUpdatePushMessage':
        return PushType<AuditFileUpdatePushMessage>('AuditFileUpdatePushMessage', AuditFileUpdatePushMessage.serializer, auditFileUpdatePushMessage);
      case 'AuditUpdatedPushMessage':
        return PushType<AuditUpdatedPushMessage>('AuditUpdatedPushMessage', AuditUpdatedPushMessage.serializer, auditUpdatedPushMessage);
      case 'CaseEventFileUpdatePushMessage':
        return PushType<CaseEventFileUpdatePushMessage>('CaseEventFileUpdatePushMessage', CaseEventFileUpdatePushMessage.serializer, caseEventFileUpdatePushMessage);
      case 'CaseEventUpdatePushMessage':
        return PushType<CaseEventUpdatePushMessage>('CaseEventUpdatePushMessage', CaseEventUpdatePushMessage.serializer, caseEventUpdatePushMessage);
      case 'CaseRequirementsUpdatedPushMessage':
        return PushType<CaseRequirementsUpdatedPushMessage>('CaseRequirementsUpdatedPushMessage', CaseRequirementsUpdatedPushMessage.serializer, caseRequirementsUpdatedPushMessage);
      ...
      case 'FacilityUpdatedPushMessage':
        return PushType<FacilityUpdatedPushMessage>('FacilityUpdatedPushMessage', FacilityUpdatedPushMessage.serializer, facilityUpdatedPushMessage);
      ...
      case 'OrderDetailPushMessage':
        return PushType<OrderDetailPushMessage>('OrderDetailPushMessage', OrderDetailPushMessage.serializer, orderDetailPushMessage);
      case 'OrderFilePushMessage':
        return PushType<OrderFilePushMessage>('OrderFilePushMessage', OrderFilePushMessage.serializer, orderFilePushMessage);
      ...
      case 'UiSetupUpdatedPushMessage':
        return PushType<UiSetupUpdatedPushMessage>('UiSetupUpdatedPushMessage', UiSetupUpdatedPushMessage.serializer, uiSetupUpdatedPushMessage);
      case 'MovePresenceEvent':
        return PushType<MovePresenceEvent>('MovePresenceEvent', MovePresenceEvent.serializer, movePresenceEvent);
    }
    return null;
  }
  
  PushType toPushType(dynamic message) {
    if (message is AuditFilePushMessage) return PushType<AuditFilePushMessage>('AuditFilePushMessage', AuditFilePushMessage.serializer, auditFilePushMessage);
    if (message is AuditFileUpdatePushMessage) return PushType<AuditFileUpdatePushMessage>('AuditFileUpdatePushMessage', AuditFileUpdatePushMessage.serializer, auditFileUpdatePushMessage);
    if (message is AuditUpdatedPushMessage) return PushType<AuditUpdatedPushMessage>('AuditUpdatedPushMessage', AuditUpdatedPushMessage.serializer, auditUpdatedPushMessage);
    if (message is CaseEventFileUpdatePushMessage) return PushType<CaseEventFileUpdatePushMessage>('CaseEventFileUpdatePushMessage', CaseEventFileUpdatePushMessage.serializer, caseEventFileUpdatePushMessage);
    if (message is CaseEventUpdatePushMessage) return PushType<CaseEventUpdatePushMessage>('CaseEventUpdatePushMessage', CaseEventUpdatePushMessage.serializer, caseEventUpdatePushMessage);
...
abstract class PushPayloads implements Built<PushPayloads, PushPayloadsBuilder> {
