...
abstract class ListTeamOrgUnitLinksApi extends ApiDispatcher<
  ...
  @override
  String get path =>
      'v1/directory/relationship/team_to_org_unit/list_team_org_unit_links';

  ListTeamOrgUnitLinksApi._();

  factory ListTeamOrgUnitLinksApi(ListTeamOrgUnitLinksApiOptions options) =
      _$ListTeamOrgUnitLinksApi;
}
