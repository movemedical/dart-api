...
abstract class ListTeamOrgUnitOptionsApi extends ApiDispatcher<
  ...
  @override
  String get path =>
      'v1/directory/relationship/team_to_org_unit/list_org_unit_options';

  ListTeamOrgUnitOptionsApi._();

  factory ListTeamOrgUnitOptionsApi(ListTeamOrgUnitOptionsApiOptions options) =
      _$ListTeamOrgUnitOptionsApi;
}
