...
abstract class ListFacilityPhysicianLinksApi extends ApiDispatcher<
  ...
  @override
  String get path =>
      'v1/directory/relationship/physician_to_facility/list_physician_links';

  ListFacilityPhysicianLinksApi._();

  factory ListFacilityPhysicianLinksApi(
          ListFacilityPhysicianLinksApiOptions options) =
      _$ListFacilityPhysicianLinksApi;
}
