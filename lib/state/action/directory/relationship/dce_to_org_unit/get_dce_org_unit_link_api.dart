...
abstract class GetDceOrgUnitLinkApi extends ApiDispatcher<GetDceOrgUnitLinkApiRequest,
...
GetDceOrgUnitLinkApi> {
  ...
  factory GetDceOrgUnitLinkApi(GetDceOrgUnitLinkApiOptions options) = _$GetDceOrgUnitLinkApi;
}
