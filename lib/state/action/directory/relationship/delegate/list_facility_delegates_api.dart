...
abstract class ListFacilityDelegatesApi extends ApiDispatcher<
  ...
  @override
  String get path =>
      'v1/directory/relationship/delegate/list_facility_delegates';

  ListFacilityDelegatesApi._();

  factory ListFacilityDelegatesApi(ListFacilityDelegatesApiOptions options) =
      _$ListFacilityDelegatesApi;
}
