...
abstract class ListOrgUnitFacilityOptionsApi extends ApiDispatcher<
  ...
  @override
  String get path =>
      'v1/directory/relationship/org_unit_to_facility/list_facility_options';

  ListOrgUnitFacilityOptionsApi._();

  factory ListOrgUnitFacilityOptionsApi(
          ListOrgUnitFacilityOptionsApiOptions options) =
      _$ListOrgUnitFacilityOptionsApi;
}
