...
abstract class ListBizUnitProcedureOptionsApi extends ApiDispatcher<
  ...
  @override
  String get path =>
      'v1/directory/relationship/procedure_to_biz_unit/list_procedure_options';

  ListBizUnitProcedureOptionsApi._();

  factory ListBizUnitProcedureOptionsApi(
          ListBizUnitProcedureOptionsApiOptions options) =
      _$ListBizUnitProcedureOptionsApi;
}
