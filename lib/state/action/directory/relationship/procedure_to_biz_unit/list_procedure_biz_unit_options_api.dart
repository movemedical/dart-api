...
abstract class ListProcedureBizUnitOptionsApi extends ApiDispatcher<
  ...
  @override
  String get path =>
      'v1/directory/relationship/procedure_to_biz_unit/list_biz_unit_options';

  ListProcedureBizUnitOptionsApi._();

  factory ListProcedureBizUnitOptionsApi(
          ListProcedureBizUnitOptionsApiOptions options) =
      _$ListProcedureBizUnitOptionsApi;
}
