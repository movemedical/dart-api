...
abstract class ListOrgUnitPhysicianLinksApi extends ApiDispatcher<ListOrgUnitPhysicianLinksApiRequest,
...
ListOrgUnitPhysicianLinksApi> {
  @override
  String get path => 'v1/directory/relationship/org_unit_to_physician/list_physician_links';
  
  ListOrgUnitPhysicianLinksApi._();
  
  factory ListOrgUnitPhysicianLinksApi(ListOrgUnitPhysicianLinksApiOptions options) = _$ListOrgUnitPhysicianLinksApi;
}
