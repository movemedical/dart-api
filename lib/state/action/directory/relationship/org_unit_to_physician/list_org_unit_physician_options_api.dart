...
abstract class ListOrgUnitPhysicianOptionsApi extends ApiDispatcher<ListOrgUnitPhysicianOptionsApiRequest,
...
ListOrgUnitPhysicianOptionsApi> {
  @override
  String get path => 'v1/directory/relationship/org_unit_to_physician/list_physician_options';
  
  ListOrgUnitPhysicianOptionsApi._();
  
  factory ListOrgUnitPhysicianOptionsApi(ListOrgUnitPhysicianOptionsApiOptions options) = _$ListOrgUnitPhysicianOptionsApi;
}
