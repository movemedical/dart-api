...
abstract class ListPhysicianOrgUnitOptionsApi extends ApiDispatcher<
  ...
  @override
  String get path =>
      'v1/directory/relationship/org_unit_to_physician/list_org_unit_options';

  ListPhysicianOrgUnitOptionsApi._();

  factory ListPhysicianOrgUnitOptionsApi(
          ListPhysicianOrgUnitOptionsApiOptions options) =
      _$ListPhysicianOrgUnitOptionsApi;
}
