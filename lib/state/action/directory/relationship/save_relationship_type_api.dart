...
abstract class SaveRelationshipTypeApi extends ApiDispatcher<SaveRelationshipTypeApiRequest,
...
SaveRelationshipTypeApi> {
  ...
  factory SaveRelationshipTypeApi(SaveRelationshipTypeApiOptions options) = _$SaveRelationshipTypeApi;
}
