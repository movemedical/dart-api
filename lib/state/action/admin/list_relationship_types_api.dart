...
abstract class ListRelationshipTypesApi extends ApiDispatcher<ListRelationshipTypesApiRequest,
...
ListRelationshipTypesApi> {
  ...
  factory ListRelationshipTypesApi(ListRelationshipTypesApiOptions options) = _$ListRelationshipTypesApi;
}
