...
abstract class ListPreferenceCardsApi extends ApiDispatcher<ListPreferenceCardsApiRequest, ListPreferenceCardsApiResponse, ListPreferenceCardsApi> {
  @override
  String get path => 'v1/prefcard/list';
  
  @override
  Serializer<ListPreferenceCardsApiRequest> get requestSerializer => ListPreferenceCardsApiRequest.serializer;
  
  @override
  Serializer<ListPreferenceCardsApiResponse> get responseSerializer => ListPreferenceCardsApiResponse.serializer;
  
  ListPreferenceCardsApi._();
  
  factory ListPreferenceCardsApi(ListPreferenceCardsApiOptions options) = _$ListPreferenceCardsApi;
}
