...
abstract class AddPrefCardToOrgUnitApi extends ApiDispatcher<AddPrefCardToOrgUnitApiRequest,
...
AddPrefCardToOrgUnitApi> {
  ...
  factory AddPrefCardToOrgUnitApi(AddPrefCardToOrgUnitApiOptions options) = _$AddPrefCardToOrgUnitApi;
}
