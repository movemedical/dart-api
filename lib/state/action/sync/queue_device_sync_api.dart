...
abstract class QueueDeviceSyncApi extends ApiDispatcher<QueueDeviceSyncApiRequest,
...
QueueDeviceSyncApi> {
  ...
  factory QueueDeviceSyncApi(QueueDeviceSyncApiOptions options) = _$QueueDeviceSyncApi;
}
