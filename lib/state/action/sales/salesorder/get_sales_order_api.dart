...
abstract class GetSalesOrderApi extends ApiDispatcher<GetSalesOrderApiRequest, GetSalesOrderApiResponse, GetSalesOrderApi> {
  @override
  String get path => 'v1/sales/sales_order/get_sales_order_detail';
  
  @override
  Serializer<GetSalesOrderApiRequest> get requestSerializer => GetSalesOrderApiRequest.serializer;
  
  @override
  Serializer<GetSalesOrderApiResponse> get responseSerializer => GetSalesOrderApiResponse.serializer;
  
  GetSalesOrderApi._();
  
  factory GetSalesOrderApi(GetSalesOrderApiOptions options) = _$GetSalesOrderApi;
}
