...
abstract class ListPackageTrackingApi extends ApiDispatcher<
  ...
  factory ListPackageTrackingApi(ListPackageTrackingApiOptions options) =
      _$ListPackageTrackingApi;
}
