...
abstract class AutoCompleteShipmentApi extends ApiDispatcher<AutoCompleteShipmentApiRequest,
...
AutoCompleteShipmentApi> {
  ...
  factory AutoCompleteShipmentApi(AutoCompleteShipmentApiOptions options) = _$AutoCompleteShipmentApi;
}
