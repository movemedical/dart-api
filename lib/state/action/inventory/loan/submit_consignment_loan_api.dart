...
abstract class SubmitConsignmentLoanApi extends ApiDispatcher<SubmitConsignmentLoanApiRequest,
...
SubmitConsignmentLoanApi> {
  ...
  factory SubmitConsignmentLoanApi(SubmitConsignmentLoanApiOptions options) = _$SubmitConsignmentLoanApi;
}
