...
abstract class ApproveConsignmentLoanApi extends ApiDispatcher<ApproveConsignmentLoanApiRequest,
...
ApproveConsignmentLoanApi> {
  ...
  factory ApproveConsignmentLoanApi(ApproveConsignmentLoanApiOptions options) = _$ApproveConsignmentLoanApi;
}
