...
abstract class CreateConsignmentLoanApi extends ApiDispatcher<CreateConsignmentLoanApiRequest,
...
CreateConsignmentLoanApi> {
  ...
  factory CreateConsignmentLoanApi(CreateConsignmentLoanApiOptions options) = _$CreateConsignmentLoanApi;
}
