...
abstract class ListTrayContentsApi extends ApiDispatcher<ListTrayContentsApiRequest,
...
ListTrayContentsApi> {
  ...
  factory ListTrayContentsApi(ListTrayContentsApiOptions options) = _$ListTrayContentsApi;
}
