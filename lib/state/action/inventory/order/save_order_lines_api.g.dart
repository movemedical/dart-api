...
class _$SaveOrderLinesApi extends SaveOrderLinesApi {
  ...
  final ActionDispatcher<Command<ApiCommand<SaveOrderLinesApiRequest>>>
      execute$;
  ...
  _$SaveOrderLinesApi._(this.options$)
      : replace$ = options$.action<
        ...
        execute$ =
            options$.action<Command<ApiCommand<SaveOrderLinesApiRequest>>>(
                'execute\$', (a) => a?.execute$),
  ...
  @override
  CommandState<ApiCommand<SaveOrderLinesApiRequest>, ApiResult<Nothing>>
      get initialState$ => CommandState<ApiCommand<SaveOrderLinesApiRequest>,
          ApiResult<Nothing>>();
