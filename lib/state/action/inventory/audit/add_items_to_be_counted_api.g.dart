...
typedef StatefulActionsOptions<
    CommandState<ApiCommand<AddItemsToBeCountedApiRequest>, ApiResult<Null>>,
...
class _$AddItemsToBeCountedApi extends AddItemsToBeCountedApi {
  ...
  final ActionDispatcher<
      CommandPayload<ApiCommand<AddItemsToBeCountedApiRequest>, ApiResult<Null>,
          AddItemsToBeCountedApi, String>> $clear;
  final ActionDispatcher<
      CommandPayload<ApiCommand<AddItemsToBeCountedApiRequest>, ApiResult<Null>,
          AddItemsToBeCountedApi, String>> $cancel;
  final ActionDispatcher<
      CommandPayload<
  ...
  final ActionDispatcher<
      CommandPayload<ApiCommand<AddItemsToBeCountedApiRequest>, ApiResult<Null>,
          AddItemsToBeCountedApi, CommandResult<ApiResult<Null>>>> $result;
  final ActionDispatcher<
      CommandPayload<ApiCommand<AddItemsToBeCountedApiRequest>, ApiResult<Null>,
          AddItemsToBeCountedApi, String>> $detach;
  final ActionDispatcher<
      CommandPayload<ApiCommand<AddItemsToBeCountedApiRequest>, ApiResult<Null>,
          AddItemsToBeCountedApi, String>> $attach;
  final ActionDispatcher<
      CommandPayload<ApiCommand<AddItemsToBeCountedApiRequest>, ApiResult<Null>,
          AddItemsToBeCountedApi, CommandProgress>> $progress;
  ...
  CommandStateBuilder<ApiCommand<AddItemsToBeCountedApiRequest>,
      ...
      $newBuilder() => CommandStateBuilder<
          ApiCommand<AddItemsToBeCountedApiRequest>, ApiResult<Null>>();
