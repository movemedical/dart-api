...
abstract class GetOfflineAuditDataApi extends ApiDispatcher<GetOfflineAuditDataApiRequest,
...
GetOfflineAuditDataApi> {
  ...
  factory GetOfflineAuditDataApi(GetOfflineAuditDataApiOptions options) = _$GetOfflineAuditDataApi;
}
