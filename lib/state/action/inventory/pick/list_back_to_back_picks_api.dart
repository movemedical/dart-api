...
abstract class ListBackToBackPicksApi extends ApiDispatcher<
  ...
  factory ListBackToBackPicksApi(ListBackToBackPicksApiOptions options) =
      _$ListBackToBackPicksApi;
}
