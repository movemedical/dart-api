...
class _$ListZonesApi extends ListZonesApi {
  ...
  final ActionDispatcher<
      CommandPayload<ApiCommand<ListZonesApiRequest>,
          ApiResult<ListZonesApiResponse>, ListZonesApi, String>> $clear;
  final ActionDispatcher<
      CommandPayload<ApiCommand<ListZonesApiRequest>,
  ...
  final ActionDispatcher<
      CommandPayload<ApiCommand<ListZonesApiRequest>,
          ApiResult<ListZonesApiResponse>, ListZonesApi, String>> $detach;
  final ActionDispatcher<
      CommandPayload<ApiCommand<ListZonesApiRequest>,
          ApiResult<ListZonesApiResponse>, ListZonesApi, String>> $attach;
  final ActionDispatcher<
      CommandPayload<
          ApiCommand<ListZonesApiRequest>,
          ApiResult<ListZonesApiResponse>,
