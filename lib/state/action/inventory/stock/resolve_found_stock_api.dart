...
abstract class ResolveFoundStockApi extends ApiDispatcher<ResolveFoundStockApiRequest,
...
ResolveFoundStockApi> {
  ...
  factory ResolveFoundStockApi(ResolveFoundStockApiOptions options) = _$ResolveFoundStockApi;
}
