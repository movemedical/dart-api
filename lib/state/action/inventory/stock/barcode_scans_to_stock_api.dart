...
abstract class BarcodeScansToStockApi extends ApiDispatcher<
  ...
  factory BarcodeScansToStockApi(BarcodeScansToStockApiOptions options) =
      _$BarcodeScansToStockApi;
}
