...
abstract class CreatePackageApi extends ApiDispatcher<CreatePackageApiRequest,
...
CreatePackageApi> {
  ...
  factory CreatePackageApi(CreatePackageApiOptions options) = _$CreatePackageApi;
}
