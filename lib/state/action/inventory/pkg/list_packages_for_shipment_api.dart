...
abstract class ListPackagesForShipmentApi extends ApiDispatcher<
  ...
  factory ListPackagesForShipmentApi(
      ListPackagesForShipmentApiOptions options) = _$ListPackagesForShipmentApi;
}
