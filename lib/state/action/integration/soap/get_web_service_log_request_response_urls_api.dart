...
abstract class GetWebServiceLogRequestResponseUrlsApi extends ApiDispatcher<
  ...
  @override
  String get path =>
      'v1/integration/soap/get_webservice_log_request_response_urls';

  GetWebServiceLogRequestResponseUrlsApi._();

  factory GetWebServiceLogRequestResponseUrlsApi(
          GetWebServiceLogRequestResponseUrlsApiOptions options) =
      _$GetWebServiceLogRequestResponseUrlsApi;
}
