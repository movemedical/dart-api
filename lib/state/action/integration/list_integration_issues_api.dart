...
abstract class ListIntegrationIssuesApi extends ApiDispatcher<ListIntegrationIssuesApiRequest, ListIntegrationIssuesApiResponse, ListIntegrationIssuesApi> {
  @override
  String get path => 'v1/integration/list_integration_issues';
  
  @override
  Serializer<ListIntegrationIssuesApiRequest> get requestSerializer => ListIntegrationIssuesApiRequest.serializer;
  
  @override
  Serializer<ListIntegrationIssuesApiResponse> get responseSerializer => ListIntegrationIssuesApiResponse.serializer;
  
  ListIntegrationIssuesApi._();
  
  factory ListIntegrationIssuesApi(ListIntegrationIssuesApiOptions options) = _$ListIntegrationIssuesApi;
}
