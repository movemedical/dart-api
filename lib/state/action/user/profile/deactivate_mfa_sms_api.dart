...
abstract class DeactivateMfaSmsApi extends ApiDispatcher<DeactivateMfaSmsApiRequest,
...
DeactivateMfaSmsApi> {
  ...
  factory DeactivateMfaSmsApi(DeactivateMfaSmsApiOptions options) = _$DeactivateMfaSmsApi;
}
