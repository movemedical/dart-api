...
abstract class ResetForgotPasswordApi extends ApiDispatcher<ResetForgotPasswordApiRequest,
...
ResetForgotPasswordApi> {
  ...
  factory ResetForgotPasswordApi(ResetForgotPasswordApiOptions options) = _$ResetForgotPasswordApi;
}
