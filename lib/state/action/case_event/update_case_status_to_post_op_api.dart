...
import 'package:movemedical_api/model/action/case_event/update_case_status_to_post_op_api_request.dart';

export 'package:movemedical_api/model/action/case_event/update_case_status_to_post_op_api_request.dart';
...
abstract class UpdateCaseStatusToPostOpApi extends ApiDispatcher<
  ...
  factory UpdateCaseStatusToPostOpApi(
          UpdateCaseStatusToPostOpApiOptions options) =
      _$UpdateCaseStatusToPostOpApi;
}
