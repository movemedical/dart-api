...
export 'package:movemedical_api/model/action/case_event/list_hospitals_for_scheduling_api_request.dart';
export 'package:movemedical_api/model/action/case_event/list_hospitals_for_scheduling_api_response.dart';

part 'list_hospitals_for_scheduling_api.g.dart';

abstract class ListHospitalsForSchedulingApi extends ApiDispatcher<
  ...
  factory ListHospitalsForSchedulingApi(
          ListHospitalsForSchedulingApiOptions options) =
      _$ListHospitalsForSchedulingApi;
}
