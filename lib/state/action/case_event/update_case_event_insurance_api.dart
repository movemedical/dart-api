...
export 'package:movemedical_api/model/action/case_event/update_case_event_insurance_api_request.dart';

part 'update_case_event_insurance_api.g.dart';

abstract class UpdateCaseEventInsuranceApi extends ApiDispatcher<
  ...
  factory UpdateCaseEventInsuranceApi(
          UpdateCaseEventInsuranceApiOptions options) =
      _$UpdateCaseEventInsuranceApi;
}
