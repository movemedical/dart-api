...
abstract class ListLotsApi extends ApiDispatcher<ListLotsApiRequest, ListLotsApiResponse, ListLotsApi> {
  @override
  String get path => 'v1/catalog/list_lots';
  
  @override
  Serializer<ListLotsApiRequest> get requestSerializer => ListLotsApiRequest.serializer;
  
  @override
  Serializer<ListLotsApiResponse> get responseSerializer => ListLotsApiResponse.serializer;
