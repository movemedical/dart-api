...
abstract class ListItemFilesApi extends ApiDispatcher<ListItemFilesApiRequest,
...
ListItemFilesApi> {
  ...
  factory ListItemFilesApi(ListItemFilesApiOptions options) = _$ListItemFilesApi;
}
