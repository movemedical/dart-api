...
abstract class RequestBackOrderReportApi extends ApiDispatcher<
  ...
  factory RequestBackOrderReportApi(RequestBackOrderReportApiOptions options) =
      _$RequestBackOrderReportApi;
}
