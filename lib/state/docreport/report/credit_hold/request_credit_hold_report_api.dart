...
abstract class RequestCreditHoldReportApi extends ApiDispatcher<
  ...
  factory RequestCreditHoldReportApi(
      RequestCreditHoldReportApiOptions options) = _$RequestCreditHoldReportApi;
}
